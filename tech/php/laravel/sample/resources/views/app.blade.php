...
<head>
    ...
    <title>@yield('title', 'Easetrail :: Home')</title>
...
<body class="is-theme-core">
    ...
    <!-- Hero -->
    <div class="hero is-relative  is-app-grey jobs-hero">
            ...
            <div class="container">
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-start">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit13-landing.php#">
                            Jobs
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit13-landing.php#">
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item is-button">
                            <a id="#signup-btn" href="kit13-landing.php#" class="button button-cta is-bold btn-align primary-btn raised">
                                Register
                            </a>
                        </div>
                    </div>
    ...
    <div class="section is-medium">
        <div class="container">
            ...
            <div class="title-wrap has-text-centered">
                ...
                <img src="{{ asset('assets/img/graphics/legacy/divider.svg') }}" class="special-divider" alt="">
            </div>
            ...
            <div class="content-wrapper">
                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/demo/brands/airbnb.svg') }}" alt="">
                            </div>
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/demo/brands/gitlab.svg') }}" alt="">
                            </div>
                            <div class="content-container">
                                <h3>Web Developer</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/demo/brands/slack.svg') }}" alt="">
                            </div>
                            <div class="content-container">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/demo/brands/dribbble.svg') }}" alt="">
                            </div>
                            <div class="content-container">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/demo/brands/facebook.svg') }}" alt="">
                            </div>
                            <div class="content-container">
                                <h3>UI/UX Designer</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/demo/brands/github.svg') }}" alt="">
                            </div>
                            <div class="content-container">
                                <h3>Web Developer</h3>
                                <div class="job-summary">
            ...
            <div class="content-wrapper">
                ...
                <div class="job-categories">
                    <div class="job-categories-inner">
                        ...
                        <!--Category-->
                        <a href="kit13-landing.php#" class="job-category tilt-card rounded">
                ...
                <!-- CTA -->
                <div class="cta-wrapper has-text-centered is-title-reveal pt-60">
                    <a href="kit13-landing.php#" class="button button-cta is-bold btn-align primary-btn raised">
                        View All Categories
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="columns is-multiline">
                    ...
                    <!--Hot Topic-->
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/js.svg') }}" alt="">
                            </div>
                            <div class="meta">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/angular.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>Angular 11</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/csharp.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>C Sharp</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/css3.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>CSS3</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/html5.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>Html5</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/nodejs.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>NodeJS</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/python.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>Python</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/php.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>PhP</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/reactjs.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>ReactJS</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/vuejs.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>VueJS</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/wordpress.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>WordPress</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="{{ asset('assets/img/logos/stacks/illustrator.svg') }}" alt="">
                            </div>
                            <div class="meta">
                                <h3>Illustrator</h3>
                                <div class="job-summary">
            ...
            <div class="content-wrapper">
                <div class="columns">
                    ...
                    <div class="column is-3">
                        <div class="job-user">
                            <div class="avatar-wrap">
                                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/helen.jpg">
                    ...
                    <div class="column is-3">
                        <div class="job-user">
                            <div class="avatar-wrap">
                                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/nick.jpg">
                                <img class="badge" src="{{ asset('assets/img/logos/stacks/js.svg') }}" alt="">
                            </div>
                            <h3>Nick Motta</h3>
                            <p>Frontend Developer, Seatlle</p>
                            <div class="tags">
                    ...
                    <div class="column is-3">
                        <div class="job-user">
                            <div class="avatar-wrap">
                                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/lakisha.jpg">
                    ...
                    <div class="column is-3">
                        <div class="job-user">
                            <div class="avatar-wrap">
                                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/alex.jpg">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="columns is-vcentered">
                            <div class="column is-6">
                                <div class="flex-card testimonial-card light-bordered light-raised padding-20">
                                    ...
                                    <div class="user-id">
                                        <img class="" src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/dan.png">
                                        <div class="info">
                                ...
                                <div class="flex-card testimonial-card light-bordered light-raised padding-20">
                                    ...
                                    <div class="user-id">
                                        <img class="" src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/janet.jpg">
                                        <div class="info">
                            ...
                            <div class="column is-6">
                                <div class="flex-card testimonial-card light-bordered light-raised padding-20">
                                    ...
                                    <div class="user-id">
                                        <img class="" src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/barry.jpg">
                                        <div class="info">
                                ...
                                <div class="flex-card testimonial-card light-bordered light-raised padding-20">
                                    ...
                                    <div class="user-id">
                                        <img class="" src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/anthony.jpg">
                                        <div class="info">
                ...
                <div class="grid-clients three-grid mt-60">
                    ...
                    <div class="columns is-vcentered is-separator">
                        ...
                        <div class="column">
                            <a><img class="client" src="https://bulkit.cssninja.io/{{ asset('assets/img/logos/custom/kromo.svg') }}" alt=""></a>
                        </div>
                        <div class="column">
                    ...
                    <div class="columns is-vcentered is-separator">
                        <div class="column"></div>
                        <div class="column">
                            <a><img class="client" src="https://bulkit.cssninja.io/{{ asset('assets/img/logos/custom/infinite.svg') }}" alt=""></a>
                        </div>
                        <div class="column">
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit13-landing.php#">Home</a></li>
                                <li class="column-item"><a href="kit13-landing.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit13-landing.php#">Get started</a></li>
                                <li class="column-item"><a href="kit13-landing.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit13-landing.php#">Learning</a></li>
                                <li class="column-item"><a href="kit13-landing.php#">Support center</a></li>
                                <li class="column-item"><a href="kit13-landing.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit13-landing.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit13-landing.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit13-landing.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit13-landing.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit13-landing.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit13-landing.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit13-landing.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit13-landing.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit13-landing.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit13-landing.php#"></a></div>
        ...
        <div class="chat-widget-body is-closed">
            <div class="chat-header">
                ...
                <div class="chat-team">
                    <div class="team-member has-text-centered">
                        <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/alan.jpg">
            ...
            <div class="message-container">
                ...
                <div class="chat-message to">
                    ...
                    <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{ asset('assets/img/avatars/helen.jpg">
                </div>
            </div>
