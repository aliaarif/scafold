...
<body>
        ...
        <div class="container">
                    ...
                    <div class="dropdown account-dropdown is-right">
                        ...
                        <div class="dropdown-menu" id="dropdown-menu6" role="menu">
                            <div class="dropdown-content">
                                <a href="profile-2.php#" class="dropdown-item">
            ...
            <div class="navbar-menu">
                ...
                <div class="navbar-start">
                    <!-- Navbar item -->
                    <a class="navbar-item is-slide" href="profile-2.php#"> Product </a>
                    <!-- Navbar item -->
                    <a class="navbar-item is-slide" href="profile-2.php#"> Pricing </a>
                    <!-- Navbar item -->
                    <a class="navbar-item is-slide" href="profile-2.php#"> About </a>
                </div>
        ...
        <div class="profile-header-inner">
            ...
            <div class="tabs is-centered">
                <ul>
                    ...
                    <li class="is-active"><a href="profile-2.php">Projects</a></li>
                    <li><a href="profile-3.php">Network</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="profile-wrapper is-larger">
                <div class="columns is-multiline">
                    ...
                    <div class="column is-4">
                        <a href="profile-2.php#" class="project-card">
                            <img src="https://via.placeholder.com/800x600" data-demo-src="assets/img/demo/projects/4.png" alt="" />
                            <div class="project-card-content">
                                <h3>Crypto / ICO Platform</h3>
                                <p>Lorem ipsum sit dolor amet is a dummy text</p>
                                <div class="project-members">
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/marge.jpg" alt="" />
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/matt.jpg" alt="" />
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="column is-4">
                        <a href="profile-2.php#" class="project-card">
                            <img src="https://via.placeholder.com/800x600" data-demo-src="assets/img/demo/projects/5.png" alt="" />
                            <div class="project-card-content">
                                <h3>Property Management</h3>
                                <p>Lorem ipsum sit dolor amet is a dummy text</p>
                                <div class="project-members">
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/nicole.jpg" alt="" />
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/fred.jpg" alt="" />
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/janet.jpg" alt="" />
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="column is-4">
                        <a href="profile-2.php#" class="project-card">
                            <img src="https://via.placeholder.com/800x600" data-demo-src="assets/img/demo/projects/6.png" alt="" />
                            <div class="project-card-content">
                                <h3>Checkout King</h3>
                                <p>Lorem ipsum sit dolor amet is a dummy text</p>
                                <div class="project-members">
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/jalil.jpg" alt="" />
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/jane.jpg" alt="" />
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="column is-4">
                        <a href="profile-2.php#" class="project-card">
                            <img src="https://via.placeholder.com/800x600" data-demo-src="assets/img/demo/projects/7.png" alt="" />
                            <div class="project-card-content">
                                <h3>Next Gen Chat</h3>
                                <p>Lorem ipsum sit dolor amet is a dummy text</p>
                                <div class="project-members">
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/kareem.jpg" alt="" />
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/mila.jpg" alt="" />
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/melany.jpg" alt="" />
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="column is-4">
                        <a href="profile-2.php#" class="project-card">
                            <img src="https://via.placeholder.com/800x600" data-demo-src="assets/img/demo/projects/8.png" alt="" />
                            <div class="project-card-content">
                                <h3>Neo Kanban</h3>
                                <p>Lorem ipsum sit dolor amet is a dummy text</p>
                                <div class="project-members">
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/alex.jpg" alt="" />
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/barry.jpg" alt="" />
            ...
            <div class="columns is-vcentered">
                    ...
                    <div>
                        ...
                        <nav class="level is-mobile mt-20">
                            <div class="level-left level-social">
                                <a href="profile-2.php#" class="level-item">
                ...
                <div class="column">
                    <div class="footer-nav-right">
                        <a class="footer-nav-link" href="profile-2.php#">Home</a>
                        <a class="footer-nav-link" href="profile-2.php#">Features</a>
                        <a class="footer-nav-link" href="profile-2.php#">Pricing</a>
                        <a class="footer-nav-link" href="profile-2.php#">Sign in</a>
                        <a class="footer-nav-link" href="profile-2.php#">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="profile-2.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="profile-2.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="profile-2.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="profile-2.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="profile-2.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-2.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="profile-2.php#"></a></div> <!-- Concatenated jQuery and plugins -->
