...
<body class="is-theme-core">
    ...
    <!-- Hero and Navbar -->
    <div class="hero is-wavy-bg is-default is-bold is-fullheight">
            ...
            <div class="container is-streched">
                ...
                <div id="is-cloned" class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide is-centered-tablet" href="kit6-landing.php#features">
                            Features
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide is-centered-tablet" href="kit6-landing.php#pricing">
                            Pricing
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide is-centered-tablet" href="kit6-login.php">
                            Login
                        </a>
                        <!-- Signup button -->
                        <div class="navbar-item is-button is-centered-tablet">
                            <a id="#signup-btn" href="kit6-signup.php" class="button button-cta is-bold btn-align primary-btn raised rounded">
                                Sign up
                            </a>
                        </div>
                    </div>
            ...
            <div class="container is-streched">
                ...
                <div id="is-static" class="navbar-menu">
                    ...
                    <div class="navbar-start">
                        <!-- Dropdown -->
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide is-centered-tablet is-hidden-desktop is-hidden-tablet" href="kit6-features.php">
                            Product
                        </a>
                    ...
                    <div class="navbar-end">
                        ...
                        <!-- Signup button -->
                        <div class="navbar-item is-button is-centered-tablet">
                            <a id="#signup-btn-double" href="kit6-signup.php" class="button button-cta is-bold btn-align secondary-btn rounded raised">
                                Sign up
                            </a>
                        </div>
                    </div>
        ...
        <!-- Hero content -->
        <div class="hero-body is-start">
            <div class="container">
                <div class="columns is-vcentered">
                    <div class="column is-6 is-offset-3 has-text-centered is-hero-caption is-pushed-md">
                        <h1 class="title is-2 no-margin">
                            Learn differently.
                        </h1>
                        <h2 class="subtitle is-4">
                            Join our awesome and ready to help community of mentors, designers and developers.
                        </h2>
                        <p class="is-flex-mobile is-flex-center-mobile">
                            <a href="kit6-landing.php#" class="button button-cta is-bold btn-align primary-btn raised rounded">
                                Get Started
                            </a>
                            <a href="kit6-landing.php#" class="button button-cta is-bold btn-align btn-outlined primary-btn raised rounded">
                                Learn More
                            </a>
                        </p>
                    </div>
            ...
            <img class="hero-image" src="assets/img/graphics/apps/landing-phones-core.png" data-base-url="assets/img/graphics/apps/landing-phones" data-extension=".png" alt="">
            <a href="kit6-landing.php#start" class="scroll-button">
    ...
    <!-- Benefits section -->
    <div class="section is-theme-grey is-medium">
        <div class="container">
            <div id="start" class="columns">
                <!-- Benefit box -->
                <div class="column is-4">
                    <div class="flex-card is-feature padding-40">
                        ...
                        <div class="content-container has-text-centered">
                            <h3>Save Time</h3>
                            <p>Duplexque isdem diebus acciderat malum, quod et Theophilum insontem atrox interceperat casus,
    ...
    <!-- Features section -->
    <div id="features" class="section is-medium">
        <div class="container">
            <!-- Feature -->
            <div class="columns is-vcentered">
                <!-- Featured image -->
    ...
    <div class="section is-theme-grey is-medium">
        <div class="container">
            <div class="title-wrap has-text-centered">
                <h2 class="title is-spaced is-2">How it works</h2>
        ...
        <div class="container">
            <div class="columns is-vcentered">
                <div class="column is-5 is-centered-mobile">
                    <!-- Title -->
                    <h4 class="title is-spaced is-3">Our plans</h4>
                    <h5 class="pricing-sub">Duplexque isdem diebus acciderat malum, quod et Theophilum insontem atrox
                        interceperat casus.</h5>
                    <!-- Period switcher -->
                    <div class="button-wrap">
                        <div class="combo-button">
                            <a href="javascript:void(0);" class="button button-cta is-bold btn-align btn-outlined primary-btn raised rounded is-active">
                                Monthly
                            </a>
                            <a href="javascript:void(0);" class="button button-cta is-bold btn-align btn-outlined primary-btn raised rounded">
                                Yearly
                            </a>
                        </div>
                    </div>
                ...
                <!-- Pricing table -->
                <div class="column">
                    <div class="flex-card is-pricing-card has-text-centered raised padding-30">
                        <!-- Icon -->
                        <div class="pricing-icon">
                            <img src="assets/img/graphics/icons/send-core.svg" data-base-url="assets/img/graphics/icons/send" data-extension=".svg" alt="">
                        </div>
                        <!-- Plan -->
                        <div class="plan-name">
                            Standard
                        ...
                        <ul class="features-list">
                            <li>Standard wireframes kit</li>
                            <li>8 hours mentoring / month</li>
                            <li>500+ premium tutorials</li>
                            <li>1 included certification</li>
                            <li>50GB online storage</li>
                        </ul>
                        <!-- Plan meta -->
                        <div class="plan-price animated preFadeInUp fadeInUp">19.00</div>
                        <div class="plan-price animated preFadeInUp fadeInUp is-hidden">210.00</div>
                        <div class="price-per">per month</div>
                        <div class="price-per is-hidden">per year</div>
                ...
                <div class="column">
                    <div class="flex-card is-pricing-card has-text-centered raised padding-30">
                        <!-- Icon -->
                        <div class="pricing-icon">
                            <img src="assets/img/graphics/icons/launch-core.svg" data-base-url="assets/img/graphics/icons/launch" data-extension=".svg" alt="">
                        </div>
                        <!-- Plan -->
                        <div class="plan-name">
                            Premium
                        ...
                        <!-- Features -->
                        <ul class="features-list">
                            <li>Premium wireframes kit</li>
                            <li>25 hours mentoring / month</li>
                            <li>1500+ premium tutorials</li>
                            <li>3 included certifications</li>
                            <li>500GB online storage</li>
                        </ul>
                        <!-- Plan meta -->
                        <div class="plan-price animated preFadeInUp fadeInUp">44.00</div>
                        <div class="plan-price animated preFadeInUp fadeInUp is-hidden">480.00</div>
                        <div class="price-per">per month</div>
                        <div class="price-per is-hidden">per year</div>
                        <div class="plan-action">
                            <a href="kit6-landing.php#" class="button button-cta is-bold btn-align btn-outlined primary-btn raised rounded">
    ...
    <div class="section is-medium">
        <div class="container">
            <div class="title-wrap has-text-centered">
                <h2 class="title is-spaced is-2">Latest news</h2>
                <h3>Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum inermis iudicabit.</h3>
                <!-- Special divider -->
                <img src="assets/img/graphics/legacy/divider.svg" class="special-divider" alt="">
            </div>
                    ...
                    <div class="column is-6">
                        <div class="main-post">
                            ...
                            <div class="post-content">
                                <h3><a href="kit6-landing.php#">How a designer can benefit from learning to code</a></h3>
                                ...
                                <!-- Read more -->
                                <a class="read-more" href="kit6-landing.php#">Continue reading <i class="im im-icon-Right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="column is-6">
                        ...
                        <div class="side-post">
                            ...
                            <!-- Featured content -->
                            <div class="post-content">
                                <h3><a href="kit6-landing.php#">Learning design has become trendy in 2018</a></h3>
                                <p>Homines enim eruditos et sobrios ut infaustos et inutiles vitant, eo quoque accedente
                        ...
                        <div class="side-post">
                            ...
                            <!-- Featured content -->
                            <div class="post-content">
                                <h3><a href="kit6-landing.php#">Welcome to Elsa, our new mentor</a></h3>
                                <p>Homines enim eruditos et sobrios ut infaustos et inutiles vitant, eo quoque accedente
                                    quod et nomenclatores adsueti haec et talia venditare ...</p>
                            </div>
                        </div>
                        ...
                        <div class="side-post">
                            ...
                            <!-- Featured content -->
                            <div class="post-content">
                                <h3><a href="kit6-landing.php#">5 tips to draw pixel perfect icons</a></h3>
                                <p>Homines enim eruditos et sobrios ut infaustos et inutiles vitant, eo quoque accedente
                                    quod et nomenclatores adsueti haec et talia venditare ...</p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="columns is-vcentered">
                ...
                <div class="column is-4 is-offset-2 is-centered-mobile">
                    <h2 class="title is-3 no-margin">Start your free trial</h2>
                    <small class="no-credit-card">No credit card required</small>
                </div>
                <!-- CTA button -->
                <div class="column is-4 has-text-centered">
                    <div class="is-title-reveal">
                        <a href="kit6-landing.php#" class="button button-cta is-bold btn-align is-fat primary-btn raised">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="footer-inner">
                    <div class="footer-block designed-by">
                        © 2019-2020 - Coded with <i class="fa fa-heart"></i> by Css Ninja
                    </div>
                    <div class="footer-block links has-text-centered">
                        <a href="kit6-landing.php#">Terms & Conditions</a>
                        <a href="kit6-landing.php#">Privacy policy</a>
                        <a href="kit6-landing.php#">Help</a>
                    </div>
                    <div class="footer-block social has-text-right">
                        <a href="kit6-landing.php#"><i class="fa fa-twitter"></i></a>
                        <a href="kit6-landing.php#"><i class="fa fa-facebook"></i></a>
                        <a href="kit6-landing.php#"><i class="fa fa-dribbble"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit6-landing.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit6-landing.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit6-landing.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit6-landing.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit6-landing.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit6-landing.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit6-landing.php#"></a></div>
