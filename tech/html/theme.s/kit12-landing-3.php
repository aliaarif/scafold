...
<body class="is-theme-core">
        ...
        <div class="container">
            <div class="navbar-brand">
                <a class="navbar-item" href="index.php">
                    <img class="light-logo" src="assets/img/logos/logo/bulkit-square-white.svg" width="28" height="28" alt="">
            ...
            <div class="navbar-menu">
                <div class="navbar-start">
                    <a href="kit12-landing-3.php#services" class="navbar-item has-hover scroll-link">
                        Services
                    </a>

                    <a href="kit12-landing-3.php#about" class="navbar-item has-hover scroll-link">
                        About
                    </a>

                    <a href="kit12-landing-3.php#news" class="navbar-item has-hover scroll-link">
                        News
                    </a>
                </div>

                <div class="navbar-end has-hover">
                    <a href="kit12-landing-3.php#contact" class="navbar-item scroll-link">
                        Help
                    </a>
                    <div class="navbar-item">
                        <a href="kit12-landing-3.php#contact" class="button button-cta primary-btn is-bold raised scroll-link">Contact</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Hero -->
    <div class="hero parallax is-cover is-relative is-fullheight" data-background="https://via.placeholder.com/1920x1280" data-color="#060b1f" data-color-opacity=".6" data-demo-background="/assets/img/demo/hero-8.jpg">
        <!-- Hero caption -->
                ...
                <div class="columns is-vcentered">
                    <div class="column is-5 signup-column has-text-left">
                        ...
                        <h2 class="subtitle is-5 no-margin-bottom is-light">
                            A team of experts dedicated to your success. Take control over your business by deploying an all in one business data monitoring solution.
                        </h2>
                        <br>
                        <!-- Signup form -->
                        <div class="signup-block">
                            <form>
                                <div class="control">
                                    ...
                                    <button type="submit" class="button btn-align primary-btn raised">Send</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="column is-6 is-offset-1">
                        <!-- Hero 16by9 video -->
                        <div class="bulkit-player-container is-4by3">
                            <video id="hero-player" class="bulkit-player" playsinline controls data-poster="https://via.placeholder.com/440x440" data-demo-poster="assets/img/demo/video/poster-3.jpg">
    ...
    <div class="section is-medium">
        <div id="start" class="container">
            ...
            <div class="section-title-wrapper has-text-centered">
                ...
                <h3 class="section-subtitle-alt">Our team is made of recognized business process experts from all over the
                    world</h3>
            </div>
                    ...
                    <div class="column is-4">
                        <div class="flex-card is-feature padding-40">
                            ...
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="assets/img/graphics/icons/time-core.svg" data-base-url="assets/img/graphics/icons/time" data-extension=".svg" alt="">
                            </div>
                            <!-- Content -->
                            <div class="content-container has-text-centered">
                                <h3>Solid Expertise</h3>
                                <p>Duplexque isdem diebus acciderat malum, quod et Theophilum insontem atrox interceperat
                                    casus,
                                    et Serenianus dignus exsecratione cunctorum, innoxius.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Benefit box -->
                    ...
                    <div class="column is-4">
                        <div class="flex-card is-feature padding-40">
                            ...
                            <div class="icon-container is-third is-icon-reveal">
                                <img src="assets/img/graphics/icons/rocket-core.svg" data-base-url="assets/img/graphics/icons/rocket" data-extension=".svg" alt="">
                            </div>
                            <!-- Content -->
                            <div class="content-container has-text-centered">
    ...
    <div id="services" class="section is-medium">
        <div class="container">
            ...
            <div class="section-title-wrapper has-text-centered">
                ...
                <h3 class="section-subtitle-alt">A wide range of consulting services to help you manage your company</h3>
            </div>
            ...
            <div class="content-wrapper">
                ...
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-6 has-text-centered">
                        <img class="featured-svg" src="assets/img/graphics/widgets/widget-hr-3-core.png" data-base-url="assets/img/graphics/widgets/widget-hr-3" data-extension=".png" alt="">
                    </div>
                    <!-- Feature content -->
                    <div class="column is-4 is-offset-1">
                        <div class="icon-subtitle is-title-reveal"><i class="im im-icon-Calendar-4"></i></div>
                        <h2 class="title is-3 no-margin">
                            Real time scheduling
                        </h2>
                        <div class="title-divider"></div>
                        <span class="section-feature-description">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu
                            harum
                            inermis iudicabit. Duplexque isdem diebus acciderat malum, quod et Theophilum insontem atrox
                            interceperat casus, et Serenianus dignus.</span>
                    </div>
                </div>
                ...
                <div class="columns is-vcentered">
                    <!-- Featured image -->
                    <div class="column is-6 is-offset-1 has-text-centered is-hidden-desktop is-hidden-tablet">
                        <img class="featured-svg" src="assets/img/graphics/widgets/widget-2-core.png" data-base-url="assets/img/graphics/widgets/widget-2" data-extension=".png" alt="">
                    </div>
                    <!-- Featured content -->
                    <div class="column is-4 is-offset-1">
                        <div class="icon-subtitle is-title-reveal"><i class="im im-icon-Duplicate-Window"></i></div>
                        <h2 class="title is-3 no-margin">
                            Online code review
                        </h2>
                        <div class="title-divider"></div>
                ...
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-5 is-offset-1 has-text-centered">
                        ...
                        <div class="bulkit-player-container is-16by9">
                            <video id="hero-player" class="bulkit-player" playsinline controls data-poster="https://via.placeholder.com/440x440" data-demo-poster="assets/img/demo/video/poster-2.jpg">
                                <source src="assets/img/demo/video/hands.mp4" type="video/mp4" />
                                <source src="assets/img/demo/video/hands.webm" type="video/webm" />
                            </video>
                        </div>
                        ...
                        <div class="process-block has-line">
                            ...
                            <div class="process-info">
                                ...
                                <div class="details">
                                    ...
                                    <p class="description">Lorem ipsum dolor sit amet, eam ex probo tation tractatos. Ut vel
                                        hinc solet tincidunt, nec et iisque placerat pertinax. Ei minim probatus mea.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="card-testimonials" class="section is-medium is-skewed-sm">
        <div class="container is-reverse-skewed-sm">
            ...
            <div class="section-title-wrapper has-text-centered">
                ...
                <h3 class="section-subtitle-alt">Read what they say about us</h3>
            </div>
    ...
    <!-- News section -->
    <div id="news" class="section is-medium">
        <div class="container">
            ...
            <div class="section-title-wrapper has-text-centered">
                ...
                <h3 class="section-subtitle-alt">Take a look at our recently published content.</h3>
            </div>
                    ...
                    <div class="column is-6">
                        <div class="main-post">
                            ...
                            <div class="post-image">
                                <img src="https://via.placeholder.com/1600x900" alt="" data-demo-src="https://source.unsplash.com/SYTO3xs06fU/1600x900">
                                <div class="image-overlay"></div>
                            </div>
                            <!-- Featured Content -->
                            <div class="post-content">
                                <h3><a href="kit12-landing-3.php#">How a designer can benefit from learning to code</a></h3>
                                <span class="time">september 10 2018</span>
                                <p>Homines enim eruditos et sobrios ut infaustos et inutiles vitant, eo quoque accedente
                                    quod et nomenclatores adsueti haec et talia venditare, mercede accepta lucris quosdam et
                                    prandiis inserunt subditicios ignobiles et obscuros.</p>
                                <!-- Read more -->
                                <a class="read-more" href="kit12-landing-3.php#">Continue reading <i class="im im-icon-Right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="column is-6">
                        ...
                        <div class="side-post">
                            <!-- Featured image -->
                            <div class="post-image">
                                <img src="https://via.placeholder.com/1600x900" alt="" data-demo-src="https://source.unsplash.com/RgXO6LZbZgg/1600x900">
                                <div class="image-overlay"></div>
                            </div>
                            <!-- Featured content -->
                            <div class="post-content">
                                <h3><a href="kit12-landing-3.php#">Learning design has become trendy in 2018</a></h3>
                                <p>Homines enim eruditos et sobrios ut infaustos et inutiles vitant, eo quoque accedente
                                    quod et nomenclatores adsueti haec et talia venditare ...</p>
                            </div>
                        </div>
                        <!-- Recent Post -->
                        <div class="side-post">
                            <!-- Featured image -->
                            <div class="post-image">
                                <img src="https://via.placeholder.com/1600x900" alt="" data-demo-src="https://source.unsplash.com/V4EOZj7g1gw/1600x900">
                                <div class="image-overlay"></div>
                            </div>
                            <!-- Featured content -->
                            <div class="post-content">
                                <h3><a href="kit12-landing-3.php#">Welcome to Elsa, our new mentor</a></h3>
                                <p>Homines enim eruditos et sobrios ut infaustos et inutiles vitant, eo quoque accedente
                                    quod et nomenclatores adsueti haec et talia venditare ...</p>
                            </div>
                        </div>
                        ...
                        <div class="side-post">
                            <!-- Featured image -->
                            <div class="post-image">
                                <img src="https://via.placeholder.com/1600x900" alt="" data-demo-src="https://source.unsplash.com/_3bUXLk6Dgs/1600x900">
                                <div class="image-overlay"></div>
                            </div>
                            <!-- Featured content -->
                            <div class="post-content">
                                <h3><a href="kit12-landing-3.php#">5 tips to draw pixel perfect icons</a></h3>
                                <p>Homines enim eruditos et sobrios ut infaustos et inutiles vitant, eo quoque accedente
                                    quod et nomenclatores adsueti haec et talia venditare ...</p>
                            </div>
                        </div>
                    ...
                    <div class="contact-form">
                        <form>
                            ...
                            <div class="submit-wrapper">
                                <a href="kit12-landing-3.php#" class="button button-cta is-bold btn-align primary-btn raised">
                                    Send Message
                                </a>
                            </div>
                        </form>
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit12-landing-3.php#">Home</a></li>
                                <li class="column-item"><a href="kit12-landing-3.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit12-landing-3.php#">Get started</a></li>
                                <li class="column-item"><a href="kit12-landing-3.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit12-landing-3.php#">Learning</a></li>
                                <li class="column-item"><a href="kit12-landing-3.php#">Support center</a></li>
                                <li class="column-item"><a href="kit12-landing-3.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit12-landing-3.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit12-landing-3.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit12-landing-3.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit12-landing-3.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit12-landing-3.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit12-landing-3.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit12-landing-3.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit12-landing-3.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit12-landing-3.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit12-landing-3.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit12-landing-3.php#"></a></div>
