...
<body class="is-theme-core">
        ...
        <nav class="navbar navbar-wrapper navbar-default navbar-fade is-transparent">
            <div class="container">
                ...
                <div class="navbar-brand">
                    ...
                    <!-- Responsive toggle -->
                    <div class="custom-burger" data-target="navbar-menu">
                ...
                <div id="navbar-menu" class="navbar-menu">
                    ...
                    <div class="navbar-start">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit4-pricing.php">
                            Pricing
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit4-help.php">
                            Help
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit4-login.php">
                            Login
                        </a>
                    </div>
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item">
                            <a id="#signup-btn" href="kit4-signup.php" class="button button-cta btn-outlined is-bold btn-align primary-btn rounded raised">
                                Sign Up
                            </a>
                        </div>
                    </div>
                ...
                <div class="columns">
                    <div class="column is-8 is-offset-2 has-text-centered">
                        ...
                        <div class="subtitle light-subtitle">
                            Start collaborating immediatly on a powerful and easy to use Human Ressources Management system
                        </div>
                        <!-- CTA button -->
                        <div class="has-text-centered">
                            <a href="kit4-signup.php" class="button button-cta primary-btn rounded raised">Get started
                                free</a>
                        </div>
                    </div>
                </div>
    ...
    <div id="product" class="section is-relative mockup-section">
        <div class="container">
            <div class="columns has-text-centered">
                <div class="column">
                    <!-- App -->
                    <img class="app-mockup has-light-shadow" src="assets/img/graphics/apps/app-1-core.png" data-base-url="assets/img/graphics/apps/app-1" data-extension=".png" alt="">
                    <!-- Background image -->
                    <img class="hr-bg" src="assets/img/graphics/apps/hr-app-bg-core.png" data-base-url="assets/img/graphics/apps/hr-app-bg" data-extension=".png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="columns is-vcentered pt-80 pb-80">
                ...
                <div class="column is-4 is-offset-1">
                    <div class="minimal-feature">
                        <h2 class="title is-5 minimal-title">Manage job offers</h2>
                ...
                <div class="column is-6 is-offset-1">
                    <div class="minimal-feature-image">
                        <img class="main-image" src="assets/img/graphics/widgets/widget-hr-1-core.png" data-base-url="assets/img/graphics/widgets/widget-hr-1" data-extension=".png" alt="">
            ...
            <div class="columns is-vcentered pt-80">
                ...
                <div class="column is-4 is-offset-4 has-text-centered">
                    <div class="minimal-feature">
                        <h2 class="title is-5 minimal-title">Recruit, manage careers</h2>
                        <div class="feature-content">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed
                            cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis
                            ipsum.
            ...
            <div class="columns is-vcentered pb-80">
                <div class="column is-10 is-offset-1 has-text-centered">
                    <div class="employees-centered">
                        <img class="main-image" src="assets/img/graphics/widgets/widget-hr-2-core.png" data-base-url="assets/img/graphics/widgets/widget-hr-2" data-extension=".png" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered pt-80 pb-80">
                ...
                <div class="column is-4 is-offset-1">
                    <div class="minimal-feature">
                        <h2 class="title is-5 minimal-title">Manage user roles</h2>
                        <div class="feature-content">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed
                            cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis.
                        </div>
                ...
                <div class="column is-6 is-offset-1">
                    <div class="minimal-feature-image">
                        <img class="main-image" src="assets/img/graphics/widgets/widget-hr-3-core.png" data-base-url="assets/img/graphics/widgets/widget-hr-3" data-extension=".png" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered pt-80 pb-80">
                ...
                <div class="column is-6 is-offset-1">
                    <div class="minimal-feature-image">
                        <img class="main-image" src="assets/img/graphics/widgets/widget-2-core.png" data-base-url="assets/img/graphics/widgets/widget-2" data-extension=".png" alt="">
                    </div>
                </div>
                <!-- Content -->
                <div class="column is-4 is-offset-1">
                    <div class="minimal-feature">
                        <h2 class="title is-5 minimal-title">Collaborate with team</h2>
                        <div class="feature-content">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed
                            cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis.
                        </div>
            ...
            <div class="columns is-vcentered pt-80 pb-80">
                ...
                <div class="column is-6 is-offset-1">
                    <div class="minimal-feature-image">
                        <img class="main-image" src="assets/img/graphics/widgets/widget-hr-4.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section section-primary no-padding-bottom">
        <div class="container">
            <div class="columns is-vcentered">
                ...
                <div class="column is-4 is-offset-1">
                    <div class="minimal-feature">
                        <h2 class="title is-5 minimal-title bold-text light-text no-margin">Start managing now</h2>
                        <div class="feature-content light-text">
                            Leave unecessary pressure behind, everything is made simple so you can focus on your work. Try
                            our Free plan and discover all our features.
                        </div>
                        <div class="pt-20 pb-20">
                            <a href="kit4-signup.php" class="button button-cta btn-outlined is-bold light-btn rounded">Get
                                started for free</a>
                ...
                <!-- City illustration -->
                <div class="column is-5 is-offset-2 no-padding">
                    <div class="city-container">
                        <img src="assets/img/graphics/compositions/city.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit4-landing.php#">Home</a></li>
                                <li class="column-item"><a href="kit4-landing.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit4-landing.php#">Get started</a></li>
                                <li class="column-item"><a href="kit4-landing.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit4-landing.php#">Learning</a></li>
                                <li class="column-item"><a href="kit4-landing.php#">Support center</a></li>
                                <li class="column-item"><a href="kit4-landing.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit4-landing.php#">Schedule a v1</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit4-landing.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit4-landing.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit4-landing.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit4-landing.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit4-landing.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit4-landing.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit4-landing.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit4-landing.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-landing.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit4-landing.php#"></a></div>
