...
<body class="is-theme-core">
    ...
    <!-- Hero and Navbar -->
    <div class="hero is-app-grey is-fullheight has-animated-waves waves-bottom waves-primary">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="kit5-features.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="kit5-features.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="kit5-features.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="kit5-features.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="kit5-features.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-7">
                        <figure class="hero-app">
                            <img src="assets/img/graphics/legacy/project-app.png" alt="">
                        </figure>
                    </div>
                </div>
            </div>
    ...
    <!-- Blue Section -->
    <div class="section section-primary is-medium has-background-image is-contain has-pseudo-lines""
        data-background=" assets/img/graphics/legacy/circles-and-shapes-w.png">
        <div class="container">
            <!-- Title -->
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered">
                    <div class="column is-6 is-offset-3 has-text-centered">
                        <img class="featured-image" src="assets/img/graphics/legacy/platform-cards.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Feature Section -->
    <div class="section section-feature-grey is-medium has-pseudo-lines"">
        <div class=" container">
        <div class="content-wrapper">
            <!-- Feature -->
            <div class="columns is-vcentered">
                ...
                <div class="column is-5">
                    ...
                    <span class="section-feature-description">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu
                            harum inermis iudicabit. Ex vidit fierent hendrerit eum, sed stet periculis ut. Vis in probo
                            decore labitur.</span>
                    <div class="pt-10 pb-10">
                        <a href="kit5-features.php#" class="button btn-align btn-more is-link color-primary">
        ...
        <div class="content-wrapper">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered is-hidden-tablet is-hidden-desktop">
                    <img class="featured-svg" src="assets/img/graphics/widgets/mini-widget-5-core.png" data-base-url="assets/img/graphics/widgets/mini-widget-5" data-extension=".png" alt="">
                </div>
    ...
    <div class="section section-feature-grey is-medium has-pseudo-lines"">
        ...
        <div class="content-wrapper">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-svg" src="assets/img/graphics/legacy/project-app-projects.png" alt="">
                </div>
    ...
    <div class="section is-medium has-pseudo-lines"">
        ...
        <div class="content-wrapper">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered is-hidden-tablet is-hidden-desktop">
                    <img class="featured-svg" src="assets/img/graphics/legacy/project-app-feed.png" alt="">
                </div>
    ...
    <div class="section section-feature-grey is-medium has-pseudo-lines"">
        ...
        <div class="content-wrapper">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-svg" src="assets/img/graphics/legacy/project-app-versions.png" alt="">
                </div>
                ...
                <div class="column is-5">
                    ...
                    <span class="section-feature-description">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu
                            ...
                            decore labitur.</span>
                    <div class="pt-10 pb-10">
                        <a href="kit5-features.php#" class="button btn-align btn-more is-link color-secondary">
                            Learn more about this <i class="sl sl-icon-arrow-right"></i>
                        </a>
                    </div>
                </div>
    ...
    <div class="section is-medium has-pseudo-lines"">
        ...
        <div class="content-wrapper">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered is-hidden-tablet is-hidden-desktop">
                    <img class="featured-svg" src="assets/img/graphics/legacy/integrations.svg" alt="">
                </div>
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered">
                    <div class="column is-5 is-offset-1">
                        <!-- Signup form -->
                        <div class="quick-signup is-landing">
                            <form>
                                ...
                                <div class="submit-wrapper">
                                    <a href="kit5-features.php#" class="button button-cta is-bold is-fullwidth btn-align primary-btn raised no-lh">
                                        Start 30 days Trial
                                    </a>
                                </div>
                            </form>
                    ...
                    <div class="column is-5">
                        <div class="trial-features">
                            ...
                            <p class="has-text-centered">Lorem ipsum dolor sit amet, cu tritani aliquid pro, in quo simul
                                fabellas. Eu vim natum adhuc laoreet. Magna possit alterum pri in, ei eum graeci nemore
                                nostro.</p>
                            <img class="featured-svg" src="assets/img/graphics/drawings/drawing-5-core.svg" data-base-url="assets/img/graphics/drawings/drawing-5" data-extension=".svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit5-features.php#">Home</a></li>
                                <li class="column-item"><a href="kit5-features.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit5-features.php#">Get started</a></li>
                                <li class="column-item"><a href="kit5-features.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit5-features.php#">Learning</a></li>
                                <li class="column-item"><a href="kit5-features.php#">Support center</a></li>
                                <li class="column-item"><a href="kit5-features.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit5-features.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit5-features.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit5-features.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit5-features.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit5-features.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit5-features.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit5-features.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit5-features.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit5-features.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-features.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit5-features.php#"></a></div>
