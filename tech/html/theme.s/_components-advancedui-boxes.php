...
<body>
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-advancedui-boxes.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-advancedui-boxes.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-advancedui-boxes.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-advancedui-boxes.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-advancedui-boxes.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <p class="components-cta">
                            <a href="_components-advancedui-boxes.php#static-boxes" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Display an eye catching feature matrix by using Bulkit icon boxes. Simple icon
                            boxes are available in several color schemes. Available modifiers are <code>.primary</code>,
                            <code>.secondary</code>, <code>.accent</code>, <code>.info</code>, <code>.success</code>,
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Display an eye catching feature matrix by using Bulkit diamond icon boxes.
                            Diamond icon boxes are available in several color schemes. Available modifiers are
                            <code>.primary</code>, <code>.secondary</code>, <code>.accent</code>, <code>.info</code>,
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Display an eye catching feature matrix by using Bulkit hover icon boxes. Hover
                            icon boxes are available in several color schemes and have a square shape by default. Available
                            modifiers are <code>.primary</code>, <code>.secondary</code>, <code>.accent</code>,
                            <code>.info</code>, <code>.success</code>, <code>.warning</code> and <code>.danger</code>.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Display an eye catching feature matrix by using Bulkit hover icon boxes. Hover
                            icon boxes are available in several color schemes and can be rounded. Add the
                            <code>.rounded</code> class to a <code>.square-icon-box</code> element to make it rounded.
                            Available color modifiers are <code>.primary</code>, <code>.secondary</code>,
                            <code>.accent</code>, <code>.info</code>, <code>.success</code>, <code>.warning</code> and
                            <code>.danger</code>.
                        </p>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Display an eye catching feature matrix by using Bulkit long shadow icon boxes.
                            Long shadow icon boxes are available in several color schemes and have a square shape by
                            default. Available modifiers are <code>.is-primary</code>, <code>.is-secondary</code>,
                            <code>.is-accent</code>, <code>.is-info</code>, <code>.is-success</code>,
                            <code>.is-warning</code> and <code>.is-danger</code>. Note that these boxes work only with Font
            ...
            <div class="columns is-vcentered has-text-centered pt-30">
                ...
                <div class="column is-3">
                    ...
                    <div class="shadow-title primary-text">
                        Cloud based
                    </div>
                ...
                <div class="column is-3">
                    ...
                    <div class="shadow-title secondary-text">
                        Document management
                    </div>
                    <div class="shadow-text">
                        Lorem ipsum dolor sit amet, usu no ancillae verterem partiendo, mea ea.
                ...
                <div class="column is-3">
                    ...
                    <div class="shadow-title accent-text">
                        Corporate portal
                    </div>
                    <div class="shadow-text">
                        Lorem ipsum dolor sit amet, usu no ancillae verterem partiendo, mea ea.
            ...
            <div class="columns is-vcentered has-text-centered">
                ...
                <div class="column is-3">
                    ...
                    <div class="shadow-title info-text">
                        Social Network
                    </div>
                    <div class="shadow-text">
                        Lorem ipsum dolor sit amet, usu no ancillae verterem partiendo, mea ea.
                ...
                <div class="column is-3">
                    ...
                    <div class="shadow-title success-text">
                        Media content
                    </div>
                    <div class="shadow-text">
                        Lorem ipsum dolor sit amet, usu no ancillae verterem partiendo, mea ea.
                ...
                <div class="column is-3">
                    ...
                    <div class="shadow-title warning-text">
                        Multiple users
                    </div>
                    <div class="shadow-text">
                        Lorem ipsum dolor sit amet, usu no ancillae verterem partiendo, mea ea.
            ...
            <div class="columns is-vcentered has-text-centered">
                ...
                <div class="column is-3">
                    ...
                    <div class="shadow-title danger-text">
                        Awarded 3 times
                    </div>
                    <div class="shadow-text">
                        Lorem ipsum dolor sit amet, usu no ancillae verterem partiendo, mea ea.
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Display an eye catching feature matrix by using Bulkit long shadow icon boxes.
                            Long shadow icon boxes are available in several color schemes and have a square shape by
                            default. You can make them rounded by adding the <code>.rounded</code> class to a
                            <code>.shadow-icon-box</code> element. Available modifiers are <code>.is-primary</code>,
                            <code>.is-secondary</code>, <code>.is-accent</code>, <code>.is-info</code>,
                            <code>.is-success</code>, <code>.is-warning</code> and <code>.is-danger</code>. Note that these
                            boxes work only with Font Awesome icons at the moment.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns">
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-boxes.php#">Discover features</a></li>
                            <li><a href="_components-advancedui-boxes.php#">CMS integration</a></li>
                            <li><a href="_components-advancedui-boxes.php#">Customers</a></li>
                            <li><a href="_components-advancedui-boxes.php#">Weekly sessions</a></li>
                            <li><a href="_components-advancedui-boxes.php#">Free trials and demo</a></li>
                            <li><a href="_components-advancedui-boxes.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-boxes.php#">About us</a></li>
                            <li><a href="_components-advancedui-boxes.php#">About security</a></li>
                            <li><a href="_components-advancedui-boxes.php#">User guide</a></li>
                            <li><a href="_components-advancedui-boxes.php#">Terms of service</a></li>
                            <li><a href="_components-advancedui-boxes.php#">Terms of website use</a></li>
                            <li><a href="_components-advancedui-boxes.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-boxes.php#">Resources</a></li>
                            <li><a href="_components-advancedui-boxes.php#">Blog</a></li>
                            <li><a href="_components-advancedui-boxes.php#">FAQ</a></li>
                            <li><a href="_components-advancedui-boxes.php#">API documentation</a></li>
                            <li><a href="_components-advancedui-boxes.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-advancedui-boxes.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-advancedui-boxes.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-boxes.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-boxes.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-boxes.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-advancedui-boxes.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-boxes.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-advancedui-boxes.php#"></a></div> <!-- Concatenated jQuery and plugins -->
