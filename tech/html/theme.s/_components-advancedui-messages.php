...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-advancedui-messages.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-advancedui-messages.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-advancedui-messages.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-advancedui-messages.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-advancedui-messages.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <h2 class="subtitle is-4 components-subtitle">
                            Messages and toasts variations
                        </h2>
                        <p class="components-cta">
                            <a href="_components-advancedui-messages.php#start" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="messages-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section">
        <div class="container">
            <div id="start" class="section-title-wrapper has-text-centered">
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Basic message</h4>
                        <p class="no-padding">Messages are a convenient way to inform users when they accomplish some
                            actions. The markup is very simple, lightweight and highly customizable.</p>
                    </div>
                </div>
            </div>

            <div class="columns is-vcentered is-multiline pt-30">
                <div class="column is-6 is-offset-3">
                    <!-- Message -->
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Messages colors</h4>
                        <p class="no-padding">Message headers can have different colors, regarding the type of message you
                            wish to deliver. Available modifiers are <code>.msg-primary</code>, <code>.msg-secondary</code>,
                            <code>.msg-accent</code>, <code>.msg-info</code>, <code>.msg-success</code>,
                            <code>.msg-warning</code> and <code>.msg-danger</code>.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered is-multiline pt-30">
                <div class="column is-6 is-offset-3">
                    ...
                    <!-- Message -->
                    <article class="message msg-primary">
                        <h4 class="message-header">
                            <span>Primary</span>
                            <span class="delete" aria-label="delete"></span>
                        </h4>
                    ...
                    <!-- Message -->
                    <article class="message msg-secondary">
                        <h4 class="message-header">
                            <span>Secondary</span>
                            <span class="delete" aria-label="delete"></span>
                        </h4>
                    ...
                    <!-- Message -->
                    <article class="message msg-accent">
                        <h4 class="message-header">
                            <span>Accent</span>
                            <span class="delete" aria-label="delete"></span>
                        </h4>
                    ...
                    <!-- Message -->
                    <article class="message msg-info">
                        <h4 class="message-header">
                            <span>Info</span>
                            <span class="delete" aria-label="delete"></span>
                        </h4>
                    ...
                    <!-- Message -->
                    <article class="message msg-warning">
                        <h4 class="message-header">
                            <span>Warning</span>
                            <span class="delete" aria-label="delete"></span>
                        </h4>
                    ...
                    <!-- Message -->
                    <article class="message msg-danger">
                        <h4 class="message-header">
                            <span>Danger</span>
                            <span class="delete" aria-label="delete"></span>
                        </h4>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block pb-20">
                        <h4>Icon Messages</h4>
                        <p class="no-padding">Sometimes, you will need something that is visually stronger. Icon messages
                            are pefect for that. They feature a big colored icon that you can use to quicly inform the user
                            before he dives into content. Available modifiers to the <code>.icon-msg</code> are
                            <code>.primary-msg</code>, <code>.secondary-msg</code>, <code>.accent-msg</code>,
                            <code>.info-msg</code>, <code>.success-msg</code>, <code>.warning-msg</code> and
                            <code>.danger-msg</code>.
                        </p>
                    </div>
                </div>
            </div>

            <div class="columns is-vcentered is-multiline pt-30 pb-60">
                <div class="column is-6 is-offset-3">
                    <!-- Message -->
    ...
    <div class="section section-feature-grey">
        <div class="container">
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Toast positions</h4>
                        <p class="no-padding">Bulkit Toast messages are based on the <a href="http://izitoast.marcelodolce.com/" target="_blank">IziToast</a> jQuery library. The
                            library is very easy to use and to customize. It also offers a lot of options. Check out the <a href="http://izitoast.marcelodolce.com/#documentation" target="_blank">plugin
                                documentation</a> for more details about usage. In the following example you can see the
                            available toast positions. Use the <code>position</code> option to set your toast position.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered is-multiline has-text-centered pt-30">
                <div class="column">
                    <button id="top-left-toast" class="button btn-align raised">Top Left</button>
                </div>
                <div class="column">
                    <button id="top-center-toast" class="button btn-align raised">Top Center</button>
                </div>
                <div class="column">
                    <button id="top-right-toast" class="button btn-align raised">Top Right</button>
                </div>
                <div class="column">
                    <button id="center-toast" class="button btn-align raised">Centered</button>
                </div>
                <div class="column">
                    <button id="bottom-left-toast" class="button btn-align raised">Bottom Left</button>
                </div>
                <div class="column">
                    <button id="bottom-center-toast" class="button btn-align raised">Bottom Center</button>
                </div>
                <div class="column">
                    <button id="bottom-right-toast" class="button btn-align raised">Bottom Right</button>
                </div>
            </div>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Message Toasts</h4>
                        <p class="no-padding">You can also use toasts to display success or error messages. Izitoast offers
                            built-in messages but you can create your own like in the following example.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered is-multiline has-text-centered pt-30">
                ...
                <div class="column is-3">
                    <button id="success-toast" class="button btn-align success-btn raised rounded">Success toast</button>
                </div>
                <div class="column is-3">
                    <button id="warning-toast" class="button btn-align warning-btn raised rounded">Warning toast</button>
                </div>
                <div class="column is-3">
                    <button id="danger-toast" class="button btn-align danger-btn raised rounded">Danger toast</button>
                </div>
            </div>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Toast Animations</h4>
                        <p class="no-padding">The way toasts appear and disappear from the screen can be controlled via
                            options. Use the <code>transitionIn</code> and the <code>transitionOut</code> options to define
                            enter and leave animations. Check the <a href="http://izitoast.marcelodolce.com/#documentation" target="_blank">plugin documentation</a> for more details.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered is-multiline has-text-centered pt-30">
                <div class="column">
                    <button id="fade-toast" class="button btn-align raised">Fade Static</button>
                </div>
                <div class="column">
                    <button id="fadeUp-toast" class="button btn-align raised">Fade Up</button>
                </div>
                <div class="column">
                    <button id="fadeDown-toast" class="button btn-align raised">Fade Down</button>
                </div>
                <div class="column">
                    <button id="fadeLeft-toast" class="button btn-align raised">Fade Left</button>
                </div>
                <div class="column">
                    <button id="fadeRight-toast" class="button btn-align raised">Fade Right</button>
                </div>
                <div class="column">
                    <button id="bounceUp-toast" class="button btn-align raised">Bounce Up</button>
                </div>
                <div class="column">
                    <button id="bounceDown-toast" class="button btn-align raised">Bounce Down</button>
                </div>
                <div class="column">
                    <button id="bounceLeft-toast" class="button btn-align raised">Bounce Left</button>
                </div>
                <div class="column">
                    <button id="bounceRight-toast" class="button btn-align raised">Bounce Right</button>
                </div>
                <div class="column">
                    <button id="flip-toast" class="button btn-align raised">Flip</button>
                </div>
            </div>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Custom Toasts</h4>
                        <p class="no-padding">Detailed API and examples let you customize toasts to exactly fit your needs.
                            The following examples feature an interactive toast, a bubble toast including callbacks and
                            custom layout toast.</p>
                    </div>
                </div>
            </div>

            <div class="columns is-vcentered is-multiline has-text-centered pt-30 pb-60">
                <div class="column">
                    <button id="question-toast" class="button btn-align accent-btn raised rounded">Question toast</button>
                </div>
                <div class="column">
                    <button id="balloon-toast" class="button btn-align secondary-btn raised rounded">Balloon toast</button>
                </div>
                <div class="column">
                    <button id="custom-toast" class="button btn-align primary-btn raised rounded">Custom toast</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="columns">
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-messages.php#">Discover features</a></li>
                            <li><a href="_components-advancedui-messages.php#">CMS integration</a></li>
                            <li><a href="_components-advancedui-messages.php#">Customers</a></li>
                            <li><a href="_components-advancedui-messages.php#">Weekly sessions</a></li>
                            <li><a href="_components-advancedui-messages.php#">Free trials and demo</a></li>
                            <li><a href="_components-advancedui-messages.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-messages.php#">About us</a></li>
                            <li><a href="_components-advancedui-messages.php#">About security</a></li>
                            <li><a href="_components-advancedui-messages.php#">User guide</a></li>
                            <li><a href="_components-advancedui-messages.php#">Terms of service</a></li>
                            <li><a href="_components-advancedui-messages.php#">Terms of website use</a></li>
                            <li><a href="_components-advancedui-messages.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-messages.php#">Resources</a></li>
                            <li><a href="_components-advancedui-messages.php#">Blog</a></li>
                            <li><a href="_components-advancedui-messages.php#">FAQ</a></li>
                            <li><a href="_components-advancedui-messages.php#">API documentation</a></li>
                            <li><a href="_components-advancedui-messages.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-advancedui-messages.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-advancedui-messages.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-messages.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-messages.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-messages.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-advancedui-messages.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-messages.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-advancedui-messages.php#"></a></div> <!-- Concatenated jQuery and plugins -->
