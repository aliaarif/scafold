...
<head>
    ...
    <title> Bulkit :: Navbar static solid</title>
...
<body id="component-page">
    ...
    <!-- Fullheight Hero -->
    <div id="navbar-solid" class="hero is-fullheight is-feature-grey">

        <nav id="demo-nav" class="navbar navbar-wrapper is-solid is-static">
            <div class="container">
                <!-- Brand -->
                <div class="navbar-brand">
                    <a class="navbar-item" href="index.php">
                        <img src="assets/img/logos/bulkit-purple.svg" alt="">
                    </a>
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-start">
                        ...
                        <div class="navbar-item has-dropdown is-hoverable is-hidden-mobile">
                            <a class="navbar-link" href="_components-layout-navbar-static-solid.php#v1">
                                V1
                            </a>
                            <div class="navbar-dropdown is-boxed is-medium">
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="agency-home.php">
                                    <i class="material-icons">weekend</i>
                                    <span>Agency Kit</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="startup-landing.php">
                                    <i class="material-icons">wb_incandescent</i>
                                    <span>Startup Kit</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit1-landing.php">
                                    <i class="material-icons">apps</i>
                                    <span>Landing Kit 1</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit2-landing.php">
                                    <i class="material-icons">timelapse</i>
                                    <span>Landing Kit 2</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit3-landing.php">
                                    <i class="material-icons">assistant</i>
                                    <span>Landing Kit 3</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit4-landing.php">
                                    <i class="material-icons">brightness_2</i>
                                    <span>Landing Kit 4</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit5-landing.php">
                                    <i class="material-icons">toys</i>
                                    <span>Landing Kit 5</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit6-landing.php">
                                    <i class="material-icons">mouse</i>
                                    <span>Landing Kit 6</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit7-landing.php">
                                    <i class="material-icons">work</i>
                                    <span>Landing Kit 7</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit8-landing.php">
                                    <i class="material-icons">public</i>
                                    <span>Landing Kit 8</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit9-landing.php">
                                    <i class="material-icons">assessment</i>
                                    <span>Landing Kit 9</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit10-landing.php">
                                    <i class="material-icons">account_balance</i>
                                    <span>Landing Kit 10</span>
                                </a>
                                <!-- Dropdown item -->
                                <a class="navbar-item is-menu" href="kit11-landing.php">
                                    <i class="material-icons">shop</i>
                                    <span>Landing Kit 11</span>
                                </a>
                            </div>
                        </div>
                        <!-- Mobile dropdown -->
                ...
                <div class="columns is-vcentered">
                    <div class="column is-8 is-offset-2 has-text-centered">
                        ...
                        <p class="has-text-centered">
                            <a href="_components-layout-navbar-static-solid.php#" class="button button-cta btn-align primary-btn rounded z-index-2">
                                Get Started
                            </a>
                        </p>
                    </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-layout-navbar-static-solid.php#">Customers</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">Weekly sessions</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">Free trials and demo</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-layout-navbar-static-solid.php#">About us</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">About security</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">User guide</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">Terms of service</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">Terms of website use</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-layout-navbar-static-solid.php#">Blog</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">FAQ</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">API documentation</a></li>
                            <li><a href="_components-layout-navbar-static-solid.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-layout-navbar-static-solid.php#" class="level-item">
    ...
    <div class="nav-switch">
        <div class="panel-title">
            <h3 class="title is-6">Switch Colors</h3>
        </div>
        <div class="panel-body">
            <div id="nav-solid" class="color-dot is-white"></div>
            <div id="nav-reverse" class="color-dot is-variation is-reverse"></div>
            <div id="nav-blue" class="color-dot is-variation is-blue"></div>
            <div id="nav-purple" class="color-dot is-variation is-purple"></div>
            <div id="nav-red" class="color-dot is-variation is-red"></div>
        </div>
    </div>
    <!-- Side navigation -->
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-layout-navbar-static-solid.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-navbar-static-solid.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-layout-navbar-static-solid.php#"></a></div> <!-- Concatenated jQuery and plugins -->
