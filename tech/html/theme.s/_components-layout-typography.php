...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-layout-typography.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-layout-typography.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-layout-typography.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-layout-typography.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-layout-typography.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <p class="components-cta">
                            <a href="_components-layout-typography.php#basic" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="typography-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <div id="basic" class="columns pb-60">
                <div class="column is-6 is-offset-3">
                    <div class="content">
                        <h1 class="is-1 mt-60">This is a H1 Heading</h1>
                        <h2 class="is-1 mt-40">This is a H2 Heading</h2>
                        <h3 class="is-1 mt-40">This is a H3 Heading</h3>
                        <h4 class="is-1 mt-40">This is a H4 Heading</h4>
                        <h5 class="is-1 mt-40">This is a H5 Heading</h5>
                        <h6 class="is-1 mt-40">This is a H6 Heading</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section section-feature-grey">
        <div class="container">
            ...
            <div class="columns pb-60">
                <div class="column is-6 is-offset-3">
                    <div class="content">
                        <h1 class="title is-1 mt-60">This is a H1 Heading</h1>
                        <h2 class="title is-2 mt-40">This is a H2 Heading</h2>
                        <h3 class="title is-3 mt-40">This is a H3 Heading</h3>
                        <h4 class="title is-4 mt-40">This is a H4 Heading</h4>
                        <h5 class="title is-5 mt-40">This is a H5 Heading</h5>
                        <h6 class="title is-6 mt-40">This is a H6 Heading</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="columns pb-60">
                <div class="column is-6 is-offset-3">
                    <div class="content">
                        <h3 class="title is-3 mt-40">This is a H3 Heading</h3>
                        <p>Lorem ipsum dolor sit amet, qui ne ludus commodo urbanitas, vix augue honestatis no. Vocibus
                            explicari ut eos. Est putent minimum incorrupte ne, rebum fabellas luptatum ea per, zril nonumy
                            scaevola vix et. Id reque iriure quo, ei graecis molestie nam, illud tincidunt sed in. Cu sea
                            vivendum qualisque vituperatoribus.</p>
                    </div>
                    <div class="content">
                        <h3 class="title is-3 text-bold mt-40">This is a H3 Bold Heading</h3>
                        <p>Lorem ipsum dolor sit amet, qui ne ludus commodo urbanitas, vix augue honestatis no. Vocibus
                            explicari ut eos. Est putent minimum incorrupte ne, rebum fabellas luptatum ea per, zril nonumy
                            scaevola vix et. Id reque iriure quo, ei graecis molestie nam, illud tincidunt sed in. Cu sea
                            vivendum qualisque vituperatoribus.</p>
                    ...
                    <div class="content">
                        <h3 class="title is-3 text-bolder mt-40">This is a H3 Bolder Heading</h3>
                        <p>Lorem ipsum dolor sit amet, qui ne ludus commodo urbanitas, vix augue honestatis no. Vocibus
                            explicari ut eos. Est putent minimum incorrupte ne, rebum fabellas luptatum ea per, zril nonumy
                            scaevola vix et. Id reque iriure quo, ei graecis molestie nam, illud tincidunt sed in. Cu sea
                            vivendum qualisque vituperatoribus.</p>
    ...
    <div class="section section-feature-grey">
        <div class="container">
            ...
            <div class="columns pb-60">
                <div class="column is-6 is-offset-3">
                    <div class="content">
                        <p class="is-size-1">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-2">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-3">Lorem ipsum dolor sit amet</p>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="columns pb-60">
                <div class="column is-6 is-offset-3">
                    <div class="content">
                        <p class="is-size-4 primary-text">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-4 secondary-text">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-4 accent-text">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-4 info-text">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-4 success-text">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-4 warning-text">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-4 danger-text">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-4 dark-text">Lorem ipsum dolor sit amet</p>
                        <p class="is-size-4 light-text dark-bg">Lorem ipsum dolor sit amet</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="column is-6 is-offset-3">
                    <div class="content">
                        <blockquote>Ut venenatis, nisl scelerisque sollicitudin fermentum, quam libero hendrerit ipsum, ut
                            blandit est tellus sit amet turpis.</blockquote>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section section-feature-grey">
        <div class="container">
            ...
            <div class="columns pb-60">
                ...
                <div class="column is- is-offset-2">
                    <div class="columns">
                        <div class="column">
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-layout-typography.php#">Customers</a></li>
                            <li><a href="_components-layout-typography.php#">Weekly sessions</a></li>
                            <li><a href="_components-layout-typography.php#">Free trials and demo</a></li>
                            <li><a href="_components-layout-typography.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-layout-typography.php#">About us</a></li>
                            <li><a href="_components-layout-typography.php#">About security</a></li>
                            <li><a href="_components-layout-typography.php#">User guide</a></li>
                            <li><a href="_components-layout-typography.php#">Terms of service</a></li>
                            <li><a href="_components-layout-typography.php#">Terms of website use</a></li>
                            <li><a href="_components-layout-typography.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-layout-typography.php#">Blog</a></li>
                            <li><a href="_components-layout-typography.php#">FAQ</a></li>
                            <li><a href="_components-layout-typography.php#">API documentation</a></li>
                            <li><a href="_components-layout-typography.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-layout-typography.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-layout-typography.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-typography.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-typography.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-typography.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-layout-typography.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-typography.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-layout-typography.php#"></a></div> <!-- Concatenated jQuery and plugins -->
