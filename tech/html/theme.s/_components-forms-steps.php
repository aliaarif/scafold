...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-forms-steps.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-forms-steps.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-forms-steps.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-forms-steps.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-forms-steps.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <p class="components-cta">
                            <a href="_components-forms-steps.php#step-form" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="steps-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <h4>Rounded step form</h4>
                        <p class="no-padding">Bulkit comes with the Steps Bulma extension. This way, you can easily build a step form for your registration, checkout or whatever process you want to build. Step forms navigation is controlled with javascript.</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="steps" id="stepsV1">
                                ...
                                <div class="step-content has-text-centered">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input" name="dribbble" id="dribbble" type="text" placeholder="Dribbble account url" autofocus data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="steps-actions">
                                <div class="steps-action">
                                    <a href="_components-forms-steps.php#" data-nav="previous" class="button is-light button-cta is-bold btn-align">Back</a>
                                    <a href="_components-forms-steps.php#" data-nav="next" class="button secondary-btn button-cta is-bold raised btn-align">Next</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <span class="tag is-secondary">Reworked 3.0.0</span>
                        <h4>Squared step form</h4>
                        <p class="no-padding">You can make the edges of the steps indicators squared. Add the <code>.is-squared</code> class to the <code>.steps-wrapper</code> parent element to make the indicators squared.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="column is-8 is-offset-2">
                    ...
                    <div class="steps-wrapper is-squared">
                        ...
                        <div class="steps" id="stepsV12">
                                ...
                                <div class="step-content has-text-centered is-active">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input" name="username2" id="username2" type="text" placeholder="Username" autofocus data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control has-icon has-icon-right">
                                                    <input class="input" type="password" name="password2" id="password2" placeholder="Password" data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control has-icon has-icon-right">
                                                    <input class="input" type="password" name="password_confirm2" id="password_confirm2" placeholder="Confirm password" data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="step-content has-text-centered">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input" name="firstname2" id="firstname2" type="text" placeholder="Firstname" autofocus data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control has-icon has-icon-right">
                                                    <input class="input" type="text" name="lastname2" id="lastname2" placeholder="Last name" data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control has-icon has-icon-right">
                                                    <input class="input" type="email" name="email2" id="email2" placeholder="Email" data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="steps-actions">
                                <div class="steps-action">
                                    <a href="_components-forms-steps.php#" data-nav="previous" class="button button-cta is-light is-bold btn-align">Back</a>
                                    <a href="_components-forms-steps.php#" data-nav="next" class="button secondary-btn button-cta is-bold raised btn-align">Next</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <span class="tag is-secondary">Reworked 3.0.0</span>
                        <h4>Animated step form</h4>
                        <p class="no-padding">You can easily animate a step form by adding animation classes to the <code>.steps-content</code> element. For example, the form below uses the <code>.fadeInUp</code> animation.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="column is-8 is-offset-2">
                    ...
                    <div class="steps-wrapper">
                        ...
                        <div class="steps" id="stepsV13">
                            ...
                            <div class="steps-content">
                                <!-- Step content -->
                                <div class="step-content has-text-centered is-active animated preFadeInUp fadeInUp">
                                    <!-- Field -->
                                    <div class="field">
                                        <div class="field-label is-normal">
                                            <label class="label">Username</label>
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input" name="username3" id="username3" type="text" placeholder="Username" autofocus data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control has-icon has-icon-right">
                                                    <input class="input" type="password" name="password3" id="password3" placeholder="Password" data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control has-icon has-icon-right">
                                                    <input class="input" type="password" name="password_confirm3" id="password_confirm3" placeholder="Confirm password" data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <!-- Step content -->
                                <div class="step-content has-text-centered animated preFadeInUp fadeInUp">
                                    <!-- Field -->
                                    <div class="field">
                                        <div class="field-label is-normal">
                                            <label class="label">First name</label>
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input" name="firstname3" id="firstname3" type="text" placeholder="Firstname" autofocus data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control has-icon has-icon-right">
                                                    <input class="input" type="text" name="lastname3" id="lastname3" placeholder="Last name" data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control has-icon has-icon-right">
                                                    <input class="input" type="email" name="email3" id="email3" placeholder="Email" data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="step-content has-text-centered animated preFadeInUp fadeInUp">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input" name="facebook3" id="facebook3" type="text" placeholder="Facebook account url" autofocus data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input" name="twitter3" id="twitter3" type="text" placeholder="Twitter account url" autofocus data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control">
                                                    <input class="input" name="dribbble3" id="dribbble3" type="text" placeholder="Dribbble account url" autofocus data-validate="require">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="steps-actions">
                                <div class="steps-action">
                                    <a href="_components-forms-steps.php#" data-nav="previous" class="button button-cta is-bold is-light btn-align">Back</a>
                                    <a href="_components-forms-steps.php#" data-nav="next" class="button secondary-btn button-cta is-bold raised btn-align">Next</a>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Double column Step Form -->
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <span class="tag is-secondary">Reworked 3.0.0</span>
                        <h4>Double Columns steps</h4>
                        <p class="no-padding">You can organize fields with the bulma grid inside a step form. Just create a grid and place the fields inside columns.</p>
                    </div>
                </div>
            </div>

            <div class="columns mt-20 pb-60">
                <div class="column is-8 is-offset-2">
                    <!-- Wrapper -->
                    <div class="steps-wrapper is-double-column">
                        <!-- Steps Indicators -->
                        <div class="steps" id="stepsV13">
                            <!-- Indicator -->
                            <div class="step-item is-active">
                                        ...
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="username4" id="username4" type="text" placeholder="Username" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control has-icon has-icon-right">
                                                            <input class="input" type="password" name="password4" id="password4" placeholder="Password" data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control has-icon has-icon-right">
                                                            <input class="input" type="password" name="password_confirm4" id="password_confirm4" placeholder="Confirm password" data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="company" id="company" type="text" placeholder="Company name" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control has-icon has-icon-right">
                                                            <input class="input" type="text" name="department" id="department" placeholder="Department" data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control has-icon has-icon-right">
                                                            <input class="input" type="text" name="location" id="location" placeholder="Location" data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="firstname4" id="firstname4" type="text" placeholder="First name" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control has-icon has-icon-right">
                                                            <input class="input" type="text" name="lastname4" id="lastname4" placeholder="Last name" data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control has-icon has-icon-right">
                                                            <input class="input" type="email" name="email4" id="email4" placeholder="Email" data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="position" id="position" type="text" placeholder="Position" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                <div class="field-label is-normal">
                                                    <label class="label">Recruited since</label>
                                                </div>
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control has-icon has-icon-right">
                                                            <input class="input" type="text" name="joined" id="joined" placeholder="Joined on" data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                <div class="field-label is-normal">
                                                    <label class="label">Completed Projects</label>
                                                </div>
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control has-icon has-icon-right">
                                                            <input class="input" type="number" name="projects" id="projects" placeholder="Number of completed projects" data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="step-content has-text-centered animated preFadeInUp fadeInUp">
                                    <div class="columns">
                                        ...
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="facebook4" id="facebook4" type="text" placeholder="Facebook account url" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="twitter4" id="twitter4" type="text" placeholder="Twitter account url" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="dribbble4" id="dribbble4" type="text" placeholder="Dribbble account url" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                <div class="field-label is-normal">
                                                    <label class="label">Linkedin account</label>
                                                </div>
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="linkedin" id="linkedin" type="text" placeholder="Linkedin account url" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                <div class="field-label is-normal">
                                                    <label class="label">Behance account</label>
                                                </div>
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="behance" id="behance" type="text" placeholder="Behance account url" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                <div class="field-label is-normal">
                                                    <label class="label">Reddit account</label>
                                                </div>
                                                <div class="field-body">
                                                    <div class="field">
                                                        <div class="control">
                                                            <input class="input" name="reddit" id="reddit" type="text" placeholder="Reddit account url" autofocus data-validate="require">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="columns footer-columns is-flex-mobile">
                    ...
                    <div class="column is-half-mobile">
                        <div class="footer-column">
                            ...
                            <ul class="link-list">
                                ...
                                <li><a href="_components-forms-steps.php#">Customers</a></li>
                                <li><a href="_components-forms-steps.php#">Weekly sessions</a></li>
                                <li><a href="_components-forms-steps.php#">Free trials and demo</a></li>
                                <li><a href="_components-forms-steps.php#">What's next ?</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="column is-half-mobile">
                        <div class="footer-column">
                            ...
                            <ul class="link-list">
                                <li><a href="_components-forms-steps.php#">About us</a></li>
                                <li><a href="_components-forms-steps.php#">About security</a></li>
                                <li><a href="_components-forms-steps.php#">User guide</a></li>
                                <li><a href="_components-forms-steps.php#">Terms of service</a></li>
                                <li><a href="_components-forms-steps.php#">Terms of website use</a></li>
                                <li><a href="_components-forms-steps.php#">Privacy policy</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="column is-half-mobile">
                        <div class="footer-column">
                            ...
                            <ul class="link-list">
                                ...
                                <li><a href="_components-forms-steps.php#">Blog</a></li>
                                <li><a href="_components-forms-steps.php#">FAQ</a></li>
                                <li><a href="_components-forms-steps.php#">API documentation</a></li>
                                <li><a href="_components-forms-steps.php#">Admin guide</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- Column -->
                            ...
                            <div class="footer-header">
                                <nav class="level is-mobile">
                                    <div class="level-left level-social">
                                        <a href="_components-forms-steps.php#" class="level-item">
        ...
        <div class="side-navigation-menu">
            ...
            <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
                ...
                <ul class="navigation-menu">
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">weekend</span>Agency kit</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">work</span>Landing kit
                            7</a>
                        <ul>
                    ...
                    <li class="has-children">
                        <a class="parent-link" href="_components-forms-steps.php#">
            ...
            <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
                ...
                <!-- Navigation body -->
                <ul class="navigation-menu">
                    <li class="has-children"><a class="parent-link has-new" href="_components-forms-steps.php#"><span class="material-icons">domain</span>Company</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link has-new" href="_components-forms-steps.php#"><span class="material-icons">call</span>Contact</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link has-new" href="_components-forms-steps.php#"><span class="material-icons">book</span>Blog</a>
                        <ul>
                    ...
                    <li class="has-children">
                        <a class="parent-link has-new" href="_components-forms-steps.php#"><span class="material-icons">highlight</span>Error Pages</a>
                        <ul>
            ...
            <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
                ...
                <!-- Navigation body -->
                <ul class="navigation-menu">
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">view_quilt</span>Layout</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">subject</span>Navbars</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">view_stream</span>Sections</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">playlist_add_check</span>Basic
                            UI</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">playlist_add</span>Advanced
                            UI</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">check_box</span>Forms</a>
                        <ul>
                    ...
                    <li class="has-children"><a class="parent-link" href="_components-forms-steps.php#"><span class="material-icons">adjust</span>Icons</a>
                        <ul>
        ...
        <!-- /Side navigation -->
        <!-- Back To Top Button -->
        <div id="backtotop"><a href="_components-forms-steps.php#"></a></div> <!-- Concatenated jQuery and plugins -->
