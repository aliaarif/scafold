...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-basicui-popups.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-basicui-popups.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-basicui-popups.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-basicui-popups.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-basicui-popups.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <p class="components-cta">
                            <a href="_components-basicui-popups.php#popovers" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="popups-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="scrollnav" class="scroll-nav-wrapper">
        <div class="container">
            <div class="tabs scrollnav-tabs is-centered">
                <ul>
                    <li class="scrollnav-item is-active"><a href="_components-basicui-popups.php#popovers">Popovers</a></li>
                    <li class="scrollnav-item"><a href="_components-basicui-popups.php#tooltips">Tooltips</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div id="popovers" class="section">
        <div class="container">
            <div id="popovers" class="section-title-wrapper has-text-centered">
            ...
            <div class="columns is-vcentered">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Popover triggers</h4>
                        <p class="no-padding">Popovers can be triggered by click, on hover and on focus. To set up a popover on an element, use the data attribute <code>data-toggle="popover"</code>. You can then pass other options with data attributes, like <code>data-trigger=""</code>, <code>data-placement=""</code>, <code>data-title=""</code> and <code>data-content=""</code> for the popover content.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered has-text-centered">
                <div class="column is-3 is-offset-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="top" title="Click popover" data-content="And here's some amazing content. It's very engaging. Right?">
                        Click me</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="top" title="Hover Popover" data-trigger="hover" data-content="And here's some amazing content. It's very engaging. Right?">
                        Hover me</div>
                </div>
            </div>
                ...
                <div class="column is-6 is-offset-3">
                    ...
                    <div class="accordion-wrapper">
                        <div class="toggle-wrap">
                            <span class="trigger"><a href="_components-basicui-popups.php#"><i class="im im-icon-Coding is-icon-2x"></i> SHOW CODE<i class="im im-icon-Add"></i></a></span>
                            <div class="toggle-container">
                                <div class="navigation-tabs animated-tabs simple-tabs mb-40">
                                    <div class="tabs is-right">
                                        <ul>
                                            <li class="tab-link is-active" data-tab="click"><a>click</a></li>
                                            <li class="tab-link" data-tab="hover"><a>hover</a></li>
                                            <li class="tab-link" data-tab="focus"><a>focus</a></li>
                                        </ul>
                                    </div>
                                    <div id="click" class="navtab-content is-active">
        ...
        &#x3C;div class=&#x22;button btn-align&#x22; data-toggle=&#x22;popover&#x22;
            ...
            Click me&#x3C;/div&#x3E;
                                    ...
                                    <div id="hover" class="navtab-content">
                                        <figure class="highlight highlight-block"><pre><code class="html code-highlight">
        &#x3C;div class=&#x22;button btn-align&#x22; data-toggle=&#x22;popover&#x22;
             data-placement=&#x22;top&#x22;
             title=&#x22;Click popover&#x22;
        ...
        &#x3C;div class=&#x22;button btn-align&#x22; data-toggle=&#x22;popover&#x22;
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Use the <code>data-placement=""</code> attribute to position a popover. Available values are <code>top</code>, <code>bottom</code>, <code>left</code> and <code>right</code>.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered has-text-centered">
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="right" title="Right" data-trigger="hover" data-content="A right aligned popover is a really boring thing in the real life.">
                        Right</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="top" title="Top" data-trigger="hover" data-content="A top aligned popover is a really boring thing in the real life.">
                        Top</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="bottom" title="Bottom" data-trigger="hover" data-arrowcolor="#f7f7f7" data-content="A bottom aligned popover is a really boring thing in the real life.">
                        Bottom</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="left" title="Left" data-trigger="hover" data-content="A left aligned popover is a really boring thing in the real life.">
                        Left</div>
                </div>
            </div>
            <!-- Popover positions -->
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Custom examples</h4>
                        <p class="no-padding">You can customize header colors with more data attributes. Use <code>data-title-backcolor=""</code>, <code>data-title-textcolor=""</code> and <code>data-arrowcolor=""</code> to customize your popover. Check the code examples.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered has-text-centered">
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="right" title="Right" data-trigger="hover" data-title-backcolor="#eda514" data-title-textcolor="#fff" data-content="A right aligned popover is a really boring thing in the real life.">
                        Right</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="top" title="Top" data-trigger="hover" data-title-backcolor="#fff" data-content="A top aligned popover is a really boring thing in the real life.">
                        Top</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="bottom" title="Bottom" data-trigger="hover" data-arrowcolor="#00b289" data-title-backcolor="#00b289" data-title-textcolor="#fff" data-content="A bottom aligned popover is a really boring thing in the real life.">
                        Bottom</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="popover" data-placement="left" title="Left" data-trigger="hover" data-title-backcolor="#039BE5" data-title-textcolor="#fff" data-content="A left aligned popover is a really boring thing in the real life.">
                        Left</div>
                </div>
            </div>

            <div class="columns pb-60">
                <div class="column is-6 is-offset-3">
                    <!-- Code section -->
                    <div class="accordion-wrapper">
                        <div class="toggle-wrap">
                            ...
                            <div class="toggle-container">
                                <div class="navigation-tabs animated-tabs simple-tabs mb-40">
                                    <div class="tabs is-right">
                                        <ul>
                                            <li class="tab-link is-active" data-tab="orange"><a>orange</a></li>
                                            <li class="tab-link" data-tab="white"><a>white</a></li>
                                            <li class="tab-link" data-tab="green"><a>green</a></li>
                                        </ul>
                                    </div>
                                    <div id="orange" class="navtab-content is-active">
                                        <figure class="highlight highlight-block"><pre><code class="html code-highlight">
        &#x3C;div class=&#x22;button btn-align&#x22; data-toggle=&#x22;popover&#x22;
                 data-placement=&#x22;right&#x22;
                 title=&#x22;Right&#x22;
                 data-trigger=&#x22;hover&#x22;
                 data-title-backcolor=&#x22;#eda514&#x22;
                ...
                Right&#x3C;/div&#x3E;
                                    ...
                                    <div id="white" class="navtab-content">
                                        <figure class="highlight highlight-block"><pre><code class="html code-highlight">
        &#x3C;div class=&#x22;button btn-align&#x22; data-toggle=&#x22;popover&#x22;
                 data-placement=&#x22;top&#x22;
                 title=&#x22;Top&#x22;
                ...
                Top&#x3C;/div&#x3E;
                                    ...
                                    <div id="green" class="navtab-content">
                                        <figure class="highlight highlight-block"><pre><code class="html code-highlight">
        &#x3C;div class=&#x22;button btn-align&#x22; data-toggle=&#x22;popover&#x22;
                 data-placement=&#x22;bottom&#x22;
                 title=&#x22;Bottom&#x22;
                 data-trigger=&#x22;hover&#x22;
                 data-title-backcolor=&#x22;#00b289&#x22;
                 data-title-textcolor=&#x22;#fff&#x22;
                 data-arrowcolor=&#x22;#00b289&#x22;
                 data-content=&#x22;A bottom aligned popover is a really boring thing in the real life.&#x22;&#x3E;
                Bottom&#x3C;/div&#x3E;
                                    </code></pre>
                                        </figure>
                                    </div>
    ...
    <div class="section section-feature-grey">
        <div class="container">
            <div id="tooltips" class="section-title-wrapper has-text-centered">
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p>Tooltips can be triggered by click, on hover and on focus. To set up a tooltip on an element, use the data attribute <code>data-toggle="popover"</code>. You can then pass other options with data attributes, like <code>data-trigger=""</code>, <code>data-placement=""</code>.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered has-text-centered">
                <div class="column is-3 is-offset-3">
                    <div class="button btn-align" data-toggle="tooltip" data-placement="top" data-trigger="click" data-title="Top tooltip">
                        Click tooltip</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="tooltip" data-placement="top" data-title="Top tooltip">
                        Hover tooltip</div>
                </div>
            </div>
                        ...
                        <div class="toggle-wrap">
                            ...
                            <div class="toggle-container">
                                <div class="navigation-tabs animated-tabs simple-tabs mb-40">
                                    <div class="tabs is-right">
                                        <ul>
                                            <li class="tab-link is-active" data-tab="tooltip-click"><a>click</a></li>
                                            <li class="tab-link" data-tab="tooltip-hover"><a>hover</a></li>
                                            <li class="tab-link" data-tab="tooltip-focus"><a>focus</a></li>
                                        </ul>
                                    </div>
                                    <div id="tooltip-click" class="navtab-content is-active">
                                        <figure class="highlight highlight-block"><pre><code class="html code-highlight">
        &#x3C;div class=&#x22;button btn-align&#x22; data-toggle=&#x22;tooltip&#x22;
             data-placement=&#x22;top&#x22;
            ...
            Click me&#x3C;/div&#x3E;
                                    ...
                                    <div id="tooltip-hover" class="navtab-content">
                                        <figure class="highlight highlight-block"><pre><code class="html code-highlight">
        &#x3C;div class=&#x22;button btn-align&#x22; data-toggle=&#x22;tooltip&#x22;
             data-placement=&#x22;top&#x22;
             data-title=&#x22;Top tooltip&#x22;
            ...
            Hover me&#x3C;/div&#x3E;
                                    ...
                                    <div id="tooltip-focus" class="navtab-content">
                                        <figure class="highlight highlight-block"><pre><code class="html code-highlight">
        &#x3C;div class=&#x22;button btn-align&#x22; data-toggle=&#x22;tooltip&#x22;
             data-placement=&#x22;top&#x22;
             data-title=&#x22;Top tooltip&#x22;
            ...
            <div class="columns is-vcentered pt-60 pb-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Use the <code>data-placement=""</code> attribute to position a tooltip. Available values are <code>top</code>, <code>bottom</code>, <code>left</code> and <code>right</code>.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered has-text-centered">
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="tooltip" data-placement="right" data-title="Right tooltip">
                        Right</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="tooltip" data-placement="left" data-title="Left tooltip">
                        Left</div>
                </div>
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="tooltip" data-placement="top" data-title="Top tooltip">
                ...
                <div class="column is-3">
                    <div class="button btn-align" data-toggle="tooltip" data-placement="bottom" data-title="Bottom tooltip">
                        Bottom</div>
                </div>
            </div>
            <!-- Basic tooltips -->
            ...
            <div class="columns">
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-basicui-popups.php#">Discover features</a></li>
                            <li><a href="_components-basicui-popups.php#">CMS integration</a></li>
                            <li><a href="_components-basicui-popups.php#">Customers</a></li>
                            <li><a href="_components-basicui-popups.php#">Weekly sessions</a></li>
                            <li><a href="_components-basicui-popups.php#">Free trials and v1</a></li>
                            <li><a href="_components-basicui-popups.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-basicui-popups.php#">About us</a></li>
                            <li><a href="_components-basicui-popups.php#">About security</a></li>
                            <li><a href="_components-basicui-popups.php#">User guide</a></li>
                            <li><a href="_components-basicui-popups.php#">Terms of service</a></li>
                            <li><a href="_components-basicui-popups.php#">Terms of website use</a></li>
                            <li><a href="_components-basicui-popups.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-basicui-popups.php#">Resources</a></li>
                            <li><a href="_components-basicui-popups.php#">Blog</a></li>
                            <li><a href="_components-basicui-popups.php#">FAQ</a></li>
                            <li><a href="_components-basicui-popups.php#">API documentation</a></li>
                            <li><a href="_components-basicui-popups.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-basicui-popups.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-basicui-popups.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-basicui-popups.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-basicui-popups.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-basicui-popups.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-basicui-popups.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-basicui-popups.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-basicui-popups.php#"></a></div> <!-- Concatenated jQuery and plugins -->
