...
<body class="is-theme-core">
            ...
            <div id="fancy-pricing" class="fancy-pricing">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-3 is-offset-1">
                        <!-- Pricing table -->
                        <div class="flex-card fancy-pricing-card light-bordered hover-inset primary">
                            ...
                            <div class="pt-10 pb-10">
                                <a class="button button-cta btn-align rounded raised primary-btn btn-outlined is-bold">Get
                                    started</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column is-4">
                        ...
                        <div class="flex-card fancy-pricing-card light-bordered hover-inset primary">
                            ...
                            <div class="plan-price">
                                <small>$</small> 40 <small>/ month</small>
                            </div>
                            <ul class="plan-features">
                            ...
                            <div class="pt-10 pb-10">
                                <a class="button button-cta btn-align rounded raised primary-btn">Get started</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-10 is-offset-1 is-hidden-mobile">
                        <div class="flex-card fancy-pricing-card streched light-bordered hover-inset primary">
                            <div>
                            ...
                            <div class="ml-auto">
                                <a class="button button-cta btn-align rounded raised primary-btn btn-outlined is-bold">Learn
                                    more</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column is-3 is-hidden-desktop is-hidden-tablet">
                        <div class="flex-card fancy-pricing-card light-bordered hover-inset primary">
                            ...
                            <div class="pt-30">
                                <a class="button button-cta btn-align rounded raised primary-btn btn-outlined is-bold mb-20">Learn
                                    more</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="tabs partner-tabs is-centered">
                <ul>
                    ...
                    <li><a><img class="partner-logo" src="https://bulkit.cssninja.io/assets/img/logos/custom/kromo.svg" alt=""></a></li>
    ...
    <div class="section section-feature-grey is-medium">
        <div class="container">
            ...
            <div class="has-text-centered">
                <img class="featured-svg" src="assets/img/graphics/compositions/cute-4-core.svg" data-base-url="assets/img/graphics/compositions/cute-4" data-extension=".svg" alt="">
            </div>
    ...
    <!-- Contact form -->
    <div class="section section-primary has-border-top is-medium is-relative footer-wavy">
        <div class="container">
            <!-- Title -->
            <div class="section-title-wrapper has-text-centered">
                ...
                <h4 class="light-text">Drop us a line or two</h4>
            </div>

            <div class="content-wrapper">
                <!-- Contact form -->
                <form class="contact-material">
                    <div class="columns">
                        <div class="column is-6 is-offset-3">
                            ...
                            <div class="has-text-centered huge-pb">
                                <button type="submit" class="button button-cta btn-align light-btn btn-outlined is-bold rounded no-lh">Send
                                    message</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="kit3-pricing.php#">Customers</a></li>
                            <li><a href="kit3-pricing.php#">Weekly sessions</a></li>
                            <li><a href="kit3-pricing.php#">Free trials and demo</a></li>
                            <li><a href="kit3-pricing.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="kit3-pricing.php#">About us</a></li>
                            <li><a href="kit3-pricing.php#">About security</a></li>
                            <li><a href="kit3-pricing.php#">User guide</a></li>
                            <li><a href="kit3-pricing.php#">Terms of service</a></li>
                            <li><a href="kit3-pricing.php#">Terms of website use</a></li>
                            <li><a href="kit3-pricing.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="kit3-pricing.php#">Blog</a></li>
                            <li><a href="kit3-pricing.php#">FAQ</a></li>
                            <li><a href="kit3-pricing.php#">API documentation</a></li>
                            <li><a href="kit3-pricing.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="kit3-pricing.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit3-pricing.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit3-pricing.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit3-pricing.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit3-pricing.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit3-pricing.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-pricing.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit3-pricing.php#"></a></div>
