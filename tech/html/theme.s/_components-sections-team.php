...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-sections-team.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-sections-team.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-sections-team.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-sections-team.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-sections-team.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <h2 class="subtitle is-4 components-subtitle">
                            "Our team" section variations.
                        </h2>
                        <p class="components-cta">
                            <a href="_components-sections-team.php#basic" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="team-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Team V1 -->
    <div id="basic" class="section is-medium">
        <div class="container">
                    ...
                    <div class="columns is-vcentered">
                        <div class="column is-4">
                            <div class="team-member">
                                <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/one.jpg">
                                <div class="item-overlay">
                                    <div class="overlay-quote has-text-centered">
                                        <div class="quote-text">
                                            <i class="fa fa-quote-right pull-left"></i>
                                            <br>Lorem ipsum dolor sit amet, ne nec justo posse salutandi, quas labores nec ne.<br>
                                        </div>
                                        <div class="social-links">
                                            <span><a href="_components-sections-team.php#"><i class="fa fa-twitter"></i></a></span>
                                            <span><a href="_components-sections-team.php#"><i class="fa fa-linkedin"></i></a></span>
                                            <span><a href="_components-sections-team.php#"><i class="fa fa-dribbble"></i></a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="member-name has-text-centered pt-10 pb-10">
                                <span>Alex</span> <span class="last-name">Walsh</span>
                                <div class="position">Lead Designer</div>
                            </div>
                        </div>
                        <div class="column is-4">
                            <div class="team-member">
                                <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/two.jpg">
                                <div class="item-overlay">
                                    <div class="overlay-quote has-text-centered">
                                        <div class="quote-text">
                                            <i class="fa fa-quote-right pull-left"></i>
                            ...
                            <div class="member-name has-text-centered pt-10 pb-10">
                                <span>Naseem</span> <span class="last-name">Al Wahabi</span>
                                <div class="position">Lead Developer</div>
                            </div>
                        </div>
                        <div class="column is-4">
                            <div class="team-member">
                                <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/three.jpg">
                                <div class="item-overlay">
                                    <div class="overlay-quote has-text-centered">
                                        <div class="quote-text">
                                            <i class="fa fa-quote-right pull-left"></i>
                            ...
                            <div class="member-name has-text-centered pt-10 pb-10">
                                <span>Dominic</span> <span class="last-name">Grilio</span>
    ...
    <div class="section is-medium section-feature-grey">
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="team-classic circled">
                    <div class="columns is-vcentered">
                        <div class="column is-4">
                            <div class="team-member">
                                <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/one.jpg">
    ...
    <div class="section is-medium">
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="team-classic squared">
                    <div class="columns is-vcentered">
                        <div class="column is-4">
                            <div class="team-member">
                                <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/one.jpg">
                        ...
                        <div class="columns is-vcentered">
                            <div class="column is-4">
                                <figure class="team-hover">
                                    <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/one.jpg">
                                    <figcaption>
                                        <h2>Alex <span class="ml-5">Walsh</span></h2>
                                        <p class="icon-links">
                                            <a href="_components-sections-team.php#"><span class="icon-dribbble"></span></a>
                                            <a href="_components-sections-team.php#"><span class="icon-linkedin"></span></a>
                                            <a href="_components-sections-team.php#"><span class="icon-twitter"></span></a>
                                        </p>
                                        <p class="description">Lead Designer</p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="column is-4">
                                <figure class="team-hover">
                                    <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/two.jpg">
                                    <figcaption>
                                        <h2>Naseem <span class="ml-5">Al Wahabi</span></h2>
                                        <p class="icon-links">
                                            <a href="_components-sections-team.php#"><span class="icon-dribbble"></span></a>
                                            <a href="_components-sections-team.php#"><span class="icon-linkedin"></span></a>
                                            <a href="_components-sections-team.php#"><span class="icon-twitter"></span></a>
                            ...
                            <div class="column is-4">
                                <figure class="team-hover">
                                    <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/three.jpg">
                                    <figcaption>
                                        <h2>Dominic <span class="ml-5">Grilio</span></h2>
                                        <p class="icon-links">
                                            <a href="_components-sections-team.php#"><span class="icon-dribbble"></span></a>
                                            <a href="_components-sections-team.php#"><span class="icon-linkedin"></span></a>
                                            <a href="_components-sections-team.php#"><span class="icon-twitter"></span></a>
                                        </p>
                                        <p class="description">Head of Sales</p>
                                    </figcaption>
                                </figure>
                            </div>
                        </div>
    ...
    <div class="section is-medium">
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="image-grid">
                    <div class="team-slanted-footer">
                        <div class="columns is-vcentered">
                            <div class="column is-4">
                                <figure class="team-slanted">
                                    <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/one.jpg">
                                    <figcaption>
                                        <h2>Alex <span>Walsh</span></h2>
                                        <div class="member-position">Lead Designer</div>
                                        <p>
                                            <a href="_components-sections-team.php#"><i class="fa fa-twitter"></i></a>
                                            <a href="_components-sections-team.php#"><i class="fa fa-linkedin"></i></a>
                                            <a href="_components-sections-team.php#"><i class="fa fa-dribbble"></i></a>
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="column is-4">
                                <figure class="team-slanted">
                                    <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/two.jpg">
                                    <figcaption>
                                        <h2>Naseem <span>Al Wahabi</span></h2>
                            ...
                            <div class="column is-4">
                                <figure class="team-slanted">
                                    <img src="https://via.placeholder.com/370x450" alt="" data-v1-src="assets/img/v1/team/three.jpg">
                                    <figcaption>
                                        <h2>Dominic <span>Grilio</span></h2>
                                        <div class="member-position">Head of Sales</div>
                                        <p>
                                            <a href="_components-sections-team.php#"><i class="fa fa-twitter"></i></a>
                                            <a href="_components-sections-team.php#"><i class="fa fa-linkedin"></i></a>
                                            <a href="_components-sections-team.php#"><i class="fa fa-dribbble"></i></a>
                ...
                <div class="modern-team">
                    <article class="modern-team-item circle-mask zoom-effect">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="https://via.placeholder.com/370x450" class="member-avatar" alt="" data-v1-src="assets/img/v1/team/one.jpg">
                            </div>
                            <div class="overlay-wrapper">
                                <div>
                                    <a href="_components-sections-team.php#0" class="social">
                    ...
                    <article class="modern-team-item circle-mask rotate-zoom-effect">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="https://via.placeholder.com/370x450" class="member-avatar" alt="" data-v1-src="assets/img/v1/team/two.jpg">
                            </div>
                            <div class="overlay-wrapper">
                                <div>
                                    <a href="_components-sections-team.php#0" class="social">
                    ...
                    <article class="modern-team-item circle-mask zoom-slide-effect">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="https://via.placeholder.com/370x450" class="member-avatar" alt="" data-v1-src="assets/img/v1/team/three.jpg">
                            </div>
                            <div class="overlay-wrapper">
                                <div>
                                    <a href="_components-sections-team.php#0" class="social">
    ...
    <div class="section is-medium">
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="modern-team">
                    <article class="modern-team-item curtain-mask zoom-effect">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="https://via.placeholder.com/370x450" class="member-avatar" alt="" data-v1-src="assets/img/v1/team/one.jpg">
                            </div>
                    ...
                    <article class="modern-team-item curtain-mask rotate-zoom-effect">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="https://via.placeholder.com/370x450" class="member-avatar" alt="" data-v1-src="assets/img/v1/team/two.jpg">
                            </div>
                    ...
                    <article class="modern-team-item curtain-mask zoom-slide-effect">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="https://via.placeholder.com/370x450" class="member-avatar" alt="" data-v1-src="assets/img/v1/team/three.jpg">
                            </div>
                        ...
                        <div class="column is-4">
                            <div class="flip-box">
                                <div class="flip-box-wrapper">
                                    ...
                                    <div class="back">
                                        <div class="flip-name">
                                            Alex <strong>Walsh</strong>
                                            <br><span>Lead Designer</span>
                                        </div>
                                        <div class="flip-social">
                                            <a href="_components-sections-team.php#"><i class="fa fa-twitter"></i></a>
                                            <a href="_components-sections-team.php#"><i class="fa fa-linkedin"></i></a>
                                            <a href="_components-sections-team.php#"><i class="fa fa-dribbble"></i></a>
                                        </div>
                        ...
                        <div class="column is-4">
                            <div class="flip-box">
                                <div class="flip-box-wrapper">
                                    ...
                                    <div class="back">
                                        <div class="flip-name">
                                            Naseem <strong>Al Wahabi</strong>
                                            <br><span>Lead Developer</span>
                                        </div>
                                        <div class="flip-social">
                                            <a href="_components-sections-team.php#"><i class="fa fa-twitter"></i></a>
                                            <a href="_components-sections-team.php#"><i class="fa fa-linkedin"></i></a>
                        ...
                        <div class="column is-3">
                            <div class="card-team-item">
                                <div class="flex-card light-bordered hover-raised">
                                    <div class="card-body">
                                        <div class="team-avatar">
                                            <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/barry.jpg">
                                        </div>
                                        <div class="member-id">
                                            <div class="name">
                                                John Locke
                        ...
                        <div class="column is-3">
                            <div class="card-team-item">
                                <div class="flex-card light-bordered hover-raised">
                                    <div class="card-body">
                                        <div class="team-avatar">
                                            <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/anthony.jpg">
                                        </div>
                                        <div class="member-id">
                                            <div class="name">
                                                Anthony Tetner
                        ...
                        <div class="column is-3">
                            <div class="card-team-item">
                                <div class="flex-card light-bordered hover-raised">
                                    <div class="card-body">
                                        <div class="team-avatar">
                                            <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/kareem.jpg">
                                        </div>
                                        <div class="member-id">
                                            <div class="name">
                                                Kareem Jabbar
                        ...
                        <div class="column is-3">
                            <div class="card-team-item">
                                <div class="flex-card light-bordered hover-raised">
                                    <div class="card-body">
                                        <div class="team-avatar">
                                            <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/elie.jpg">
                                        </div>
                                        <div class="member-id">
                                            <div class="name">
                                                Elie Schwartz
                        ...
                        <div class="column is-3">
                            <div class="card-team-item">
                                <div class="flex-card light-bordered hover-raised">
                                    <div class="card-body">
                                        <div class="team-avatar">
                                            <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/dan.png">
                                        </div>
                                        <div class="member-id">
                                            <div class="name">
                                                Dan Baxter
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-team.php#">Customers</a></li>
                            <li><a href="_components-sections-team.php#">Weekly sessions</a></li>
                            <li><a href="_components-sections-team.php#">Free trials and v1</a></li>
                            <li><a href="_components-sections-team.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-sections-team.php#">About us</a></li>
                            <li><a href="_components-sections-team.php#">About security</a></li>
                            <li><a href="_components-sections-team.php#">User guide</a></li>
                            <li><a href="_components-sections-team.php#">Terms of service</a></li>
                            <li><a href="_components-sections-team.php#">Terms of website use</a></li>
                            <li><a href="_components-sections-team.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-team.php#">Blog</a></li>
                            <li><a href="_components-sections-team.php#">FAQ</a></li>
                            <li><a href="_components-sections-team.php#">API documentation</a></li>
                            <li><a href="_components-sections-team.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-sections-team.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-sections-team.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-team.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-team.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-team.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-sections-team.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-team.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-sections-team.php#"></a></div> <!-- Concatenated jQuery and plugins -->
