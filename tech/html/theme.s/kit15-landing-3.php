...
<body class="is-theme-core">
    ...
    <div class="hero type-1 parallax is-cover is-relative is-fullheight" data-background="https://via.placeholder.com/1920x1280" data-color="#545375" data-color-opacity="0.6" data-demo-background="/assets/img/demo/hero-15.jpeg">

        <!--Shape-->
        <img class="hero-shape-commerce" src="assets/img/graphics/legacy/cut-shape-v3.svg" alt="">
            ...
            <div class="container">
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-start">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide scroll-link" href="kit15-landing-3.php#solution">
                            Solution
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide scroll-link" href="kit15-landing-3.php#use-cases">
                            Use Cases
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit15-about.php">
                            About
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide scroll-link" href="kit15-landing-3.php#contact">
                            Contact
                        </a>
                    </div>
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item is-button">
                            <a id="#signup-btn" href="kit15-contact.php" class="button button-signup btn-outlined is-bold btn-align light-btn raised">
                                Free V1
                            </a>
                        </div>
                    </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-8 is-offset-2 has-text-centered">
                        ...
                        <p class="has-text-centered is-centered buttons">
                            <a href="kit15-landing-3.php#start" class="button button-cta btn-align primary-btn z-index-2 scroll-link">
                                Get Started
                            </a>
                            <a href="kit15-landing-3.php#" class="button button-cta btn-align z-index-2">
                                Learn More
                            </a>
                        </p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="columns is-vcentered">
                <div class="column is-6 is-offset-1 has-text-centered">
                    <div class="masked-image">
                        <img class="main-image" src="assets/img/demo/business/1.jpg" alt="">
                ...
                <div class="column is-4">
                    ...
                    <div class="pt-10 pb-10">
                        <a href="kit15-landing-3.php#" class="button btn-align btn-more is-link color-primary">
            ...
            <div class="columns is-vcentered">
                <div class="column is-6 has-text-centered is-hidden-tablet is-hidden-desktop">
                    <div class="masked-image">
                        <img class="main-image" src="assets/img/demo/business/2.jpg" alt="">
            ...
            <div class="columns is-vcentered">
                <div class="column is-6 is-offset-1 has-text-centered">
                    <div class="masked-image">
                        <img class="main-image" src="assets/img/demo/business/3.jpg" alt="">
                        ...
                        <div class="navigation-tabs outlined-pills animated-tabs">
                            ...
                            <div id="procurement" class="navtab-content is-active">
                                <div class="columns is-vcentered">
                                    <div class="column is-6">
                                        <figure class="image">
                                            <img class="has-light-shadow" src="https://via.placeholder.com/1920x1280" data-demo-src="assets/img/demo/business/procurement.jpeg" alt="">
                                        </figure>
                                    </div>
                                    <div class="column is-6">
                                        <div class="inner-content">
                                            ...
                                            <p class="body-color">Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has eu lorem
                                                convenire incorrupte. Sound like a dream? It’s possible. </p>
                                            <div class="solid-list">
                                                ...
                                                <div class="solid-list-item">
                                                    ...
                                                    <div class="list-text body-color">
                                                        Move to strategic vs. transactional supplier relationships
                                                    </div>
                                                </div>
                                                <div class="solid-list-item">
                                                    <div class="list-bullet">
                                            ...
                                            <div class="button-wrap mt-4">
                                                <a href="kit15-contact.php" class="button btn-align btn-more is-link color-primary">
                                                    Talk about our procurement services <i class="sl sl-icon-arrow-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="diversity" class="navtab-content">
                                <div class="columns is-vcentered">
                                    <div class="column is-6">
                                        <figure class="image">
                                            <img class="has-light-shadow" src="https://via.placeholder.com/1920x1280" data-demo-src="assets/img/demo/business/diversity.jpeg" alt="">
                                        </figure>
                                    </div>
                                    <div class="column is-6">
                                        <div class="inner-content">
                                            ...
                                            <div class="solid-list">
                                                <div class="solid-list-item">
                                                    ...
                                                    <div class="list-text body-color">
                                                        Supplier development – help diverse suppliers improve and thrive within your organization
                                                    </div>
                                                </div>
                                                <div class="solid-list-item">
                                                    <div class="list-bullet">
                                                    ...
                                                    <div class="list-text body-color">
                                                        Automated feedback and clear ROI on development programs
                                                    </div>
                                                </div>
                                                <div class="solid-list-item">
                                                    <div class="list-bullet">
                                                    ...
                                                    <div class="list-text body-color">
                                                        See how your suppliers perform on diversity (supplier diversity, gender inequality, etc.)
                                                    </div>
                                                </div>
                                                <div class="solid-list-item">
                                                    <div class="list-bullet">
                                            ...
                                            <div class="button-wrap mt-4">
                                                <a href="kit15-contact.php" class="button btn-align btn-more is-link color-primary">
                                                    Learn more about diversity services <i class="sl sl-icon-arrow-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="business-units" class="navtab-content">
                                <div class="columns is-vcentered">
                                    <div class="column is-6">
                                        <figure class="image">
                                            <img class="has-light-shadow" src="https://via.placeholder.com/1920x1280" data-demo-src="assets/img/demo/business/business-units.jpeg" alt="">
                                        </figure>
                                    </div>
                                    <div class="column is-6">
                                        <div class="inner-content">
                                            ...
                                            <div class="button-wrap mt-4">
                                                <a href="kit15-contact.php" class="button btn-align btn-more is-link color-primary">
                                                    Have some suppliers to rank? <i class="sl sl-icon-arrow-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="boards" class="navtab-content">
                                <div class="columns is-vcentered">
                                    <div class="column is-6">
                                        <figure class="image">
                                            <img class="has-light-shadow" src="https://via.placeholder.com/1920x1280" data-demo-src="assets/img/demo/business/boards.jpeg" alt="">
                                        </figure>
                                    </div>
                                    <div class="column is-6">
                                        <div class="inner-content">
                                            ...
                                            <div class="solid-list">
                                                ...
                                                <div class="solid-list-item">
                                                    ...
                                                    <div class="list-text body-color">
                                                        Solid numbers and action for the proof behind your goals and public statements
                                                    </div>
                                                </div>
                                                <div class="solid-list-item">
                                                    <div class="list-bullet">
                                                ...
                                                <div class="solid-list-item">
                                                    ...
                                                    <div class="list-text body-color">
                                                        Get the value and return you deserve from suppliers and employees
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="button-wrap mt-4">
                                                <a href="kit15-contact.php" class="button btn-align btn-more is-link color-primary">
                                                    Talk about specifics for your department <i class="sl sl-icon-arrow-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="benefits-body">
                            <div class="solid-list">
                                <div class="solid-list-item">
                                    ...
                                    <div class="list-text body-color">
                                        Build trust and relationships through transparency and feedback
                                    </div>
                                </div>
                                <div class="solid-list-item">
                                    <div class="list-bullet">
                                    ...
                                    <div class="list-text body-color">
                                        Create a level playing field for all suppliers, including diverse businesses
                                    </div>
                                </div>
                                <div class="solid-list-item">
                                    <div class="list-bullet">
                        ...
                        <div class="benefits-body">
                            <div class="solid-list">
                                <div class="solid-list-item">
                                    ...
                                    <div class="list-text body-color">
                                        Changing the course of business through engagement and intervention
                                    </div>
                                </div>
                                <div class="solid-list-item">
                                    <div class="list-bullet">
                                    ...
                                    <div class="list-text body-color">
                                        Ensuring you get the most value out of the dollars you spend with suppliers
                                    </div>
                                </div>
                                <div class="solid-list-item">
                                    <div class="list-bullet">
                                ...
                                <div class="solid-list-item">
                                    ...
                                    <div class="list-text body-color">
                                        Surfacing critical items that would otherwise fester or never come out
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="side-feature-text">
                            <h2 class="feature-headline is-clean is-flex is-align-items-center">
                                <figure class="image is-64x64 mr-4">
                                    <img class="is-rounded" src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/janet.jpg" alt="">
                                </figure>
                                <span>A Word from our CEO</span>
                            </h2>
                            <p class="mt-4"><i class="fa fa-quote-left mr-2 is-size-4 color-primary"></i>Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has eu lorem convenire
                                incorrupte. </p>
    ...
    <!--Contact-->
    <div id="contact" class="section parallax is-cover" data-background="https://via.placeholder.com/1920x1280" data-color="#545375" data-color-opacity="0.6" data-demo-background="https://images.pexels.com/photos/1024248/pexels-photo-1024248.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
        <div class="container">
            <!--Title-->
                    ...
                    <div class="contact-form-2">
                        <form>
                            ...
                            <div class="button-wrap">
                                <div class="button cta-button primary-btn is-fullwidth">Submit Application</div>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="columns is-vcentered">
                    ...
                    <div>
                        ...
                        <nav class="level is-mobile mt-20">
                            <div class="level-left level-social">
                                <a href="kit15-landing-3.php#" class="level-item">
                ...
                <div class="column">
                    <div class="footer-nav-right">
                        <a class="footer-nav-link" href="kit15-landing-3.php#">Home</a>
                        <a class="footer-nav-link" href="kit15-landing-3.php#">Features</a>
                        <a class="footer-nav-link" href="kit15-landing-3.php#">Pricing</a>
                        <a class="footer-nav-link" href="kit15-landing-3.php#">Sign in</a>
                        <a class="footer-nav-link" href="kit15-landing-3.php#">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit15-landing-3.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit15-landing-3.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit15-landing-3.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit15-landing-3.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit15-landing-3.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit15-landing-3.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit15-landing-3.php#"></a></div>
