...
<body class="is-theme-core">
    ...
    <div id="pricing-page" class="hero sub-hero">
                                    ...
                                    <div class="container">
                                        <div class="columns">
                                            ...
                                            <div class="column">
                                                ...
                                                <p class="is-cta">
                                                    <a href="kit8-pricing.php#" class="button btn-align mega-btn primary-btn">Learn more</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="kit8-pricing.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="kit8-pricing.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="kit8-pricing.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="kit8-pricing.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="kit8-pricing.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="container">
                ...
                <div id="is-static" class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        ...
                        <!-- Signup button -->
                        <div class="navbar-item is-button is-centered-tablet">
                            <a id="#signup-btn-double" href="kit8-signup.php" class="button button-cta is-bold btn-align primary-btn raised is-rounded">
                                Sign up
                            </a>
                        </div>
                    </div>
        ...
        <div class="hero-body">
            <div class="columns">
                <div class="column is-10 is-offset-1 has-text-centered">
                    <h2 class="title is-1 dark-text">One word. Affordable.</h2>
                    <p class="subtitle is-4 muted-text">Comprehensive and scalable pricing</p>

                    <!-- Price switch -->
                    <div class="billing-switcher-wrapper">
                        <div class="by-month is-active">Monthly</div>
                        <!-- Switch -->
                        ...
                        <div class="by-year">Annualy</div>
                        <!-- Discount image -->
                        <div class="discount">
                            <img src="assets/img/graphics/compositions/percent-core.svg" data-base-url="assets/img/graphics/compositions/percent" data-extension=".svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="pricing-plans" class="section section-focus">
        <div class="container">
            <div class="columns is-vcentered mt-30">
                <div class="column">
                            ...
                            <div class="columns is-gapless">
                                ...
                                <div class="column is-3">
                                    <div class="condensed-plan">
                                        ...
                                        <div class="plan-price">
                                            <span class="monthly-price">15</span>
                                            <span class="yearly-price">14</span>
                                            <div class="yearly-billed">(Billed at $168/year)</div>
                                        </div>
                                        <ul class="plan-features">
                                            <li><b>1</b> user</li>
                                            <li><b>1</b> Dashboard</li>
                                ...
                                <div class="column is-3">
                                    <div class="condensed-plan">
                                        ...
                                        <div class="plan-price">
                                            <span class="monthly-price">30</span>
                                            <span class="yearly-price">28</span>
                                            <div class="yearly-billed">(Billed at $336/year)</div>
                                        </div>
                                        <ul class="plan-features">
                                            <li><b>1</b> user</li>
                                            <li><b>1</b> Dashboard</li>
                                ...
                                <!-- Plan -->
                                <div class="column is-3">
                                    <div class="condensed-plan is-last">
                                        <div class="plan-header">
                                            Business
                                        </div>
                                        <div class="plan-description">
                                        ...
                                        <div class="plan-price">
                                            <span class="monthly-price">50</span>
                                            <span class="yearly-price">46</span>
                                            <div class="yearly-billed">(Billed at $552/year)</div>
                                        </div>
                                        <ul class="plan-features">
                                            <li><b>1</b> user</li>
                                            <li><b>1</b> Dashboard</li>
                    ...
                    <!-- CTA -->
                    <div class="has-text-centered pt-60">
                        <a href="kit8-signup.php" class="button button-cta primary-btn rounded raised">Get started
                            free</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit8-pricing.php#">Home</a></li>
                                <li class="column-item"><a href="kit8-pricing.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit8-pricing.php#">Get started</a></li>
                                <li class="column-item"><a href="kit8-pricing.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit8-pricing.php#">Learning</a></li>
                                <li class="column-item"><a href="kit8-pricing.php#">Support center</a></li>
                                <li class="column-item"><a href="kit8-pricing.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit8-pricing.php#">Schedule a v1</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit8-pricing.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit8-pricing.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit8-pricing.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit8-pricing.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit8-pricing.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit8-pricing.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit8-pricing.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit8-pricing.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-pricing.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit8-pricing.php#"></a></div>
