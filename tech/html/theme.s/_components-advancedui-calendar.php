...
<body id="component-page">
    ...
    <!-- Hero and nav -->
    <div id="calendar-v1" class="hero is-relative is-theme-primary">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-advancedui-calendar.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-advancedui-calendar.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-advancedui-calendar.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-advancedui-calendar.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-advancedui-calendar.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <p class="components-cta">
                            <a href="_components-advancedui-calendar.php#basic-calendar" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="calendar-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section is-medium">
        ...
        <div id="basic-calendar" class="section-title-wrapper has-text-centered">
        ...
        <div class="columns is-vcentered">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    ...
                    <p>Bulkit used to come with a very versatile Bulma calendar UI extension. At the time it was released, the extension had only a few features. It has now a lot more. However, we kept the legacy calendars in case you need it. Please note that the legacy UI is purely static.</p>
                </div>
            </div>
        </div>
        ...
        <div class="columns is-vcentered pb-60">
            <div class="column is-6 is-offset-3">
                <!-- Inline Calendar -->
                <div class="calendar-legacy is-centered is-custom">
                    <!-- Header -->
    ...
    <div class="section section-feature-grey">
        ...
        <div class="columns is-vcentered">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    <h4>Large Calendar</h4>
                    <p>You can make the legacy calendar bigger by adding the <code>.is-large</code> class to the <code>.calendar</code> element. It also supports events.</p>
                </div>
            </div>
        </div>
        ...
        <div class="columns is-vcentered pb-60">
            <div class="column is-8 is-offset-2">
                <!-- Large Calendar -->
                <div class="calendar-legacy is-large is-centered is-custom">
                    <!-- Header -->
                    <div class="calendar-nav">
                        <!-- Previous -->
                        <div class="calendar-nav-previous-month">
    ...
    <div class="section">
        ...
        <div class="columns is-vcentered">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    ...
                    <p>The Datepicker can be displayed as a modal, with an opaque overlay. It can come very handy for certain particular use cases. </p>
                </div>
                <!-- Datepicker -->
                <div class="component-block">
                    <div class="field">
                        <div class="control">
                            <input id="datepickerV1Dialog" class="input" type="date">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="columns is-vcentered">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    ...
                    <p>The Datepicker can be displayed inline, like a work calendar. That can be interesting if you need the users to always see the calendar while working with it. </p>
                </div>
                <!-- Datepicker -->
                <div class="component-block">
                    <div class="field">
                        <div class="control">
                            <input id="datepickerV1Inline" class="input" type="date">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="columns is-vcentered pb-60">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    <span class="tag is-success">New3.0.0</span>
                    <h4>Datepicker Range</h4>
                    <p>Sometimes, you need to be able to enter a date range. This component does it easily and in a very elegant way.</p>
                </div>
                <!-- Datepicker -->
                <div class="component-block">
                    <div class="field">
                        <div class="control">
                            <input id="datepickerV1Range" class="input" data-is-range="true" type="date">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="section section-feature-grey">
        ...
        <div class="columns is-vcentered">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    <span class="tag is-success">New3.0.0</span>
                    <h4>Regular Timepicker</h4>
                    <p>The Calendar can behave like a timepicker when wired to a text input. It has to be initialized with
                        Javascript. </p>
                </div>
                <!-- Timepicker -->
                <div class="component-block">
                    <div class="field">
                        <div class="control">
                            <input id="timepickerV1Default" class="input" type="time">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="columns is-vcentered">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    <span class="tag is-success">New3.0.0</span>
                    <h4>Timepicker Inline</h4>
                    <p>The Timepicker can be displayed inline, if you need to always see it while working with it.</p>
                </div>
                <!-- Timepicker -->
                <div class="component-block">
                    <div class="field">
                        <div class="control">
                            <input id="timepickerV1Inline" class="input" type="time">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="columns is-vcentered pb-60">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    ...
                    <p>Sometimes, you need to be able to enter a time range. This component does it easily and in a very elegant way.</p>
                </div>
                <!-- Timepicker -->
                <div class="component-block">
                    <div class="field">
                        <div class="control">
                            <input id="timepickerV1Range" class="input" data-is-range="true" type="time">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="section">
        ...
        <div class="columns is-vcentered">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    <span class="tag is-success">New3.0.0</span>
                    <h4>Regular DateTimepicker</h4>
                    <p>What if we simply mix the features from the two last sections? Is it even possible? Indeed it is. This component lets you choose date and time in a row.</p>
                </div>
                <!-- Datepicker -->
                <div class="component-block">
                    <div class="field">
                        <div class="control">
                            <input id="datetimepickerV1Default" class="input" type="datetime">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="columns is-vcentered">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    <span class="tag is-success">New3.0.0</span>
                    <h4>Datepicker Modal</h4>
                    <p>The same result can be obtained while opting in for the modal approach. The component keeps looking nice and sharp.</p>
                </div>
                <!-- Datepicker -->
                <div class="component-block">
                    <div class="field">
                        <div class="control">
                            <input id="datetimepickerV1Dialog" class="input" type="datetime">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="columns is-vcentered pb-60">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    <span class="tag is-success">New3.0.0</span>
                    <h4>Datepicker Inline</h4>
                    <p>Like the previous examples, the DateTimepicker can be shown inline, if you need to.</p>
                </div>
                <!-- Datepicker -->
                <div class="component-block">
                    <div class="field">
                        <div class="control">
                            <input id="datetimepickerV1Inline" class="input" type="datetime">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-advancedui-calendar.php#">Customers</a></li>
                            <li><a href="_components-advancedui-calendar.php#">Weekly sessions</a></li>
                            <li><a href="_components-advancedui-calendar.php#">Free trials and v1</a></li>
                            <li><a href="_components-advancedui-calendar.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-calendar.php#">About us</a></li>
                            <li><a href="_components-advancedui-calendar.php#">About security</a></li>
                            <li><a href="_components-advancedui-calendar.php#">User guide</a></li>
                            <li><a href="_components-advancedui-calendar.php#">Terms of service</a></li>
                            <li><a href="_components-advancedui-calendar.php#">Terms of website use</a></li>
                            <li><a href="_components-advancedui-calendar.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-advancedui-calendar.php#">Blog</a></li>
                            <li><a href="_components-advancedui-calendar.php#">FAQ</a></li>
                            <li><a href="_components-advancedui-calendar.php#">API documentation</a></li>
                            <li><a href="_components-advancedui-calendar.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-advancedui-calendar.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-advancedui-calendar.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-calendar.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-calendar.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-calendar.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-advancedui-calendar.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-calendar.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-advancedui-calendar.php#"></a></div> <!-- Concatenated jQuery and plugins -->
