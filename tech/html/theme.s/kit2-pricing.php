...
<body class="is-theme-core">
        ...
        <div id="main-hero" class="hero-body">
            <div class="container">
                <div class="columns is-vcentered">
                    <div class="column is-6 is-offset-3 is-header-caption has-text-centered pt-60">
    ...
    <div class="section section-light-grey is-skewed-sm clean-pricing">
        <div class="container has-text-centered is-reverse-skewed-sm">
            <!-- Pricing tables -->
            <div class="columns is-vcentered giant-pb">
                <div class="column is-5 has-text-left">
                    <!-- Period selector -->
                    <div class="period-select">
                        <span class="clean-text is-active">Monthly</span>
                        <span class="clean-text">Annualy</span>
                    </div>
                    <h2 class="title theme clean-text pb-10 pt-10 is-2 no-margin">
                        Choose a plan.
                    </h2>
                    <!-- Plan type switcher -->
                    <div class="plan-controls">
                        <span id="show-freelance" class="clean-text is-active">Freelancer</span>
                        <span id="show-business" class="clean-text">Business</span>
                    </div>
                    <div class="subtitle is-6 mt-20">
                        Wether you are a dynamic startup or a software company, Bulkit will answer your business needs.
                    </div>
                    <br>
                </div>
                <div class="column is-8">
                    ...
                    <div id="freelance-pricing" class="side-pricing">
                        <div class="columns is-vcentered">
                            <div class="column">
                                ...
                                <div class="pricing-card animated preFadeInLeft fadeInLeft">
                                    ...
                                    <div class="inner">
                                        ...
                                        <a href="kit2-pricing.php#" class="button button-cta primary-btn raised">Sign up</a>
                                    </div>
                                </div>
                            </div>
                            <div class="column">
                                ...
                                <div class="pricing-card transparent animated preFadeInLeft fadeInLeft delay-1">
                                    <div class="inner">
                                        ...
                                        <a href="kit2-pricing.php#" class="button button-cta primary-btn btn-outlined is-bold">Sign up</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Business pricing -->
                    <div id="business-pricing" class="side-pricing is-hidden">
                        <div class="columns is-vcentered">
                            <div class="column">
                                <!-- Pricing table featured -->
                                <div class="pricing-card raised animated preFadeInLeft fadeInLeft">
                                    <div class="popular"><i class="im im-icon-Crown-2"></i></div>
                                    <div class="inner">
                                        <h6 class="plan-name">Pro</h6>
                                        <div class="plan-price">
                                            <small class="currency">$</small>
                                            <div class="month-price animated preFadeInUp fadeInUp">
                                                <span>49</span>
                                        ...
                                        <ul>
                                            <li><b>500 +</b> Invoices per month</li>
                                            <li><b>50 Gb</b> Storage</li>
                                            <li><b>10</b> User accounts</li>
                                            <li><b>∞</b> Clients</li>
                                        </ul>
                                        <a href="kit2-pricing.php#" class="button button-cta btn-align primary-btn raised">Sign up</a>
                                    </div>
                                </div>
                            </div>
                            <div class="column">
                                ...
                                <div class="pricing-card transparent animated preFadeInLeft fadeInLeft delay-1">
                                    <div class="inner">
                                        ...
                                        <ul>
                                            <li><b>2000 +</b> Invoices per month</li>
                                            <li><b>200 Gb</b> Storage</li>
                                            <li><b>30 +</b> User account</li>
                                            <li><b>∞</b> Clients</li>
                                        </ul>
                                        <a href="kit2-pricing.php#" class="button button-cta primary-btn btn-outlined is-bold">Sign up</a>
                                    </div>
    ...
    <div class="section is-medium">
        <div class="container">
            <h2 class="title section-subtitle clean-text color-primary has-text-centered is-2">
                Frequent questions
            </h2>
    ...
    <div class="section is-medium section-feature-grey">
        <div class="container">
            ...
            <h2 class="subtitle clean-text has-text-centered is-5">Drop us a line or two</h2>
                    ...
                    <div class="columns">
                        <div class="column is-6 is-offset-3">
                            ...
                            <div class="has-text-centered">
                                <button type="submit" class="button button-cta btn-align primary-btn raised no-lh">Send
                                    message</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="columns is-vcentered">
                    ...
                    <div>
                        ...
                        <nav class="level is-mobile mt-20">
                            <div class="level-left level-social">
                                <a href="kit2-pricing.php#" class="level-item">
                ...
                <div class="column">
                    <div class="footer-nav-right">
                        <a class="footer-nav-link" href="kit2-pricing.php#">Home</a>
                        <a class="footer-nav-link" href="kit2-pricing.php#">Features</a>
                        <a class="footer-nav-link" href="kit2-pricing.php#">Pricing</a>
                        <a class="footer-nav-link" href="kit2-pricing.php#">Sign in</a>
                        <a class="footer-nav-link" href="kit2-pricing.php#">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit2-pricing.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit2-pricing.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit2-pricing.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit2-pricing.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit2-pricing.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-pricing.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit2-pricing.php#"></a></div>
