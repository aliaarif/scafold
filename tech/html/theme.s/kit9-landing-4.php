...
<body class="is-theme-core">
        ...
        <div class="container">
            <div class="navbar-brand">
                <a class="navbar-item" href="index.php">
                    <img class="light-logo switcher-logo-square" src="assets/img/logos/logo/bulkit-square-core.svg" width="28" height="28" alt="">
                    <img class="dark-logo switcher-logo-square is-hidden" src="assets/img/logos/logo/bulkit-square-core.svg" width="28" height="28" alt="">
                </a>
            ...
            <div class="navbar-menu">
                <div class="navbar-start">
                    <a href="kit9-landing-4.php#main-features" class="navbar-item has-hover scroll-link">
                        Features
                    </a>

                    <a href="kit9-landing-4.php#pricing" class="navbar-item has-hover scroll-link">
                        Pricing
                    </a>
                </div>
                ...
                <div class="navbar-end has-hover">
                    ...
                    <div class="navbar-item">
                        <a href="kit9-landing-4.php#" class="button button-signup is-rounded is-bold  primary-btn">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--Hero-->
    <div class="hero is-app-grey rounded-hero is-fullheight has-shape-layer-1">

        <!--Shape Layer-->
        <img class="shape-layer" src="assets/img/graphics/legacy/wavy-4-core.svg" alt="" data-base-url="assets/img/graphics/legacy/wavy-4" data-extension=".svg">

        <div class="hero-body has-text-centered">
            <div class="container">
                <div class="columns">
                    <div class="column is-8 is-offset-2 is-hero-caption is-centered is-pushed">
                        <h1 class="title is-1 is-bold is-light">More Leads & Prospects.</h1>
                        <h3 class="subtitle is-5 is-light">Work with people differently.</h3>
                        <div class="buttons">
                            <a href="kit9-landing-4.php#" class="button button-cta is-bold btn-align white-btn is-rounded raised">
                                Get Started
                            </a>
                            <a href="kit9-landing-4.php#" class="button button-cta is-bold btn-align primary-btn is-rounded raised">
                                Try For Free
                            </a>
                        </div>
                    </div>
                ...
                <img class="hero-mockup is-smaller has-light-shadow" src="assets/img/graphics/apps/app-1-core.png" data-base-url="assets/img/graphics/apps/app-1" data-extension=".png" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="columns is-flex-tablet">
                ...
                <div class="column is-3">
                    <div class="box-wrap is-one-page is-box-reveal">
                        <div class="icon-box">
                            <img src="assets/img/graphics/icons/robotics-1-core.svg" data-base-url="assets/img/graphics/icons/robotics-1" data-extension=".svg" alt="">
                            <h4 class="box-title">Conception</h4>
                            <p>Lorem ipsum is a dummy text used by a lot of typographers and by the web industry.</p>
                        </div>
                    </div>
                </div>
                <!--Feature-->
                <div class="column is-3">
                    <div class="box-wrap is-one-page is-box-reveal">
                        <div class="icon-box">
                            <img src="assets/img/graphics/icons/robotics-2-core.svg" data-base-url="assets/img/graphics/icons/robotics-2" data-extension=".svg" alt="">
                ...
                <div class="column is-3">
                    <div class="box-wrap is-one-page is-box-reveal">
                        <div class="icon-box">
                            <img src="assets/img/graphics/icons/robotics-3-core.svg" data-base-url="assets/img/graphics/icons/robotics-3" data-extension=".svg" alt="">
                            <h4 class="box-title">Prototyping</h4>
                            <p>Lorem ipsum is a dummy text used by a lot of typographers and by the web industry.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="column is-3">
                    <div class="box-wrap is-one-page is-box-reveal">
                        <div class="icon-box">
                            <img src="assets/img/graphics/icons/robotics-4-core.svg" data-base-url="assets/img/graphics/icons/robotics-4" data-extension=".svg" alt="">
            ...
            <!--Subscribe box-->
            <div id="subscription" class="subscription-combo">
                ...
                <a class="button button-cta primary-btn raised combo-button">Get Started</a>
            </div>

            <!--Counters-->
            <div class="columns stat-boxes-wrapper">
                <!--Counter-->
                <div class="column is-4">
                    <div class="stat-box">
                        <div class="stat-icon is-icon-reveal">
                            <img src="assets/img/graphics/icons/robotics-5-core.svg" data-base-url="assets/img/graphics/icons/robotics-5" data-extension=".svg" alt="">
                        </div>
                ...
                <div class="column is-4">
                    <div class="stat-box">
                        <div class="stat-icon is-icon-reveal">
                            <img src="assets/img/graphics/icons/robotics-6-core.svg" data-base-url="assets/img/graphics/icons/robotics-6" data-extension=".svg" alt="">
                        </div>
                        <div class="stat-count">
                            <span class="counter">6000</span>
                        </div>
                        <p>Prorotypes completed</p>
                    </div>
                </div>
                <!--Counter-->
                <div class="column is-4">
                    <div class="stat-box">
                        <div class="stat-icon is-icon-reveal">
                            <img src="assets/img/graphics/icons/robotics-7-core.svg" data-base-url="assets/img/graphics/icons/robotics-7" data-extension=".svg" alt="">
                        </div>
                        <div class="stat-count">
    ...
    <!--Feature Section 1-->
    <div class="section is-medium is-grey has-triangle-right">
        <img class="triangle-right" src="assets/img/graphics/legacy/triangle-right.svg" alt="">
        <div class="container">
            <!--Title-->
            <div id="features-1" class="section-title has-text-centered">
                <img src="assets/img/graphics/icons/robot-heading-core.svg" data-base-url="assets/img/graphics/icons/robot-heading" data-extension=".svg" alt="">
                <h2 class="title is-spaced">How it works ?</h2>
                <h3 class="subtitle-alt">Designing robotics has never been so easy.</h3>
            </div>
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-6 is-relative is-centered-portrait">
                        <img class="side-image" src="assets/img/graphics/widgets/widget-23-core.png" data-base-url="assets/img/graphics/widgets/widget-23" data-extension=".png" alt="">
                    </div>
                    <!--Feature text-->
                    <div class="column is-6">
                        <div class="side-title">
                            <h3 class="title">Manage</h3>
                            <div class="title-number is-single-reveal">1</div>
                        </div>
                        <p class="side-paragraph">
                            Lorem ipsum is a wonderful demo text used by typographers and the
                            web industry.
                        </p>
                    </div>
                </div>
    ...
    <!--Feature Section 2-->
    <div id="features-2" class="section has-circles is-medium">
        <div class="container">
            <!--Wrapper-->
                ...
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-5 is-offset-1">
                        <div class="side-title">
                            ...
                            <div class="title-number is-single-reveal">2</div>
                        </div>
                        <p class="side-paragraph">
                            Lorem ipsum is a wonderful demo text used by typographers and the
                            web industry.
                    ...
                    <div class="column is-9">
                        <img class="has-light-shadow side-image" src="assets/img/graphics/apps/app-2-core.png" data-base-url="assets/img/graphics/apps/app-2" data-extension=".png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="primary-bold-circle"></div>
        <div class="accent-circle"></div>
    </div>

    <!--Feature Section 3-->
    <div id="features-3" class="section is-grey is-medium is-reversed has-triangle-left">
        <img class="triangle-left" src="assets/img/graphics/legacy/triangle-left.svg" alt="">
        <div class="container">
            <!--Wrapper-->
            <div class="content-wrapper has-margin-bottom">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-5 is-offset-1">
                        <div class="side-title">
                            ...
                            <div class="title-number is-single-reveal">3</div>
                        </div>
                        <p class="side-paragraph">
                            Lorem ipsum is a wonderful demo text used by typographers and the
                            web industry.
                    ...
                    <!--Mockup-->
                    <div class="column is-9">
                        <img class="has-light-shadow side-image" src="assets/img/graphics/apps/app-1-core.png" data-base-url="assets/img/graphics/apps/app-1" data-extension=".png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section is-medium">
        <div class="container">
            ...
            <div class="section-title has-text-centered">
                <img src="assets/img/graphics/icons/robot-heading-core.svg" data-base-url="assets/img/graphics/icons/robot-heading" data-extension=".svg" alt="">
                <h2 class="title is-spaced">Forget the Old Way</h2>
                <h3 class="subtitle-alt">And all bad stuff that goes with it.</h3>
            </div>

            <!--Wrapper-->
            <div class="content-wrapper">
                <!--First block-->
                <div class="columns is-vcentered is-methods">
                    <div class="column">
                        <h4 class="title is-6 grey-title has-text-centered">The Old Way</h4>
                        <img class="side-image is-tablet" src="assets/img/graphics/compositions/method-1-core.svg" data-base-url="assets/img/graphics/compositions/method-1" data-extension=".svg" alt="">
                    </div>
                    <!--Divider-->
                    <div class="column is-1 is-hidden-mobile">
                        <div class="divider-container">
                            <div class="divider-bar is-top"></div>
                            <div class="divider-text">VS.</div>
                            <div class="divider-bar is-bot"></div>
                        </div>
                    </div>
                    <!--Second block-->
                    <div class="column">
                        <h4 class="title is-6 primary-title has-text-centered">The New Way</h4>
                        <img class="side-image is-tablet" src="assets/img/graphics/compositions/method-2-core.svg" data-base-url="assets/img/graphics/compositions/method-2" data-extension=".svg" alt="">
                    </div>
                </div>

                <div class="button-wrap has-text-centered is-single-reveal">
                    <a href="kit9-landing-4.php#" class="button button-cta primary-btn raised is-long is-rounded">Sign Up</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section is-pricing is-medium">
        <div class="container">
            <!--Title-->
            <div id="pricing" class="section-title has-text-centered">
                <img src="assets/img/graphics/icons/robot-heading-core.svg" data-base-url="assets/img/graphics/icons/robot-heading" data-extension=".svg" alt="">
                <h2 class="title is-spaced">Straightforward Plans</h2>
                <h3 class="subtitle-alt">With tons of available features.</h3>
            </div>
                ...
                <div class="columns">
                    ...
                    <div class="column is-4">
                        <div class="pricing-card">
                            <div class="pricing-overlay is-accent"></div>
                            <a class="button pricing-button cta-button is-rounded">Get Started</a>
                            ...
                            <div class="pricing-desc">
                                <p>Lorem ipsum sit dolor amet is a dummy text used by the typographers and the web industry.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column is-4">
                        <div class="pricing-card">
                            <div class="pricing-overlay is-bold"></div>
                            <a class="button pricing-button cta-button is-rounded">Get Started</a>
                            <div class="pricing-head">
    ...
    <div class="section is-medium is-grey">
        <div class="container">
            <div class="content-wrapper">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-6">
                        <div class="partner-logos">
                            <img src="https://bulkit.cssninja.io/assets/img/logos/custom/kromo.svg" alt="">
                            <img src="https://bulkit.cssninja.io/assets/img/logos/custom/gutwork.svg" alt="">
                            <img src="assets/img/logos/custom/tribe.svg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-wrapper">
                    <div class="carousel">
                        ...
                        <div class="carousel-item">
                            ...
                            <p>Lorem ipsum is a wonderful demo text used by typographers and the
                                web industry.</p>
                            <div class="item-footer">
                                <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/helen.jpg" alt="">
                        ...
                        <div class="carousel-item">
                            ...
                            <p>Lorem ipsum is a wonderful demo text used by typographers and the
                                web industry.</p>
                            <div class="item-footer">
                                <img src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/anthony.jpg" alt="">
                ...
                <!--Title-->
                <div class="section-title contact-title has-text-centered">
                    <h2 class="title is-spaced">Join Beta</h2>
                    <h3 class="subtitle-alt">Help us ship the first version and earn rewards.</h3>
                </div>
                ...
                <div class="content-wrapper has-margin-bottom">
                    <div class="columns is-vcentered form-wrapper">
                        <div class="column is-4 is-offset-1">
                            <!--Title-->
                            <div class="side-title">
                                <h3 class="title is-3 is-spaced is-portrait-padded">Reach out our Support for any question.
                                </h3>
                            </div>
                            <p class="side-paragraph is-small has-margin">
                                Lorem ipsum is a wonderful demo text used by typographers and the web industry. It's very
                                likely that you've already seen it.
                            </p>
                        </div>
                        <div class="column is-5 is-offset-1">
                            <!--Form-->
                            <div class="contact-form is-bigger ">
                                <form>
                                    ...
                                    <div class="button-wrap">
                                        <div class="button button-cta primary-btn btn-align no-lh raised is-fullwidth">Join Beta</div>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <!--Footer-->
    <footer class="footer landing-dark-footer">
        <div class="container">
            <div class="columns">
                <div class="column is-4">
                    <img class="footer-logo square-logo switcher-logo" src="assets/img/logos/logo/bulkit-square-white.svg" alt="">
                ...
                <div class="column">
                    <h4 class="title is-light is-5">Get Started</h4>
                    <ul class="footer-menu">
                        <li><a href="kit9-landing-4.php#">Sign Up</a></li>
                        <li><a href="kit9-landing-4.php#">Features</a></li>
                        <li><a href="kit9-landing-4.php#">Pricing</a></li>
                        <li><a href="kit9-landing-4.php#">Login</a></li>
                    </ul>
                </div>
                <div class="column">
                    <h4 class="title is-light is-5">Support</h4>
                    <ul class="footer-menu">
                        <li><a href="kit9-landing-4.php#">Help</a></li>
                        <li><a href="kit9-landing-4.php#">User Guides</a></li>
                        <li><a href="kit9-landing-4.php#">Assistance</a></li>
                        <li><a href="kit9-landing-4.php#">Terms of Service</a></li>
                    </ul>
                </div>
                <div class="column">
                    <h4 class="title is-light is-5">Contact</h4>
                    <ul class="footer-menu">
            ...
            <div class="copyright">
                <img class="copyright-logo" src="assets/img/logos/logo/bulkit-core-w.svg" width="112" height="28" alt="">
                <div class="copyright-text">&copy;2020-2021, Css Ninja, All Rights Reserved.</div>
            </div>
        </div>
    </footer>

    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit9-landing-4.php#"></a></div>
    <!-- Side navigation -->
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit9-landing-4.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit9-landing-4.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit9-landing-4.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit9-landing-4.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit9-landing-4.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit9-landing-4.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
