...
<body class="is-theme-core">
    ...
    <div class="hero parallax is-cover is-relative is-fullheight" data-background="https://via.placeholder.com/1920x1280" data-color="#837FCB" data-color-opacity=".8" data-demo-background="/assets/img/demo/hero-11.jpg">
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item">
                            <a id="#signup-btn" href="kit1-signup.php" class="button button-signup btn-outlined is-bold btn-align light-btn rounded raised">
                                Sign up
                            </a>
                        </div>
                    </div>
                ...
                <div class="columns is-vcentered">
                            ...
                            <div class="flex-card">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input is-medium has-shadow" type="text" placeholder="">
                                ...
                                <div class="field switch-toggle-wrap is-grouped pt-10 pb-10">
                                    ...
                                    <div class="control">
                                        <span>By signing up, I agree to the Bulkit <a>Terms and Conditions</a>.</span>
                                    </div>
                                </div>

                                <div class="field">
                                    <div class="control">
                                        <button class="button button-cta success-btn is-rounded is-bold is-fullwidth raised" type="button">Sign Up</button>
                                    </div>
                                </div>
                    ...
                    <div class="column is-5 signup-column has-text-left">
                        ...
                        <div class="buttons mt-20">
                            <a href="kit1-landing-6.php#product" class="button button-cta btn-align is-bold primary-btn">
                                Get Started
                            </a>
                            <a href="kit1-landing-6.php#" class="button button-cta btn-align is-bold light-btn">
                                Get a Quote
                            </a>
                        </div>
                    </div>
        ...
        <div class="hero-foot">
            <div class="container">
                <div class="tabs partner-tabs is-centered">
                    <ul>
                        <li><a><img class="partner-logo" src="assets/img/logos/custom/covenant-light.svg" alt=""></a></li>
                        <li><a><img class="partner-logo" src="assets/img/logos/custom/infinite-light.svg" alt=""></a></li>
                        <li><a><img class="partner-logo" src="assets/img/logos/custom/phasekit-light.svg" alt=""></a></li>
                        <li><a><img class="partner-logo" src="assets/img/logos/custom/grubspot-light.svg" alt=""></a></li>
                        <li><a><img class="partner-logo" src="assets/img/logos/custom/gutwork-light.svg" alt=""></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered is-multiline has-text-centered">
                    ...
                    <div class="column is-3">
                        <div class="wavy-icon-box">
                            ...
                            <div class="box-title">Collaboration</div>
                    ...
                    <div class="column is-3">
                        <div class="wavy-icon-box">
                            ...
                            <div class="box-title">Task Management</div>
                            <p class="box-content is-tablet-padded">Lorem ipsum dolor sit amet, eam ex probo tation
                                tractatos. Ut vel hinc solet tincidunt, nec et iisque placerat pertinax.</p>
                        </div>
                    </div>
                    ...
                    <div class="column is-3">
                        <div class="wavy-icon-box">
                            ...
                            <div class="box-title">Advanced Reporting</div>
                            <p class="box-content is-tablet-padded">Lorem ipsum dolor sit amet, eam ex probo tation
                                tractatos. Ut vel hinc solet tincidunt, nec et iisque placerat pertinax.</p>
                        </div>
                    </div>
                ...
                <div class="has-text-centered pt-40 pb-40">
                    <a href="kit1-landing-6.php#" class="button button-cta primary-btn rounded raised">Learn more</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section section-feature-grey is-medium">
        <div class="container">
            ...
            <div class="section-title-wrapper has-text-centered">
                ...
                <h4>Dont struggle anymore to manage tasks</h4>
            </div>
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered pb-40 pt-40">
                    <div class="column is-4 is-offset-1">
                        <!-- Title -->
                        <div class="icon-subtitle"><i class="im im-icon-Magnifi-Glass2"></i></div>
                        ...
                        <div class="pt-10 pb-10">
                            <a href="kit1-landing-6.php#" class="button btn-align btn-more is-link color-primary">
                                Learn more <i class="sl sl-icon-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                    <div class="column is-6 is-offset-1">
                        <img src="assets/img/graphics/features/kit1-1-core.svg" data-base-url="assets/img/graphics/features/kit1-1" data-extension=".svg" alt="">
                    </div>
                </div>
                ...
                <div class="columns is-vcentered pb-40 pt-40">
                    ...
                    <div class="column is-4 is-offset-1 is-hidden-tablet is-hidden-desktop">
                        <!-- Title -->
                        <div class="icon-subtitle"><i class="im im-icon-Bar-Chart"></i></div>
                        <div class="title quick-feature has-numbers text-bold">
                            <h2>Data insights</h2>
                            <div class="bg-number">$</div>
                        </div>
                    ...
                    <div class="column is-6">
                        <img src="assets/img/graphics/features/kit1-2-core.svg" data-base-url="assets/img/graphics/features/kit1-2" data-extension=".svg" alt="">
                    </div>
                ...
                <div class="columns is-vcentered pb-40 pt-40">
                    ...
                    <div class="column is-6 is-offset-1">
                        <img src="assets/img/graphics/features/kit1-3-core.svg" data-base-url="assets/img/graphics/features/kit1-3" data-extension=".svg" alt="">
                    </div>
                </div>
                <div class="has-text-centered is-title-reveal pt-20 pb-20">
                    <a href="kit1-landing-6.php#" class="button button-cta primary-btn rounded raised">Start your Free trial</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="first-feature" class="section no-margin has-border-top">
        <div class="container">
            <div class="columns is-gapless is-vcentered mt-80 mb-80">
                ...
                <div class="column slide-description">
                    ...
                    <span class="body-text">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum
                        ...
                        labitur.</span>
                    <div class="pt-10 pb-10">
                        <a href="kit1-landing-6.php#second-feature" class="button button-cta btn-align btn-outlined is-bold raised primary-btn rounded is-hidden-touch">
                            Next feature
                        </a>
                    </div>
                </div>
    ...
    <div id="second-feature" class="section section-feature-grey no-margin">
        <div class="container">
            ...
            <div class="columns is-gapless is-vcentered mt-80 mb-80">
                ...
                <div class="column slide-description">
                    <div class="icon-subtitle"><i class="im im-icon-Line-Chart3"></i></div>
                    <div class="title quick-feature has-numbers text-bold">
                    ...
                    <span class="body-text">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum
                        ...
                        labitur.</span>
                    <div class="pt-10 pb-10">
                        <a href="kit1-landing-6.php#third-feature" class="button button-cta btn-align btn-outlined is-bold raised primary-btn rounded is-hidden-touch">
                            Next feature
                        </a>
                    </div>
                </div>
    ...
    <div id="third-feature" class="section no-margin">
        <div class="container">
            ...
            <div class="columns is-gapless is-vcentered mt-80 mb-80">
                ...
                <div class="column slide-description">
                    <div class="icon-subtitle"><i class="im im-icon-Add-File"></i></div>
                    <div class="title quick-feature has-numbers text-bold">
                    ...
                    <span class="body-text">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum
                        ...
                        labitur.</span>
                    <div class="pt-10 pb-10">
                        <a href="kit1-landing-6.php#fourth-feature" class="button button-cta btn-align btn-outlined is-bold raised primary-btn rounded is-hidden-touch">
                            Next feature
                        </a>
                    </div>
                </div>
    ...
    <div id="fourth-feature" class="section section-feature-grey no-margin">
        <div class="container">
            ...
            <div class="columns is-gapless is-vcentered mt-80 mb-80">
                ...
                <div class="column slide-description">
                    <div class="icon-subtitle"><i class="im im-icon-Folder-Organizing"></i></div>
                    <div class="title quick-feature has-numbers text-bold">
                    ...
                    <span class="body-text">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum
                        ...
                        labitur.</span>
                    <div class="pt-10 pb-10">
                        <a href="landing-signup.php" class="button button-cta btn-align raised primary-btn rounded is-hidden-touch">
                            Get started
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                ...
                <div class="has-text-centered is-title-reveal pt-40 pb-40">
                    <a href="kit1-pricing.php" class="button button-cta btn-align primary-btn raised rounded">Get
                        started Now</a>
                </div>
            </div>
        </div>
                ...
                <div class="columns">
                    <div class="column is-4">
                        ...
                        <div class="event-card is-wavy">
                            ...
                            <div class="img-container">
                                <img src="https://via.placeholder.com/1080x810" alt="" data-demo-src="assets/img/demo/kit/event1.jpg">
                            </div>
                            <div class="card-text">
                                <div class="text text-container">
                                    ...
                                    <div class="text text-details">
                                        <p class="text text-description">Lorem ipsum dolor sit amet, consectetur adipisicing
                                            elit. Ea nulla cum impedit et nemo molestiae, suscipit animi officiis soluta
                                            natus, provident ab laudantium, amet dolorum.
                                        </p>
                                        <a href="kit1-landing-6.php#" class="button btn-align btn-more is-link color-primary mt-10 mb-10">
                    ...
                    <div class="column is-4">
                        ...
                        <div class="event-card is-wavy">
                            ...
                            <div class="img-container">
                                <img src="https://via.placeholder.com/1080x810" alt="" data-demo-src="assets/img/demo/kit/event2.jpg">
                            </div>
                            <div class="card-text">
                                <div class="text text-container">
                                    <div class="text text-header">
                    ...
                    <div class="column is-4">
                        ...
                        <div class="event-card is-wavy">
                            ...
                            <div class="img-container">
                                <img src="https://via.placeholder.com/1080x810" alt="" data-demo-src="assets/img/demo/kit/event3.svg">
                            </div>
                            <div class="card-text">
                                <div class="text text-container">
                                    <div class="text text-header">
                    ...
                    <div class="column is-6">
                        ...
                        <div class="testimonials is-wavy">
                            ...
                            <div class="testimonial-item">
                                <div class="flex-card card-overflow raised">
                                    ...
                                    <div class="testimonial-content">
                                        <p>Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum inermis iudicabit.
                                            Ex vidit fierent hendrerit eum, sed stet periculis ut. Vis in probo decore
                                            labitur. Unum simul an vis, tale patrioque eos ad, dicunt percipit ea nam. Vis
                                            dolor quidam assentior te, atomorum posidonium qui an.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="testimonial-item">
                                <div class="flex-card card-overflow raised">
                                    <div class="testimonial-avatar">
                                        <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/stella.jpg">
                                    </div>
                                    <div class="testimonial-name">
    ...
    <!-- Contact form -->
    <div class="section is-medium is-relative has-waves-bottom-dark section-feature-grey">
        <div class="container">
            <!-- Title -->
            <div class="section-title-wrapper has-text-centered">
            ...
            <div class="columns">
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="kit1-landing-6.php#">Discover features</a></li>
                            <li><a href="kit1-landing-6.php#">CMS integration</a></li>
                            <li><a href="kit1-landing-6.php#">Customers</a></li>
                            <li><a href="kit1-landing-6.php#">Weekly sessions</a></li>
                            <li><a href="kit1-landing-6.php#">Free trials and demo</a></li>
                            <li><a href="kit1-landing-6.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="kit1-landing-6.php#">About us</a></li>
                            <li><a href="kit1-landing-6.php#">About security</a></li>
                            <li><a href="kit1-landing-6.php#">User guide</a></li>
                            <li><a href="kit1-landing-6.php#">Terms of service</a></li>
                            <li><a href="kit1-landing-6.php#">Terms of website use</a></li>
                            <li><a href="kit1-landing-6.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="kit1-landing-6.php#">Resources</a></li>
                            <li><a href="kit1-landing-6.php#">Blog</a></li>
                            <li><a href="kit1-landing-6.php#">FAQ</a></li>
                            <li><a href="kit1-landing-6.php#">API documentation</a></li>
                            <li><a href="kit1-landing-6.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="kit1-landing-6.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit1-landing-6.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit1-landing-6.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit1-landing-6.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit1-landing-6.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit1-landing-6.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-6.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit1-landing-6.php#"></a></div>
