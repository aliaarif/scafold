...
<body class="is-theme-core">
    ...
    <div class="hero is-fullheight rounded-hero">
                                    ...
                                    <div class="container">
                                        <div class="columns">
                                            ...
                                            <div class="column">
                                                ...
                                                <p class="is-cta">
                                                    <a href="kit7-landing-alt.php#" class="button btn-align mega-btn primary-btn">Learn more</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="kit7-landing-alt.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="kit7-landing-alt.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="kit7-landing-alt.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="kit7-landing-alt.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="kit7-landing-alt.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="hero-body has-text-centered">
            <div class="container">
                ...
                <div class="buttons">
                    <a href="kit7-landing-alt.php#" class="button button-cta is-bold btn-align white-btn is-rounded raised">
                        Get Started
                    </a>
                    <a href="kit7-landing-alt.php#" class="button button-cta is-bold btn-align primary-btn is-rounded raised">
                        Try For Free
                    </a>
                </div>
                <img class="hero-mockup" src="assets/img/graphics/apps/app-dashboard-sidebar-core.png" data-base-url="assets/img/graphics/apps/app-dashboard-sidebar" data-extension=".png" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="columns is-vcentered">
                ...
                <div class="column is-5">
                    <h2 class="title section-title is-demo bordered dark-text no-margin">Generate Leads</h2>
            ...
            <div class="columns is-vcentered">
                ...
                <div class="column is-5">
                    <h2 class="title section-title is-demo bordered dark-text no-margin">Set Up Workflows</h2>
                    <p class="section-feature-description">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum
                        inermis
                        iudicabit. Ex vidit fierent hendrerit eum, sed stet periculis ut. Vis in probo decore labitur.
                    </p>
            ...
            <div class="columns is-vcentered">
                ...
                <div class="column is-5">
                    <h2 class="title section-title is-demo bordered dark-text no-margin">Track Your Tasks</h2>
                    <p class="section-feature-description">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum
                        inermis
                        iudicabit. Ex vidit fierent hendrerit eum, sed stet periculis ut. Vis in probo decore labitur.
                    </p>
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="right-side">
                            ...
                            <div class="testimonial-content">
                                ...
                                <a class="learn-more" href="kit7-landing-alt.php#">
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit7-landing-alt.php#">Home</a></li>
                                <li class="column-item"><a href="kit7-landing-alt.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit7-landing-alt.php#">Get started</a></li>
                                <li class="column-item"><a href="kit7-landing-alt.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit7-landing-alt.php#">Learning</a></li>
                                <li class="column-item"><a href="kit7-landing-alt.php#">Support center</a></li>
                                <li class="column-item"><a href="kit7-landing-alt.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit7-landing-alt.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit7-landing-alt.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit7-landing-alt.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit7-landing-alt.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit7-landing-alt.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit7-landing-alt.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit7-landing-alt.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit7-landing-alt.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit7-landing-alt.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit7-landing-alt.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit7-landing-alt.php#"></a></div>
