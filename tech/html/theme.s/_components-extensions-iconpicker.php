...
<head>
    ...
    <title> Bulkit :: Icon Picker</title>
...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-extensions-iconpicker.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-extensions-iconpicker.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-extensions-iconpicker.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-extensions-iconpicker.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-extensions-iconpicker.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <h2 class="subtitle is-4 components-subtitle">
                            Iconpicker extension.
                        </h2>
                        <p class="components-cta">
                            <a href="_components-extensions-iconpicker.php#basic-buttons" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="iconpicker-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section">
        ...
        <div id="basic-buttons" class="section-title-wrapper has-text-centered">
            <div class="bg-number">1</div>
            <h2 class="title section-title has-text-centered dark-text text-bold">
                Iconpicker <span class="tag is-info">New</span>
            </h2>
        </div>
        ...
        <div class="columns is-vcentered pb-60">
            <div class="column is-6 is-offset-3">
                <div class="info-block">
                    <h4>Usage</h4>
                    <p>You can use this component if you need a feature that involves an icon picker in your project. Just create an input and give it a <code>data-action="iconPicker"</code> attribute. This will turn the input into a clickable icon that displays an icon picker modal dialog.</p>
                </div>

                <!-- Wrapper -->
                <div class="iconpicker-wrapper">
                    <!-- Input -->
                    <input type="text" id="iconPicker" data-action="iconPicker" value="fa fa-plus" />
                    <p class="help">Click on the icon to open the iconPicker.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-extensions-iconpicker.php#">Customers</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">Weekly sessions</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">Free trials and v1</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-extensions-iconpicker.php#">About us</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">About security</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">User guide</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">Terms of service</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">Terms of website use</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-extensions-iconpicker.php#">Blog</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">FAQ</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">API documentation</a></li>
                            <li><a href="_components-extensions-iconpicker.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-extensions-iconpicker.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-extensions-iconpicker.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-extensions-iconpicker.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-extensions-iconpicker.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-extensions-iconpicker.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-extensions-iconpicker.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-extensions-iconpicker.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-extensions-iconpicker.php#"></a></div> <!-- Concatenated jQuery and plugins -->
