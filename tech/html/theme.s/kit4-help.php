...
<body class="is-theme-core">
                ...
                <div id="navbar-menu" class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item">
                            <a id="#signup-btn" href="kit4-signup.php" class="button button-signup btn-outlined is-bold btn-align light-btn rounded raised">
                                Sign up
                            </a>
                        </div>
                    </div>
                ...
                <div class="columns is-vcentered pt-40">
                    ...
                    <div class="column is-9">
                        ...
                        <div class="help-subheader">
                            <h2 class="title is-3">Find your answer in our knowledge base</h2>
                        </div>
                        ...
                        <div class="card-body">
                            <a href="kit4-help-category.php">
                                ...
                                <div class="inner-content">
                                    <h2 class="title is-4">Welcome to our App</h2>
                    ...
                    <div class="flex-card category-card light-bordered">
                        <div class="card-body">
                            <a href="kit4-help-category.php">
                                ...
                                <!-- Content -->
                                <div class="inner-content">
                                    <h2 class="title is-4">Main dashboard</h2>
                                    <div class="inner-text">
                                        The dashboard is the central page of the application. It collects data for you and display it in a comprehensive way.
                                    </div>
                                    <div class="card-meta">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/alan.jpg">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/helen.jpg">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/thomas.jpg">
                                        <div class="meta-info">
                                            <div class="articles-number">6 articles in this section</div>
                                            <div class="authors">Written by <span>Alan Maynard</span> and 2 others</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="flex-card category-card light-bordered">
                        <div class="card-body">
                            <a href="kit4-help-category.php">
                                ...
                                <!-- Content -->
                                <div class="inner-content">
                                    <h2 class="title is-4">Team management</h2>
                                    <div class="inner-text">
                                        Our app let's you manage your team members smoothly. You can add users to your team in few clicks.
                                    </div>
                                    <div class="card-meta">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/helen.jpg">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/marc.jpg">
                                        <div class="meta-info">
                                            <div class="articles-number">5 articles in this section</div>
                                            <div class="authors">Written by <span>Helen Miller</span> and 1 other</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="flex-card category-card light-bordered">
                        <div class="card-body">
                            <a href="kit4-help-category.php">
                                ...
                                <!-- Content -->
                                <div class="inner-content">
                                    <h2 class="title is-4">Recruitments</h2>
                                    <div class="inner-text">
                                    ...
                                    <div class="card-meta">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/elie.jpg">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/helen.jpg">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/jalil.jpg">
                                        <span class="small-avatar is-more"><span>+1</span></span>
                                        <div class="meta-info">
                                            <div class="articles-number">9 articles in this section</div>
                                            <div class="authors">Written by <span>Nicole Ferrier</span> and 3 others</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="flex-card category-card light-bordered">
                        <div class="card-body">
                            <a href="kit4-help-category.php">
                                ...
                                <!-- Content -->
                                <div class="inner-content">
                                    <h2 class="title is-4">Payroll</h2>
                                    <div class="inner-text">
                                        Every employee needs to get paid at the end of the month. Discover user friendly features and streamilne your tasks.
                                    </div>
                                    <div class="card-meta">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/kareem.jpg">
                                        <div class="meta-info">
                                            <div class="articles-number">7 articles in this section</div>
                                            <div class="authors">Written by <span>Kareem Jabbar</span></div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="flex-card category-card light-bordered">
                        <div class="card-body">
                            <a href="kit4-help-category.php">
                                ...
                                <!-- Content -->
                                <div class="inner-content">
                                    <h2 class="title is-4">Timesheets</h2>
                                    <div class="inner-text">
                                    ...
                                    <div class="card-meta">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/helen.jpg">
                                        <img class="small-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/lakisha.jpg">
                                        <div class="meta-info">
                                            <div class="articles-number">4 articles in this section</div>
                                            <div class="authors">Written by <span>Helen Miller</span> and 1 other</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit4-help.php#">Home</a></li>
                                <li class="column-item"><a href="kit4-help.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit4-help.php#">Get started</a></li>
                                <li class="column-item"><a href="kit4-help.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit4-help.php#">Learning</a></li>
                                <li class="column-item"><a href="kit4-help.php#">Support center</a></li>
                                <li class="column-item"><a href="kit4-help.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit4-help.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit4-help.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit4-help.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit4-help.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit4-help.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit4-help.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit4-help.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit4-help.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit4-help.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit4-help.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit4-help.php#"></a></div>
