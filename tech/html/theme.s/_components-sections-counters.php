...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-sections-counters.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-sections-counters.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-sections-counters.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-sections-counters.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-sections-counters.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <h2 class="subtitle is-4 components-subtitle">
                            Animated counters variations.
                        </h2>
                        <p class="components-cta">
                            <a href="_components-sections-counters.php#icon-bg" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="counters-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Icon bg counter -->
    <div id="icon-bg" class="section is-medium">
        <div class="container">
                ...
                <div class="columns is-vcentered has-text-centered">
                    <div class="column is-4">
                        <div class="simple-counter">
                            <div class="counter counter-number is-bold">1847</div>
                            <div class="counter-text">teams use our product</div>
                    ...
                    <div class="column is-4">
                        <div class="simple-counter">
                            <div class="counter counter-number is-bold">2360</div>
                            <div class="counter-text">meetings every day</div>
                            <div class="background-icon">
                    ...
                    <div class="column is-4">
                        <div class="simple-counter">
                            <div class="counter counter-number is-bold">4972</div>
                            <div class="counter-text">addons sold</div>
                            <div class="background-icon">
                ...
                <div class="columns is-vcentered has-text-centered">
                    <div class="column is-4">
                        <div class="icon-counter">
                            ...
                            <div class="counter counter-number text-bold">6851</div>
                            <div class="counter-text">Available ressources</div>
                        </div>
                    </div>
                    <div class="column is-4">
                        <div class="icon-counter">
                            ...
                            <div class="counter counter-number text-bold">463</div>
                            <div class="counter-text">Collaborative projects</div>
                        </div>
                    </div>
                    <div class="column is-4">
                        <div class="icon-counter">
                            ...
                            <div class="counter counter-number text-bold">18000</div>
                            <div class="counter-text">Monthly emails</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Icon counter -->
    <div class="section is-medium parallax is-cover is-relative" data-background="https://via.placeholder.com/1920x1397" data-color="#000" data-color-opacity="0.7" data-v1-background="assets/img/v1/woman-ipad.jpg">
        <div class="container">
            <div class="section-title-wrapper">
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-counters.php#">Customers</a></li>
                            <li><a href="_components-sections-counters.php#">Weekly sessions</a></li>
                            <li><a href="_components-sections-counters.php#">Free trials and v1</a></li>
                            <li><a href="_components-sections-counters.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-sections-counters.php#">About us</a></li>
                            <li><a href="_components-sections-counters.php#">About security</a></li>
                            <li><a href="_components-sections-counters.php#">User guide</a></li>
                            <li><a href="_components-sections-counters.php#">Terms of service</a></li>
                            <li><a href="_components-sections-counters.php#">Terms of website use</a></li>
                            <li><a href="_components-sections-counters.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-counters.php#">Blog</a></li>
                            <li><a href="_components-sections-counters.php#">FAQ</a></li>
                            <li><a href="_components-sections-counters.php#">API documentation</a></li>
                            <li><a href="_components-sections-counters.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-sections-counters.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-sections-counters.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-counters.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-counters.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-counters.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-sections-counters.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-counters.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-sections-counters.php#"></a></div> <!-- Concatenated jQuery and plugins -->
