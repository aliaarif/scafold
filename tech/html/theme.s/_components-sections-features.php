...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-sections-features.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-sections-features.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-sections-features.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-sections-features.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-sections-features.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <p class="components-cta">
                            <a href="_components-sections-features.php#features" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-svg" src="assets/img/graphics/widgets/widget-1-core.png" alt="">
                </div>

                <div class="column is-5">
                    <h3 class="detailed-feature-subtitle">A minimal theme</h3>
                    <h2 class="title section-title is-demo bordered dark-text no-margin">Cleanly designed</h2>
                    ...
                    <div class="pt-10 pb-10">
                        <a href="_components-sections-features.php#" class="button btn-align btn-more is-link color-primary">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered is-hidden-tablet is-hidden-desktop">
                    <img class="featured-svg" src="assets/img/graphics/widgets/widget-2-core.png" alt="">
                </div>

                <div class="column is-5 has-text-right">
                    <h3 class="detailed-feature-subtitle">A powerful</h3>
                    <h2 class="title section-title is-demo bordered dark-text no-margin">Flexbox layout</h2>
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-svg" src="assets/img/graphics/widgets/widget-3-core.png" alt="">
                </div>

                <div class="column is-5">
                    <h3 class="detailed-feature-subtitle">Many extras</h3>
                    <h2 class="title section-title is-demo bordered dark-text no-margin">Included graphic assets</h2>
                    <div class="title-divider"></div>
                    <span class="section-feature-description">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum inermis iudicabit. Ex vidit fierent hendrerit eum, sed stet periculis ut. Vis in probo decore labitur. Unum simul an vis, tale patrioque eos ad, dicunt percipit ea nam. Vis dolor quidam assentior te, atomorum posidonium qui an.</span>
                    <div class="pt-10 pb-10">
                        <a href="_components-sections-features.php#" class="button btn-align btn-more is-link color-primary">
            ...
            <h2 class="title has-text-centered">
                <a href="_components-sections-features.php#" class="button button-action btn-align btn-fade rounded raised secondary-btn">
                    <i class="fa fa-play"></i> See all Features
                </a>
            </h2>
    ...
    <div class="section is-medium">
        <div class="container">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-svg" src="assets/img/graphics/widgets/widget-4-core.png" alt="">
                </div>

                <div class="column is-4">
                    <div class="icon-subtitle"><i class="im im-icon-Speach-Bubble2"></i></div>
                    <h2 class="title quick-feature text-bold no-margin">
                        Cleanly designed
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered is-hidden-tablet is-hidden-desktop">
                    <img class="featured-svg" src="assets/img/graphics/widgets/widget-5-core.png" alt="">
                </div>

                <div class="column is-4 is-offset-1">
                    <div class="icon-subtitle"><i class="im im-icon-Navigation-RightWindow"></i></div>
                    <h2 class="title quick-feature text-bold no-margin">
                        Flexbox layout
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-svg" src="assets/img/graphics/widgets/widget-6-core.png" alt="">
                </div>

                <div class="column is-4">
                    <div class="icon-subtitle"><i class="im im-icon-Diamond"></i></div>
                    <h2 class="title quick-feature text-bold no-margin">
    ...
    <div class="section is-medium is-relative section-feature-grey">
        <div class="container has-text-centered">
            <div class="columns is-vcentered">
                <div class="column is-6 is-offset-3 has-text-centered">
                    <div class="section-title-wrapper">
                        <h6 class="top-subtitle">That's not all</h6>
                        <h2 class="title dark-text text-bold main-title is-2">
                            Discover more Features!
                        </h2>
                        <h3 class="subtitle is-4 pt-10 pb-10">
            ...
            <div class="columns is-vcentered">
                <div class="column is-4">
                    ...
                    <div class="content content-flex">
                        ...
                        <div class="dark-text has-text-left ml-30">
                            <h5 class="text-bold">Chat messages</h5>
                ...
                <div class="column is-4">
                    ...
                    <div class="content content-flex">
                        ...
                        <div class="dark-text has-text-left ml-30">
                            <h5 class="text-bold">Audio messages</h5>
                            Lorem ipsum dolor sit amet, ea vis numquam vivendo, voluptua argumentum an pri. Duo illud consequat in, eum eu veri ipsum oporteat.
                        </div>
                    </div>
                </div>
                <div class="column is-4">
                    ...
                    <div class="content content-flex">
                        ...
                        <div class="dark-text has-text-left ml-30">
                            <h5 class="text-bold">Email messages</h5>
                            Lorem ipsum dolor sit amet, ea vis numquam vivendo, voluptua argumentum an pri. Duo illud consequat in, eum eu veri ipsum oporteat.
                        </div>
                    </div>
                </div>
            ...
            <p class="pt-40 pb-40">
                <a href="_components-sections-features.php#product" class="button button-cta btn-align raised rounded secondary-btn">
                    Learn more
                </a>
            </p>
        </div>
    ...
    <div class="section is-medium">
        <div class="container">
            ...
            <div class="columns pt-80 pb-80">
                <div class="column is-one-third">
                    <div class="feature-card card-md light-bordered hover-inset has-text-centered">
                        <div class="card-icon">
                            <img src="assets/img/graphics/icons/lifesaver-core.svg" alt="">
                        </div>
                ...
                <div class="column">
                    <div class="feature-card card-md light-bordered hover-inset has-text-centered">
                        <div class="card-icon">
                            <img src="assets/img/graphics/icons/building-core.svg" alt="">
                        </div>
                        <div class="card-title">
                            <h4>Clean design</h4>
                        </div>
    ...
    <!-- Product showcase -->
    <div class="section is-medium section-feature-grey no-padding-left no-padding-right">
        <div class="container is-fluid no-margin">
            ...
            <div class="content-wrapper">
                <div class="columns">
                    <!-- Hipboard section -->
                    <div id="hipboard" class="columns is-vcentered">
                        <div class="column is-4 is-offset-2 mobile-padding-20">
                            <div class="icon-subtitle"><i class="im im-icon-Timer-2"></i></div>
                            <h2 class="title quick-feature text-bold no-margin">
                                Project Management
                                <span class="bg-number">1</span>
                            </h2>
                            <div class="title-divider"></div>
                            <span class="section-feature-description">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum inermis iudicabit. Vim debet perpetua no, feugait pertinacia his ad, dico euripidis nec ut. Vim in justo aliquando. Id alia mutat consetetur vel.</span>
                            <!-- Rating card -->
                            <div class="flex-card light-bordered hover-inset padding-10 mt-20 mb-20 animated preFadeInUp fadeInUp delay-3">
                                <div class="content content-flex">
                                    <div class="card-content">
                                        <p class="">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum inermis iudicabit.</p>
                                        <div class="star-rating color-primary">
                                        ...
                                        <div class="bottom-avatar">
                                            <img class="ml-10 mr-10" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/ray.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="column is-7 is-offset-1">
                            <img class="is-3-by-2 animated preFadeInRight fadeInLeft has-light-shadow" src="assets/img/graphics/apps/app-2-core.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-features.php#">Customers</a></li>
                            <li><a href="_components-sections-features.php#">Weekly sessions</a></li>
                            <li><a href="_components-sections-features.php#">Free trials and demo</a></li>
                            <li><a href="_components-sections-features.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-sections-features.php#">About us</a></li>
                            <li><a href="_components-sections-features.php#">About security</a></li>
                            <li><a href="_components-sections-features.php#">User guide</a></li>
                            <li><a href="_components-sections-features.php#">Terms of service</a></li>
                            <li><a href="_components-sections-features.php#">Terms of website use</a></li>
                            <li><a href="_components-sections-features.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-features.php#">Blog</a></li>
                            <li><a href="_components-sections-features.php#">FAQ</a></li>
                            <li><a href="_components-sections-features.php#">API documentation</a></li>
                            <li><a href="_components-sections-features.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-sections-features.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-sections-features.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-features.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-features.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-features.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-sections-features.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-features.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-sections-features.php#"></a></div> <!-- Concatenated jQuery and plugins -->
