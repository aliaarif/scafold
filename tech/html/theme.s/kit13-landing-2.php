...
<body class="is-theme-core">
    ...
    <!-- Hero -->
    <div class="hero parallax is-cover is-relative is-fullheight jobs-hero" data-background="https://via.placeholder.com/1920x1280" data-color="#837FCB" data-color-opacity=".7" data-demo-background="https://images.pexels.com/photos/4345107/pexels-photo-4345107.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
            ...
            <div class="container">
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-start">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit13-landing-2.php#">
                            Jobs
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit13-landing-2.php#">
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item is-button">
                            <a id="#signup-btn" href="kit13-landing-2.php#" class="button button-signup btn-outlined is-bold btn-align light-btn rounded raised">
                                Register
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="columns has-text-centered">
                    ...
                    <div class="column is-12 is-hero-caption is-centered">
                        <h1 class="title is-1 is-light">Find a Job</h1>
                        <h2 class="subtitle is-5 pt-10 is-light">
                            Discover a beautiful and full featured invoicing
                            software.
                        </h2>
                            ...
                            <div class="columns box search-box">
                                ...
                                <div class="column is-3 is-paddingless">
                                    <form class="price-block">
                                        ...
                                        <a class="button" href="kit13-landing-2.php#" title="Salary">
                                ...
                                <div class="column is-3 is-paddingless">
                                    <div class="price-block">
                                        ...
                                        <a class="button" href="kit13-landing-2.php#" title="Job Options">
            ...
            <div class="content-wrapper">
                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing-2.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/demo/brands/airbnb.svg" alt="">
                            </div>
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing-2.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/demo/brands/gitlab.svg" alt="">
                            </div>
                            <div class="content-container">
                                <h3>Web Developer</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing-2.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/demo/brands/slack.svg" alt="">
                            </div>
                            <div class="content-container">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing-2.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/demo/brands/dribbble.svg" alt="">
                            </div>
                            <div class="content-container">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing-2.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/demo/brands/facebook.svg" alt="">
                            </div>
                            <div class="content-container">
                                <h3>UI/UX Designer</h3>
                                <div class="job-summary">
                    ...
                    <div class="column is-4">
                        <a href="kit13-landing-2.php#" class="flex-card featured-job-box">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/demo/brands/github.svg" alt="">
                            </div>
                            <div class="content-container">
                                <h3>Web Developer</h3>
                                <div class="job-summary">
            ...
            <div class="content-wrapper">
                ...
                <div class="job-categories">
                    <div class="job-categories-inner">
                        ...
                        <!--Category-->
                        <a href="kit13-landing-2.php#" class="job-category tilt-card rounded">
                ...
                <!-- CTA -->
                <div class="cta-wrapper has-text-centered is-title-reveal pt-60">
                    <a href="kit13-landing-2.php#" class="button button-cta is-bold btn-align primary-btn raised">
                        View All Categories
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="columns is-multiline">
                    ...
                    <!--Hot Topic-->
                    <div class="column is-4">
                        <a href="kit13-landing-2.php#" class="flex-card job-topic">
                            <div class="icon-container is-first is-icon-reveal">
                                <img src="assets/img/logos/stacks/js.svg" alt="">
                            </div>
                            <div class="meta">
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit13-landing-2.php#">Home</a></li>
                                <li class="column-item"><a href="kit13-landing-2.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit13-landing-2.php#">Get started</a></li>
                                <li class="column-item"><a href="kit13-landing-2.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit13-landing-2.php#">Learning</a></li>
                                <li class="column-item"><a href="kit13-landing-2.php#">Support center</a></li>
                                <li class="column-item"><a href="kit13-landing-2.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit13-landing-2.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit13-landing-2.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit13-landing-2.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit13-landing-2.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit13-landing-2.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit13-landing-2.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit13-landing-2.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit13-landing-2.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit13-landing-2.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit13-landing-2.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit13-landing-2.php#"></a></div>
