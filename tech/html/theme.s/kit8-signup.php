...
<body class="is-theme-core">
    ...
    <div class="auth-nav-alt">
        <div class="start is-hidden-mobile">
            <a href="index.php">Home</a>
        </div>
        <div class="end">
            <span class="muted-text pr-10">Have an account?</span>
            <a href="kit8-login.php" class="button is-rounded btn-align">Sign In</a>
        </div>
    </div>

    <div class="auth-outer-alt">
                    ...
                    <div class="form-inner">
                        <div class="field">
                            <div class="control has-icons-left">
                                <input type="text" class="input is-rounded is-primary-focus" placeholder="Email address">
                        ...
                        <div class="field">
                            <div class="control has-icons-left">
                                <input type="password" class="input is-rounded is-primary-focus" placeholder="Password">
                                <div class="icon is-nedium is-left">
                        ...
                        <div class="field">
                            <div class="control has-icons-left">
                                <input type="password" class="input is-rounded is-primary-focus" placeholder="Repeat password">
                                <div class="icon is-nedium is-left">
                                    <i class="sl sl-icon-lock"></i>
                                </div>
                            </div>
                        ...
                        <div class="field pb-5">
                            <div class="control">
                                <label class="checkbox-wrap is-small muted-text">
                                    ...
                                    <span></span>
                                    You agree to our <a class="color-primary">Terms & Conditions</a>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="field">
                            <div class="control has-icons-left">
                                <button class="button is-fullwidth is-rounded primary-btn raised">Sign Up</button>
                            </div>
                        </div>
                        ...
                        <div class="social-login">
                            <h4>Or sign up with social media</h4>
