...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-layout-footers.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-layout-footers.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-layout-footers.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-layout-footers.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-layout-footers.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <p class="components-cta">
                            <a href="_components-layout-footers.php#dark-footer" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="footer-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="columns">
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-layout-footers.php#">Discover features</a></li>
                            <li><a href="_components-layout-footers.php#">CMS integration</a></li>
                            <li><a href="_components-layout-footers.php#">Customers</a></li>
                            <li><a href="_components-layout-footers.php#">Weekly sessions</a></li>
                            <li><a href="_components-layout-footers.php#">Free trials and demo</a></li>
                            <li><a href="_components-layout-footers.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-layout-footers.php#">About us</a></li>
                            <li><a href="_components-layout-footers.php#">About security</a></li>
                            <li><a href="_components-layout-footers.php#">User guide</a></li>
                            <li><a href="_components-layout-footers.php#">Terms of service</a></li>
                            <li><a href="_components-layout-footers.php#">Terms of website use</a></li>
                            <li><a href="_components-layout-footers.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-layout-footers.php#">Resources</a></li>
                            <li><a href="_components-layout-footers.php#">Blog</a></li>
                            <li><a href="_components-layout-footers.php#">FAQ</a></li>
                            <li><a href="_components-layout-footers.php#">API documentation</a></li>
                            <li><a href="_components-layout-footers.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-layout-footers.php#" class="level-item">
            ...
            <div class="columns is-vcentered">
                ...
                <div class="column">
                    <div class="footer-nav-right">
                        <a class="footer-nav-link" href="_components-layout-footers.php#">Home</a>
                        <a class="footer-nav-link" href="_components-layout-footers.php#">Features</a>
                        <a class="footer-nav-link" href="_components-layout-footers.php#">Pricing</a>
                        <a class="footer-nav-link" href="_components-layout-footers.php#">Sign in</a>
                        <a class="footer-nav-link" href="_components-layout-footers.php#">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="footer footer-dark-left">
        <div class="container">
            <div class="columns is-vcentered">
                <div class="column is-6">
                    <div class="mb-20">
                        <img class="small-footer-logo switcher-logo" src="assets/img/logos/logo/bulkit-core-w.svg" alt="">
                    </div>
                    <div>
                        <span class="moto">Designed and coded with <i class="fa fa-heart color-red"></i> by CSS Ninja.</span>
                        <nav class="level is-mobile mt-20">
                ...
                <div class="column is-4">
                    ...
                    <div>
                        ...
                        <div class="social-links">
                            <a href="_components-layout-footers.php#">
                                <span class="icon"><i class="fa fa-facebook"></i></span>
                            </a>
                            <a href="_components-layout-footers.php#">
                                <span class="icon"><i class="fa fa-twitter"></i></span>
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="_components-layout-footers.php#">Home</a></li>
                                <li class="column-item"><a href="_components-layout-footers.php#">Pricing</a></li>
                                <li class="column-item"><a href="_components-layout-footers.php#">Get started</a></li>
                                <li class="column-item"><a href="_components-layout-footers.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="_components-layout-footers.php#">Learning</a></li>
                                <li class="column-item"><a href="_components-layout-footers.php#">Support center</a></li>
                                <li class="column-item"><a href="_components-layout-footers.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="_components-layout-footers.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="_components-layout-footers.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="_components-layout-footers.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="_components-layout-footers.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-layout-footers.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-footers.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-footers.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-footers.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-layout-footers.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-footers.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-layout-footers.php#"></a></div> <!-- Concatenated jQuery and plugins -->
