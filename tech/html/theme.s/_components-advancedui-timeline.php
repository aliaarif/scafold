...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-advancedui-timeline.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-advancedui-timeline.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-advancedui-timeline.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-advancedui-timeline.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-advancedui-timeline.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <h2 class="subtitle is-4 components-subtitle">
                            Timeline and activity feed variations.
                        </h2>
                        <p class="components-cta">
                            <a href="_components-advancedui-timeline.php#responsive" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="timeline-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section">
        <div class="container">
            <div id="reponsive" class="section-title-wrapper has-text-centered">
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Use timelines if you want to display chronological information. This timeline features timeline icons and user avatars. It is responsive by default.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <div class="content-body">
                                    <img class="timeline-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/carolin.png">
                                    <div class="timeline-text">
                                        <div>Marjory Cambell</div>
                                        <div>Has locked a set of business documents</div>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content right">
                                <div class="content-body">
                                    <img class="timeline-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/henry.jpg">
                                    <div class="timeline-text">
                                        <div>Henry Rodstein</div>
                                        <div>Has marked <a href="_components-advancedui-timeline.php#">4 invoices</a> as processed and paid.</div>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <div class="content-body">
                                    <img class="timeline-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/helen.jpg">
                                    <div class="timeline-text">
                                        <div>Helen Miller</div>
                                        <div>Has uploaded <a href="_components-advancedui-timeline.php#">17 invoices</a> to the processing queue.</div>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block pb-20">
                        <h4>Doted timeline</h4>
                        <p class="no-padding">You can display small dots instead of icons if you prefer a lighter layout. Inspect the source to see the markup details</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered pt-30">
                <div class="column is-10 is-offset-1">
                    <!-- Timeline -->
                    <div class="timeline doted">
                        <div class="timeline-item">
                            <!-- Timeline item -->
                            <div class="timeline-icon g-item"></div>
                            <div class="timeline-content">
                                <div class="content-body">
                                    <img class="timeline-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/carolin.png">
                                    <div class="timeline-text">
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">Timelines can also be used to display message conversations, like inside a support ticket UI for example.</p>
                    </div>
                </div>
            </div>

            <div class="columns is-vcentered pt-30 pb-60">
                <div class="column is-10 is-offset-1">
                    <!-- Timeline -->
                    <div class="timeline">
                        <!-- Timeline item -->
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <div class="content-body">
                                    <div class="timeline-text">
                                        <div>Marjory Cambell</div>
                                        <div>Lorem ipsum dolor sit amet, vel option latine alterum ut, sed ad ludus saperet nominavi. Te exerci libris blandit qui, quo ei lucilius vulputate. </div>
                                        <span class="timestamp">30 minutes ago</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content right">
                                <div class="content-body">
                                    <div class="timeline-text">
                                        <div>Henry Rodstein</div>
                                        <div>Lorem ipsum dolor sit amet, vel option latine alterum ut, sed ad ludus saperet nominavi. Te exerci libris blandit qui.</div>
                                        <span class="timestamp">2 hours ago</span>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p class="no-padding">If timelines dont suit your needs, you can use de the simple activity feed to display notifications or whatever chronological content.</p>
                    </div>
                </div>
            </div>
            <div class="columns is-vcentered pt-30">
                <div class="column is-8 is-offset-2">
                    ...
                    <ol class="simple-feed">
                        <!-- Feed item -->
                        <li class="feed-item">
                            <img class="feed-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/henry.jpg">
                            <div class="feed-item-text">
                                <span class="date">2 minutes ago</span>
                                <span class="text"><span class="name">Henry Rodstein</span> has marked <a href="_components-advancedui-timeline.php#">4 invoices</a> as processed and paid.</span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <img class="feed-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/carolin.png">
                            <div class="feed-item-text">
                                <span class="date">3 hours ago</span>
                                <span class="text"><span class="name">Marjory Cambell</span> has locked and archived <a href="_components-advancedui-timeline.php#">2 invoices</a></span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <img class="feed-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/anthony.jpg">
                            <div class="feed-item-text">
                                <span class="date">5 hours ago</span>
                                <span class="text"><span class="name">Anthony Kowalsky</span> created <a href="_components-advancedui-timeline.php#">2 new opportunities</a></span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <img class="feed-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/kareem.jpg">
                            <div class="feed-item-text">
                                <span class="date">Yesterday</span>
                                <span class="text"><span class="name">Kareem Jabbar</span> has marked <a href="_components-advancedui-timeline.php#">3 invoices</a> with issues and set their priority to urgent.</span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <img class="feed-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/marge.jpg">
                            <div class="feed-item-text">
                                <span class="date">Monday</span>
                                <span class="text"><span class="name">Eleanor Briggs</span> uploaded <a href="_components-advancedui-timeline.php#">5 new invoices</a>.</span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <img class="feed-avatar" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/ben.jpg">
                            <div class="feed-item-text">
                                <span class="date">Last week</span>
                                <span class="text"><span class="name">Kevin Smith</span> has marked <a href="_components-advancedui-timeline.php#">9 invoices</a> as processed and paid.</span>
                            </div>
                        </li>
                    </ol>
                </div>
            ...
            <div class="columns is-vcentered pt-60">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Activity Feed</h4>
                        <p class="no-padding">Avatars can also easily replaced by icons to emphasize your feed content design.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered pt-30 pb-60">
                <div class="column is-8 is-offset-2">
                    ...
                    <ol class="simple-feed">
                        <!-- Feed item -->
                        <li class="feed-item">
                            <i class="im im-icon-Speach-Bubble2 is-icon-2x accent-text"></i>
                            <div class="feed-item-text">
                                <span class="date">2 minutes ago</span>
                                <span class="text"><span class="name">Henry Rodstein</span> sent you a <a href="_components-advancedui-timeline.php#">Message</a>.</span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <i class="im im-icon-Envelope is-icon-2x accent-text"></i>
                            <div class="feed-item-text">
                                <span class="date">3 hours ago</span>
                                <span class="text">You have <a href="_components-advancedui-timeline.php#">5 new messages</a> in your inbox.</span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <i class="im im-icon-Yes is-icon-2x accent-text"></i>
                            <div class="feed-item-text">
                                <span class="date">5 hours ago</span>
                                <span class="text"><a href="_components-advancedui-timeline.php#">3 more users</a> are now following you.</span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <i class="im im-icon-File-Lock is-icon-2x accent-text"></i>
                            <div class="feed-item-text">
                                <span class="date">Yesterday</span>
                                <span class="text">You have <a href="_components-advancedui-timeline.php#">3 overdue invoices</a> pending.</span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <i class="im im-icon-Heart-2 is-icon-2x accent-text"></i>
                            <div class="feed-item-text">
                                <span class="date">Monday</span>
                                <span class="text"><span class="name">Eleanor Briggs</span> liked your <a href="_components-advancedui-timeline.php#">Publication</a>.</span>
                            </div>
                        </li>
                        <!-- Feed item -->
                        <li class="feed-item">
                            <i class="im im-icon-Folders is-icon-2x accent-text"></i>
                            <div class="feed-item-text">
                                <span class="date">Last week</span>
                                <span class="text"><span class="name">Kevin Smith</span> added <a href="_components-advancedui-timeline.php#">a new Folder</a> to an ongoing <a href="_components-advancedui-timeline.php#">Project</a>.</span>
                            </div>
                        </li>
                    </ol>
                </div>
            ...
            <div class="columns">
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-timeline.php#">Discover features</a></li>
                            <li><a href="_components-advancedui-timeline.php#">CMS integration</a></li>
                            <li><a href="_components-advancedui-timeline.php#">Customers</a></li>
                            <li><a href="_components-advancedui-timeline.php#">Weekly sessions</a></li>
                            <li><a href="_components-advancedui-timeline.php#">Free trials and demo</a></li>
                            <li><a href="_components-advancedui-timeline.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-timeline.php#">About us</a></li>
                            <li><a href="_components-advancedui-timeline.php#">About security</a></li>
                            <li><a href="_components-advancedui-timeline.php#">User guide</a></li>
                            <li><a href="_components-advancedui-timeline.php#">Terms of service</a></li>
                            <li><a href="_components-advancedui-timeline.php#">Terms of website use</a></li>
                            <li><a href="_components-advancedui-timeline.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-timeline.php#">Resources</a></li>
                            <li><a href="_components-advancedui-timeline.php#">Blog</a></li>
                            <li><a href="_components-advancedui-timeline.php#">FAQ</a></li>
                            <li><a href="_components-advancedui-timeline.php#">API documentation</a></li>
                            <li><a href="_components-advancedui-timeline.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-advancedui-timeline.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-advancedui-timeline.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-timeline.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-timeline.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-timeline.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-advancedui-timeline.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-timeline.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-advancedui-timeline.php#"></a></div> <!-- Concatenated jQuery and plugins -->
