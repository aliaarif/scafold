...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-sections-carousel.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-sections-carousel.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-sections-carousel.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-sections-carousel.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-sections-carousel.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <h2 class="subtitle is-4 components-subtitle">
                            Slick carousel variations.
                        </h2>
                        <p class="components-cta">
                            <a href="_components-sections-carousel.php#basic" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="carousel-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="image-carousel">
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img src="https://via.placeholder.com/400x300" alt="" data-v1-src="assets/img/v1/flat/big-moon.jpg">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img src="https://via.placeholder.com/400x300" alt="" data-v1-src="assets/img/v1/flat/cactus.png">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img src="https://via.placeholder.com/400x300" alt="" data-v1-src="assets/img/v1/flat/ice-mountains.png">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img src="https://via.placeholder.com/400x300" alt="" data-v1-src="assets/img/v1/flat/moon-mountains.png">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img src="https://via.placeholder.com/400x300" alt="" data-v1-src="assets/img/v1/flat/working.png">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img src="https://via.placeholder.com/400x300" alt="" data-v1-src="assets/img/v1/flat/moon.png">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="section is-medium section-feature-grey">
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered">
                    <div class="column">
                        <div class="multiple-image-carousel">
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img class="stack-logo" src="assets/img/logos/stacks/jquery.png" alt="">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img class="stack-logo" src="assets/img/logos/stacks/angular.png" alt="">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img class="stack-logo" src="assets/img/logos/stacks/meteor.png" alt="">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img class="stack-logo" src="assets/img/logos/stacks/vuejs.png" alt="">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="image-wrapper">
                                    <img class="stack-logo" src="assets/img/logos/stacks/rails.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-carousel.php#">Customers</a></li>
                            <li><a href="_components-sections-carousel.php#">Weekly sessions</a></li>
                            <li><a href="_components-sections-carousel.php#">Free trials and v1</a></li>
                            <li><a href="_components-sections-carousel.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-sections-carousel.php#">About us</a></li>
                            <li><a href="_components-sections-carousel.php#">About security</a></li>
                            <li><a href="_components-sections-carousel.php#">User guide</a></li>
                            <li><a href="_components-sections-carousel.php#">Terms of service</a></li>
                            <li><a href="_components-sections-carousel.php#">Terms of website use</a></li>
                            <li><a href="_components-sections-carousel.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-carousel.php#">Blog</a></li>
                            <li><a href="_components-sections-carousel.php#">FAQ</a></li>
                            <li><a href="_components-sections-carousel.php#">API documentation</a></li>
                            <li><a href="_components-sections-carousel.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-sections-carousel.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-sections-carousel.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-carousel.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-carousel.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-carousel.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-sections-carousel.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-carousel.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-sections-carousel.php#"></a></div> <!-- Concatenated jQuery and plugins -->
