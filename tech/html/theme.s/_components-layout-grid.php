...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-layout-grid.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-layout-grid.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-layout-grid.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-layout-grid.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-layout-grid.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <p class="components-cta">
                            <a href="_components-layout-grid.php#basic" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="grid-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="basic" class="section">
        <div class="container">
            ...
            <div class="columns has-text-left">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Basic grid</h4>
                        <p>Bulkit uses the <a href="https://bulma.io/" target="_blank">Bulma.io</a> flex-box based grid
                            system. It is very flexible and easy to use. To create a new row, create a <code>div</code> with
                            a <code>.columns</code> class. It serves as the main wrapper for the columns that you will use
                            to build your layout. This columns can have several modifiers: </p>
                        <ul>
                            <li>
                                <p><b><code>.is-vcentered</code></b>: vertically centers all columns inside that row.</p>
                            </li>
                            <li>
                                <p><b><code>.is-gapless</code></b>: removes padding between columns.</p>
                            </li>
                            <li>
                                <p><b><code>.is-multiline</code></b>: gives the row the <code>flex-wrap: wrap</code> css
                                    property, so your columns span accross multiple lines.</p>
                            </li>
                            <li>
                                <p><b><code>.is-flex-mobile</code></b>: maintains the flex layout on mobile devices.</p>
                            </li>
                        </ul>
                        <p class="pt-20">More modifiers and responsive options are available, just check the <a href="https://bulma.io/" target="_blank">Bulma.io</a> framework documentation. To add
                            columns, just add the needed number of <code>divs</code> with a class of <code>.column</code>
                            inside the previously created <code>.columns</code> div. Columns without any modifier share the
                            available space.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-system">
                <div class="columns">
                    <div class="column">
                        <p class="is-blue">Column</p>
                    </div>
                    <div class="column">
                        <p class="is-green">Column</p>
                    </div>
                    <div class="column">
                        <p class="is-orange">Column</p>
                    </div>
                    <div class="column">
                        <p class="is-red">Column</p>
                    </div>
                </div>
            </div>

            <!-- Column sizes -->
            <div class="columns has-text-left pt-80">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Column sizes</h4>
                        <p>Columns have several size modifiers that you can define. You can try
                            <code>.is-three-quarters</code>, <code>is-two-thirds</code>, <code>.is-half</code>,
                            <code>.is-one-third</code> or <code>.is-one-quarter</code>. Columns without a modifier will take
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-three-quarters">
                        <p class="is-blue"><code>is-three-quarters</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
                    <div class="column">
                        <p class="is-orange">Auto</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-two-thirds">
                        <p class="is-blue"><code>is-two-thirds</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-half">
                        <p class="is-blue"><code>is-half</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-one-third">
                        <p class="is-blue"><code>is-one-third</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-one-quarter">
                        <p class="is-blue"><code>is-one-quarter</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="columns has-text-left pt-80">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>12 columns system</h4>
                        <p>Columns can also be organized following a 12 columns grid system. In this case, modifiers take
                            the form of <code>.is-*</code> followed by desired number, from <b>1</b> to <b>12</b>.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns is-multiline">
                    <div class="column is-2">
                        <p class="is-blue"><code>is-2</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-3">
                        <p class="is-blue"><code>is-3</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-4">
                        <p class="is-blue"><code>is-4</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-5">
                        <p class="is-blue"><code>is-5</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-6">
                        <p class="is-blue"><code>is-6</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="columns has-text-left pt-80">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>12 columns examples</h4>
                        <p>You can find below some examples of what you can achieve with the Bulma grid. Layout
                            possibilities are endless. Note that you can easily nest <code>.columns</code> (e.g : rows)
                            inside others <code>.columns</code>. </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    ...
                    <div class="column is-6">
                        <p class="is-green"><code>is-6</code></p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    ...
                    <div class="column is-8">
                        <p class="is-green"><code>is-8</code></p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    ...
                    <div class="column is-4">
                        <p class="is-green"><code>is-4</code></p>
                    </div>
                    <div class="column is-4">
                        <p class="is-orange"><code>is-4</code></p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    ...
                    <div class="column is-3">
                        <p class="is-green"><code>is-3</code></p>
                    </div>
                    <div class="column is-3">
                        <p class="is-orange"><code>is-3</code></p>
                    </div>
                    <div class="column is-3">
                        <p class="is-red"><code>is-3</code></p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-7">
                        <p class="is-blue"><code>is-7</code></p>
                    </div>
                    <div class="column is-5">
                        <p class="is-green"><code>is-5</code></p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns has-text-left pt-80">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        ...
                        <p>Columns can be offseted easily. To offset a column, add a modifier following this naming
                            convention : <code>is-offset-*</code> where <code>*</code> represents the value of the offset
                            you want in the grid.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-6 is-offset-3">
                        <p class="is-blue"><code>is-6 is-offset-3</code></p>
                    </div>
                </div>
            </div>
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-4 is-offset-2">
                        <p class="is-green"><code>is-4 is-offset-2</code></p>
                    </div>
                </div>
            </div>
            <div class="grid-system is-medium">
                <div class="columns">
                    <div class="column is-3 is-offset-5">
                        <p class="is-orange"><code>is-3 is-offset-5</code></p>
                    </div>
                </div>
            </div>
            ...
            <div class="columns has-text-left pt-80">
                <div class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Using Fifths </h4>
                        <p>Columns now support being divided in fifths since <b>Bulma 0.6.1</b> : You can now use the
                            following multiples of 20% :</p>
                        <div class="content">
                            <ul>
                                <li><code>is-four-fifths</code></li>
                                <li><code>is-three-fifths</code></li>
                                <li><code>is-two-fifths</code></li>
                                <li><code>is-one-fifth</code></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns is-multiline">
                    <div class="column is-four-fifths">
                        <p class="is-blue"><code>is-four-fifths</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns is-multiline">
                    <div class="column is-three-fifths">
                        <p class="is-blue"><code>is-three-fifths</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium">
                <div class="columns is-multiline">
                    <div class="column is-two-fifths">
                        <p class="is-blue"><code>is-two-fifths</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="grid-system is-medium pb-60">
                <div class="columns is-multiline">
                    <div class="column is-one-fifth">
                        <p class="is-blue"><code>is-one-fifth</code></p>
                    </div>
                    <div class="column">
                        <p class="is-green">Auto</p>
                    </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-layout-grid.php#">Customers</a></li>
                            <li><a href="_components-layout-grid.php#">Weekly sessions</a></li>
                            <li><a href="_components-layout-grid.php#">Free trials and demo</a></li>
                            <li><a href="_components-layout-grid.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-layout-grid.php#">About us</a></li>
                            <li><a href="_components-layout-grid.php#">About security</a></li>
                            <li><a href="_components-layout-grid.php#">User guide</a></li>
                            <li><a href="_components-layout-grid.php#">Terms of service</a></li>
                            <li><a href="_components-layout-grid.php#">Terms of website use</a></li>
                            <li><a href="_components-layout-grid.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-layout-grid.php#">Blog</a></li>
                            <li><a href="_components-layout-grid.php#">FAQ</a></li>
                            <li><a href="_components-layout-grid.php#">API documentation</a></li>
                            <li><a href="_components-layout-grid.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-layout-grid.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-layout-grid.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-grid.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-grid.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-grid.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-layout-grid.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-grid.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-layout-grid.php#"></a></div> <!-- Concatenated jQuery and plugins -->
