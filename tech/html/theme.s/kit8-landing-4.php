...
<body class="is-theme-core">
    ...
    <!-- Hero and Navbar -->
    <div class="hero is-fullheight rounded-hero">
            ...
            <div class="container">
                ...
                <div id="is-cloned" class="navbar-menu">
                    ...
                    <div class="navbar-start">
                                    ...
                                    <div class="container">
                                        <div class="columns">
                                            <div class="column">
                                                ...
                                                <a class="navbar-item is-flex" href="kit8-jobs.php">
                                            ...
                                            <div class="column">
                                                ...
                                                <p class="is-cta">
                                                    <a href="kit8-landing-4.php#" class="button btn-align mega-btn primary-btn">Learn more</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="kit8-landing-4.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="kit8-landing-4.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="kit8-landing-4.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="kit8-landing-4.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="kit8-landing-4.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <a class="navbar-item is-slide is-centered-tablet is-hidden-desktop is-hidden-tablet" href="kit8-jobs.php">
                            Jobs
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide is-centered-tablet" href="kit8-pricing.php">
                            Pricing
                        </a>
                    </div>
                    ...
                    <div class="navbar-end">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide is-centered-tablet" href="kit8-login.php">
                            Login
                        </a>
                        <!-- Signup button -->
                        <div class="navbar-item is-button is-centered-tablet">
                            <a id="#signup-btn" href="kit8-signup.php" class="button button-cta is-bold btn-align primary-btn raised is-rounded">
                                Sign up
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div id="is-static" class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        ...
                        <!-- Signup button -->
                        <div class="navbar-item is-button is-centered-tablet">
                            <a id="#signup-btn-double" href="kit8-signup.php" class="button button-cta is-bold btn-align secondary-btn raised is-rounded">
                                Sign up
                            </a>
                        </div>
                    </div>
        ...
        <div class="absolute-header">
            <div class="header-inner">
                <img class="cut-circle" src="assets/img/graphics/legacy/cut-shape-v4.svg" alt="">
            </div>
        </div>

        <div class="hero-body has-text-centered">
            <div class="container">
                <h1 class="title is-1 is-bold is-light">Work Fast. Get Paid.</h1>
                <h3 class="subtitle is-5 is-light">A hole new way to think freelancing.</h3>
                <div class="buttons">
                    <a href="kit8-landing-4.php#" class="button button-cta is-bold btn-align secondary-btn is-rounded raised">
                        Get Started
                    </a>
                    <a href="kit8-landing-4.php#" class="button button-cta is-bold btn-align primary-btn is-rounded raised">
                        Try For Free
                    </a>
                </div>
                <img class="hero-mockup" src="assets/img/graphics/apps/app-dashboard-full-core.png" data-base-url="assets/img/graphics/apps/app-dashboard-full" data-extension=".png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="section-title has-text-centered">
                <h2 class="title is-2">Freelancing made Easy</h2>
                <h4>Discover a brand new way of managing freelance projects.</h4>
            </div>
            ...
            <div class="cta-block">
                ...
                <div class="head-action">
                    <div class="buttons">
                        <a class="button primary-btn is-rounded raised action-button">Try it free</a>
        ...
        <div class="container">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-image" src="assets/img/graphics/widgets/widget-23-core.png" data-base-url="assets/img/graphics/widgets/widget-23" data-extension=".png" alt="">
                </div>
                <div class="column is-5">
                    <h2 class="title feature-title dark-text no-margin is-centered-tablet-portrait">Build your profile</h2>
                    <p class="section-feature-description is-centered-tablet-portrait">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum inermis
                        iudicabit. Ex vidit fierent hendrerit eum, sed stet periculis ut. Vis in probo decore labitur.
                    </p>
                </div>
            </div>
            <!-- Feature -->
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered is-hidden-desktop is-hidden-tablet">
                    <img class="featured-image" src="assets/img/graphics/drawings/drawing-7-core.svg" data-base-url="assets/img/graphics/drawings/drawing-7" data-extension=".svg" alt="">
                </div>
                <div class="column is-5">
                    <h2 class="title feature-title dark-text no-margin is-centered-tablet-portrait">Get top ranked</h2>
                    <p class="section-feature-description is-centered-tablet-portrait">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum inermis
                        iudicabit. Ex vidit fierent hendrerit eum, sed stet periculis ut. Vis in probo decore labitur.
                    </p>
                </div>
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-image" src="assets/img/graphics/widgets/widget-24-core.png" data-base-url="assets/img/graphics/widgets/widget-24" data-extension=".png" alt="">
                </div>
                <div class="column is-5">
                    <h2 class="title feature-title dark-text no-margin is-centered-tablet-portrait">Work on top tier projects</h2>
                    <p class="section-feature-description is-centered-tablet-portrait">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum inermis
                        iudicabit. Ex vidit fierent hendrerit eum, sed stet periculis ut. Vis in probo decore labitur.
                    </p>
                </div>
            ...
            <div class="cta-block no-border pt-30">
                <div class="head-text">
                    ...
                    <p>Check our customer help center for more info</p>
                </div>
                <div class="head-action">
                    <div class="buttons">
                        <a class="button secondary-btn is-rounded raised action-button">Help Center</a>
                        <a class="button chat-button is-secondary">Chat with us</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section section-focus">
        <div class="container has-text-centered">
            <div class="columns is-vcentered pt-40">
                <div class="column is-6 is-offset-3 has-text-centered">
                    ...
                    <div class="section-title has-text-centered pb-40">
                        <h2 class="title is-3">Use our presentation tools</h2>
                        <h4>Some awesome featured subtitle.</h4>
                    </div>
            ...
            <div class="columns is-vcentered presentation-tools">
                <div class="column is-4">
                    ...
                    <div class="content content-flex">
                        <div class="dark-text">
                            <i class="im im-icon-Video-5 is-size-2 color-secondary"></i>
                        </div>
                        <div class="dark-text has-text-left ml-30">
                            <h5 class="text-bold mb-10">Video Editing</h5>
                ...
                <div class="column is-4">
                    ...
                    <div class="content content-flex">
                        <div class="dark-text">
                            <i class="im im-icon-Vector-5 is-size-2 color-secondary"></i>
                        </div>
                        <div class="dark-text has-text-left ml-30">
                            <h5 class="text-bold mb-10">Vector Editing</h5>
                            Lorem ipsum dolor sit amet, ea vis numquam vivendo, voluptua argumentum an pri. Duo illud consequat in, eum eu veri ipsum oporteat.
                        </div>
                    </div>
                </div>
                <div class="column is-4">
                    ...
                    <div class="content content-flex">
                        <div class="dark-text">
                            <i class="im im-icon-Blackboard is-size-2 color-secondary"></i>
                        </div>
                        <div class="dark-text has-text-left ml-30">
                            <h5 class="text-bold mb-10">Screen Sharing</h5>
                            Lorem ipsum dolor sit amet, ea vis numquam vivendo, voluptua argumentum an pri. Duo illud consequat in, eum eu veri ipsum oporteat.
                        </div>
                    </div>
                </div>
            ...
            <!--CTA-->
            <p class="pt-40 pb-40">
                <a href="kit8-landing-4.php#product" class="button button-cta btn-align raised rounded secondary-btn">
                    Learn more
                </a>
            </p>
        </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="section-title has-text-centered pt-40">
                <h2 class="title is-3">Why our customers choose Bulkit</h2>
                ...
                <div class="testimonials-solo-carousel">
                    ...
                    <div class="testimonial-item">
                        <div class="left-side">
                            <div class="avatar-container">
                                ...
                                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/v1/photos/1.jpg">
                                <img class="dots is-bottom" src="assets/img/graphics/legacy/dots.svg" alt="">
                            </div>
                            <div class="avatar-info">
                                <h3>Robert Klemens</h3>
                                <p>HR Manager</p>
                            </div>
                        </div>
                        <div class="right-side">
                            <img class="company-logo" src="https://bulkit.cssninja.io/assets/img/logos/custom/infinite.svg" alt="">
                            <div class="testimonial-content">
                                <p class="text-content">
                                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Invidiosum nomen est, infame, suspectum. Utilitatis causa
                                    amicitia est quaesita. Non laboro, inquit, de nomine. Duo Reges: constructio interrete. Aliter homines, aliter
                                    philosophos loqui putas oportere?"
                                </p>
                                <a class="learn-more" href="kit8-landing-4.php#">
                                ...
                                <div class="metrics">
                                    <div class="metric">
                                        <svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="50" height="33" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <circle class="circle-chart__circle" stroke="#8c8cf9" stroke-width="2" stroke-dasharray="90,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" />
                                            <circle class="circle-chart__circle" stroke="#cfcfff" stroke-width="2" stroke-dasharray="30,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" />
                                    ...
                                    <div class="metric">
                                        <svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="50" height="33" xmlns="http://www.w3.org/2000/svg">
                                            <circle class="circle-chart__background" stroke="#efefef" stroke-width="2" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" />
                                            <circle class="circle-chart__circle" stroke="#8c8cf9" stroke-width="2" stroke-dasharray="60,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" />
                                            <circle class="circle-chart__circle" stroke="#cfcfff" stroke-width="2" stroke-dasharray="30,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" />
                                            <g class="circle-chart__info">
                                            </g>
                                        </svg>
                    ...
                    <div class="testimonial-item">
                        <div class="left-side">
                            <div class="avatar-container">
                                <img class="dots is-top" src="assets/img/graphics/legacy/dots.svg" alt="">
                                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/v1/photos/2.jpg">
                                <img class="dots is-bottom" src="assets/img/graphics/legacy/dots.svg" alt="">
                            </div>
                            <div class="avatar-info">
                                <h3>Hank Breueur</h3>
                        ...
                        <div class="right-side">
                            ...
                            <div class="testimonial-content">
                                <p class="text-content">
                                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Invidiosum nomen est, infame, suspectum. Utilitatis causa
                                    amicitia est quaesita. Non laboro, inquit, de nomine. Duo Reges: constructio interrete. Aliter homines,
                    ...
                    <div class="testimonial-item">
                        <div class="left-side">
                            <div class="avatar-container">
                                <img class="dots is-top" src="assets/img/graphics/legacy/dots.svg" alt="">
                                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/v1/photos/3.jpg">
                                <img class="dots is-bottom" src="assets/img/graphics/legacy/dots.svg" alt="">
                            </div>
                            <div class="avatar-info">
                                <h3>Yuko Kurosaki</h3>
                        ...
                        <div class="right-side">
                            ...
                            <div class="testimonial-content">
                                <p class="text-content">
                                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Invidiosum nomen est, infame, suspectum.
                                    Utilitatis causa
                                    amicitia est quaesita. Non laboro, inquit, de nomine. Duo Reges: constructio interrete. Aliter homines,
                                    aliter philosophos loqui putas oportere?"
                                </p>
                    ...
                    <div class="testimonial-item">
                        <div class="left-side">
                            <div class="avatar-container">
                                <img class="dots is-top" src="assets/img/graphics/legacy/dots.svg" alt="">
                                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/v1/photos/4.jpg">
                                <img class="dots is-bottom" src="assets/img/graphics/legacy/dots.svg" alt="">
                            </div>
                            <div class="avatar-info">
                                <h3>John Drazic</h3>
            ...
            <div class="columns">
                <div class="column is-10 is-offset-1">
                    <div class="grid-clients three-grid pt-20 pb-60">
                        <div class="columns is-vcentered">
    ...
    <div class="section section-focus">
        <div class="container">
            ...
            <div class="columns pb-30">
                ...
                <div class="column is-9">
                    <div class="cta-block is-box">
                        <div class="head-text">
                            <h3>Successful job hunters</h3>
                            <p>Some success stories on Bulkit</p>
                        </div>
                        <div class="head-action">
                            <div class="buttons">
                                <a class="button secondary-btn is-rounded raised action-button">learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="columns pb-30">
                <div class="column is-hidden-mobile"></div>
                <div class="column is-9">
                    <div class="columns is-vcentered is-multiline stories">
                        <!--Story-->
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-4.php#">Beating job challenges for almost 5 years</a></h3>
                                            <p class="mcard-description is-hidden-touch">Discover Melany's success story on Bulkit HR recruiting </p>
                                        </div>
                                        <div class="mcard-controls">
                                            ...
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-4.php#" class="color-primary">Melany Smith</a></span>
                                                <div><span>29 Aug</span> <i class="fa fa-circle"></i> <span>15m</span></div>
                                            </div>
                                    ...
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-v1-background="assets/img/v1/photos/l1.jpg"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-v1-background="assets/img/v1/photos/l2.jpg"></div>
                                    </div>
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-4.php#">Bulkit HR recruiting changed my work habits</a></h3>
                                            <p class="mcard-description is-hidden-touch">Discover Terry's success story on Bulkit HR recruiting </p>
                                        </div>
                                        <div class="mcard-controls">
                                            <div class="mcard-avatar">
                                            ...
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-4.php#" class="color-primary">Terry Daniels</a></span>
                                                <div><span>06 Oct</span> <i class="fa fa-circle"></i> <span>4m</span></div>
                                            </div>
                                            <div class="mcard-actions ml-auto">
                                                <span><i class="material-icons">bookmark_border</i> </span>
                                            </div>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-4.php#">It helped me switch to full time freelance</a></h3>
                                            <p class="mcard-description is-hidden-touch">Discover Sally's success story on Bulkit HR recruiting </p>
                                        </div>
                                        <div class="mcard-controls">
                                            <div class="mcard-avatar">
                                                <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/sally.jpg">
                                            </div>
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-4.php#" class="color-primary">Sally Mitchells</a></span>
                                                <div><span>29 Aug</span> <i class="fa fa-circle"></i> <span>15m</span></div>
                                            </div>
                                            <div class="mcard-actions ml-auto">
                                                <span><i class="material-icons">bookmark_border</i> </span>
                                    ...
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-v1-background="assets/img/v1/photos/l3.jpg"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-v1-background="assets/img/v1/photos/l4.jpg"></div>
                                    </div>
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-4.php#">Got rid of time tracking problems.</a></h3>
                                            <p class="mcard-description is-hidden-touch">Discover Mark's success story on Bulkit HR recruiting </p>
                                        </div>
                                        <div class="mcard-controls">
                                            <div class="mcard-avatar">
                                                <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/marc.jpg">
                                            </div>
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-4.php#" class="color-primary">Mark Walters</a></span>
                                                <div><span>06 Oct</span> <i class="fa fa-circle"></i> <span>4m</span></div>
                                            </div>
                                            <div class="mcard-actions ml-auto">
                                                <span><i class="material-icons">bookmark_border</i> </span>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-4.php#">A big choice of big to small sized jobs</a></h3>
                                            <p class="mcard-description is-hidden-touch">Discover Fred's success story on Bulkit HR recruiting </p>
                                        </div>
                                        <div class="mcard-controls">
                                            <div class="mcard-avatar">
                                                <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/fred.jpg">
                                            </div>
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-4.php#" class="color-primary">Fred Gillings</a></span>
                                                <div><span>29 Aug</span> <i class="fa fa-circle"></i> <span>15m</span></div>
                                            </div>
                                            <div class="mcard-actions ml-auto">
                                                <span><i class="material-icons">bookmark_border</i> </span>
                                    ...
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-v1-background="assets/img/v1/photos/l5.jpg"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-v1-background="assets/img/v1/photos/l6.jpg"></div>
                                    </div>
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-4.php#">I earn a lot more working overall less time.</a></h3>
                                            <p class="mcard-description is-hidden-touch">Discover Janet's success story on Bulkit HR recruiting </p>
                                        </div>
                                        <div class="mcard-controls">
                                            <div class="mcard-avatar">
                                                <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/janet.jpg">
                                            </div>
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-4.php#" class="color-primary">Janet Biggs</a></span>
                                                <div><span>06 Oct</span> <i class="fa fa-circle"></i> <span>4m</span></div>
                                            </div>
                                            <div class="mcard-actions ml-auto">
                                                <span><i class="material-icons">bookmark_border</i> </span>
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit8-landing-4.php#">Home</a></li>
                                <li class="column-item"><a href="kit8-landing-4.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit8-landing-4.php#">Get started</a></li>
                                <li class="column-item"><a href="kit8-landing-4.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit8-landing-4.php#">Learning</a></li>
                                <li class="column-item"><a href="kit8-landing-4.php#">Support center</a></li>
                                <li class="column-item"><a href="kit8-landing-4.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit8-landing-4.php#">Schedule a v1</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit8-landing-4.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit8-landing-4.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit8-landing-4.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit8-landing-4.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit8-landing-4.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit8-landing-4.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit8-landing-4.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit8-landing-4.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-4.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit8-landing-4.php#"></a></div>
            ...
            <div class="chat-header">
                ...
                <div class="chat-team">
                    <div class="team-member has-text-centered">
                        <img src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/alan.jpg">
