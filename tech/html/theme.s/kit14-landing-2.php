...
<body class="is-theme-core">
    ...
    <div class="hero parallax is-cover is-relative is-fullheight" data-background="https://via.placeholder.com/1920x1280" data-color="#545375" data-color-opacity="0.8" data-demo-background="assets/img/demo/good-morning.jpeg">
            ...
            <div class="container">
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-start">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit14-landing-2.php#">
                            Learn
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit14-landing-2.php#">
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item is-button">
                            <a id="#signup-btn" href="kit14-landing-2.php#" class="button button-signup btn-outlined is-rounded is-bold btn-align light-btn rounded raised">
                                Register
                            </a>
                        </div>
                    </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-6 is-offset-3 has-text-centered">
                        ...
                        <h2 class="subtitle is-5 light-text">
                            Nothing can restrain you now. Get started and code like a Hero !
                        </h2>
                        <br>
                        <p class="has-text-centered">
                            <a href="kit14-landing-2.php#" class="button button-cta btn-align primary-btn rounded z-index-2">
                                Get Started
                            </a>
                        </p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                ...
                <div class="has-text-centered pt-40 pb-40">
                    <a href="kit14-landing-2.php#" class="button button-cta primary-btn rounded raised">Learn more</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered pb-40 pt-40">
                    <div class="column is-4 is-offset-1">
                        ...
                        <div class="pt-10 pb-10">
                            <a href="kit14-landing-2.php#" class="button btn-align btn-more is-link color-primary">
                ...
                <div class="columns is-vcentered pb-40 pt-40">
                    <div class="column is-4 is-offset-1">
                        <!-- Title -->
                        <div class="icon-subtitle"><i class="im im-icon-Business-ManWoman"></i></div>
                        <div class="title quick-feature has-numbers text-bold">
                ...
                <div class="has-text-centered is-title-reveal pt-20 pb-20">
                    <a href="kit14-landing-2.php#" class="button button-cta primary-btn rounded raised">Start your Free trial</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="content-wrapper hover-cards">
                ...
                <div class="button-wrap has-text-centered is-title-reveal">
                    <a href="kit2-signup.php" class="button button-cta is-rounded btn-align raised primary-btn raised">
        ...
        <div class="container">
            ...
            <div class="section-title-wrapper has-text-centered">
                ...
                <div class="button-wrap has-text-centered is-title-reveal mb-40">
                    <a href="kit2-signup.php" class="button button-cta btn-align raised primary-btn raised">
                        Start your Free Trial
                    </a>
                </div>
            </div>
                    ...
                    <div class="column is-6 backend-code-container">
                        ...
                        <article class="code-container gradient-left">
                            ...
                            <div data-backend-sample="ruby" class="active">
                                <pre class="m-t-none m-b-none highlight ruby"><code><span class="n">my_data</span> <span class="o">=</span> <span class="no">Bulkit</span><span class="o">::</span><span class="no">App</span><span class="p">.</span><span class="nf">get</span><span class="p">(</span><span class="s1">'contacts'</span><span class="p">)</span>
    <span class="n">my_data</span><span class="p">.</span><span class="nf">get_object</span> <span class="ss">:firstname</span> <span class="o">=&gt;</span> <span class="s2">"John"</span><span class="p">,</span>
                        ...
                        <span class="ss">:company</span> <span class="o">=&gt;</span> <span class="s2">"Css Ninja"</span>
                            ...
                            <div data-backend-sample="rails">
                                <pre class="m-t-none m-b-none highlight ruby"><code><span class="k">class</span> <span class="nc">Contact</span> <span class="o">&lt;</span> <span class="no">Records</span><span class="o">::</span><span class="no">Base</span>
    ...
    <span class="k">end</span>
                            ...
                            <div data-backend-sample="python">
                                <pre class="m-t-none m-b-none highlight python"><code><span class="n">myData</span> <span class="o">=</span> <span class="n">apiClient</span><span class="o">.</span><span class="n">init_db</span><span class="p">(</span><span class="s">"contacts"</span><span class="p">)</span>
    <span class="n">myData</span><span class="o">.</span><span class="n">add_object</span><span class="p">({</span><span class="s">"firstname"</span><span class="p">:</span> <span class="s">"John"</span><span class="p">,</span>
                        ...
                        <span class="s">"company"</span><span class="p">:</span> <span class="s">"Css Ninja"</span><span class="p">})</span>
                            ...
                            <div data-backend-sample="django">
                                <pre class="m-t-none m-b-none highlight python"><code><span class="kn">from</span> <span class="nn">django.contrib.bulkit</span> <span class="kn">import</span> <span class="n">BulkitApi</span>
             ...
             <span class="k">class</span> <span class="nc">MyModel</span><span class="p">(</span><span class="n">BulkitApi</span><span class="p">):</span>
                 <span class="n">fields</span> <span class="o">=</span> <span class="p">(</span><span class="s">'firstname'</span><span class="p">,</span> <span class="s">'lastname'</span><span class="p">,</span> <span class="s">'company'</span><span class="p">)</span>
                            ...
                            <div data-backend-sample="php">
                                <pre class="m-t-none m-b-none highlight javascript"><code><span class="nx">$myData</span> <span class="o">=</span> <span class="nx">$apiClient</span><span class="o">-&gt;</span><span class="nx">initDB</span><span class="p">(</span><span class="s2">"contacts"</span><span class="p">);</span>
    ...
    <span class="p">]);</span>
                            ...
                            <div data-backend-sample="symfony">
                                <pre class="m-t-none m-b-none highlight javascript"><code><span class="cm">/**
    *
    * @ORM\Entity
    *
    * @Bulkit\Index()
    ...
    */</span>
    ...
    <span class="p">}</span>
                            ...
                            <div data-backend-sample="javascript">
                                <pre class="m-t-none m-b-none highlight javascript"><code><span class="kr">const</span> <span class="nx">myData</span> <span class="o">=</span> <span class="nx">apiClient</span><span class="p">.</span><span class="nx">initDB</span><span class="p">(</span><span class="s1">'contacts'</span><span class="p">);</span>
    ...
    <span class="o">);</span>
                            ...
                            <div data-backend-sample="scala">
                                <pre class="m-t-none m-b-none highlight scala"><code><span class="c1">//For the DSL
    ...
    <span class="o">}</span>
                            ...
                            <div data-backend-sample="go">
                                <pre class="m-t-none m-b-none highlight go"><code><span class="n">object</span><span class="x"> </span><span class="o">:=</span><span class="x"> </span><span class="n">bulkit</span><span class="o">.</span><span class="n">Object</span><span class="p">{</span><span class="x">
                            ...
                            <div data-backend-sample="csharp">
                                <pre class="m-t-none m-b-none highlight csharp"><code><span class="n">Data</span> <span class="n">myData</span> <span class="p">=</span> <span class="n">apiClient</span><span class="p">.</span><span class="nf">InitData</span><span class="p">(</span><span class="s">"contacts"</span><span class="p">);</span>
    ...
    <span class="n">myIndex</span><span class="p">.</span><span class="nf">AddObject</span><span class="p">(</span><span class="n">jsonObject</span><span class="p">);</span>
                            ...
                            <div data-backend-sample="apple">
                                <pre class="m-t-none m-b-none highlight javascript"><code><span class="kd">let</span> <span class="nx">myData</span> <span class="o">=</span> <span class="nx">apiClient</span><span class="p">.</span><span class="nx">getData</span><span class="p">(</span><span class="s2">"contacts"</span><span class="p">)</span>
    ...
    <span class="nx">myIndex</span><span class="p">.</span><span class="nx">addObject</span><span class="p">(</span><span class="nx">n</span><span class="p">)</span>
                            ...
                            <div data-backend-sample="android">
                                <pre class="m-t-none m-b-none highlight java"><code><span class="n">Data</span> <span class="n">myData</span> <span class="o">=</span> <span class="n">apiClient</span><span class="o">.</span><span class="na">initData</span><span class="o">(</span><span class="s">"contacts"</span><span class="o">);</span>
                            ...
                            <ul class="tab-codesnippets" id="tab-backend">
                                    ...
                                    <span class="Ruby clickable text-muted">
                                        <svg id="use-ruby" viewBox="0 0 70 70">
                                            <g fill="none" fill-rule="evenodd">
                                                <circle fill="currentColor" cx="35" cy="35" r="35"></circle>
                                                <path
                                        ...
                                        <svg id="use-python" viewBox="0 0 70 70">
                                            <g fill="none" fill-rule="evenodd">
                                                ...
                                                <path
                                                    ...
                                                    class="fill-alt" fill="#C8CFE9"></path>
                                            </g>
                                        </svg>
                                ...
                                <li class="javascript" data-language="javascript" data-languagename="JavaScript">
                                    <span class="JavaScript clickable text-muted">
                                        ...
                                        <small class="text-muted block text-ellipsis">JavaScript</small>
                                    </span>
                                </li>
                                    ...
                                    <span class="Go clickable text-muted">
                                        <svg id="use-go" viewBox="0 0 70 70">
                                            <g transform="translate(-1)" fill="none" fill-rule="evenodd">
                                                <circle fill="currentColor" cx="35.984" cy="35" r="35"></circle>
                    ...
                    <div class="column is-6 frontend-code-container">
                        ...
                        <article class="code-container gradient-right block">
                            ...
                            <header>
                                ...
                                <span class="m-r-small p-mini inline backend-label">Javascript</span>
                            </header>

                            <!--Javascript-->
                            <div data-frontend-sample="javascript" class="active">
                                <pre class="p-large m-t-none m-b-none highlight html active"><code><span class="nt">&lt;div</span> <span class="na">id=</span><span class="s">"wrapper"</span><span class="nt">&gt;&lt;/div&gt;</span>
    ...
    <span class="nt">&lt;/script&gt;</span>
                            ...
                            <div data-frontend-sample="reactinstantsearch">
                                <pre class="p-large m-t-none m-b-none highlight javascript"><code><span class="kr">const</span> <span class="nx">App</span> <span class="o">=</span> <span class="p">(</span>
    <span class="o">&lt;</span><span class="nx">Wrapper</span><span class="o">&gt;</span>
        ...
        <span class="sr">/</span><span class="err">&gt;
                            ...
                            <div data-frontend-sample="android">
                                <pre class="p-large m-t-none m-b-none highlight xml"><code><span class="nt">&lt;RelativeLayout</span>
    ...
    <span class="nt">&lt;/RelativeLayout&gt;</span>
                            ...
                            <div data-frontend-sample="vue">
                                <pre class="p-large m-t-none m-b-none highlight html"><code><span class="nt">&lt;bulkit-index&gt;</span>
    ...
    <span class="nt">&lt;/bulkit-index&gt;</span>
                            ...
                            <div data-frontend-sample="angular">
                                <pre class="p-large m-t-none m-b-none highlight javascript"><code><span class="err">@</span><span class="nx">Component</span><span class="p">({</span>
    ...
    <span class="kr">export</span> <span class="nx">bulkit</span><span class="p">(</span><span class="nx">App</span><span class="p">);</span>
                            ...
                            <div data-frontend-sample="apple">
                                <pre class="p-large m-t-none m-b-none highlight swift"><code><span class="kd">import</span> <span class="kt">Bulkit</span>
                                ...
                                <li class="clickable vue" data-language="vue" data-languagename="Vue">
                                    <span class="clickable text-muted use-Vue">
                                        <svg id="use-vue" viewBox="0 0 75 75">
                                            <g fill="none" fill-rule="evenodd">
                                                <circle cx="37.277" cy="37.277" r="37.277" fill="currentColor"></circle>
                                                <path fill="#FFF" fill-opacity=".5" fill-rule="nonzero"
                                                    d="M32 21l5 9 5-9h16L37 58 16 21"></path>
                                                <path fill="#FFF" fill-rule="nonzero" d="M33 21l4 8 5-8h8L37 43 25 21">
                                                </path>
                                            </g>
                                        </svg>
                                    ...
                                    <span class="clickable text-muted use-AngularJS">
                                        <svg id="use-angular" viewBox="0 0 75 75">
                                            <g fill="none" fill-rule="evenodd">
                                                ...
                                                <path fill="#FFF" fill-rule="nonzero"
                                                    d="M37.5 16v4.884-.022V60l17.207-9.614 3.097-27.082"></path>
                                        ...
                                        <small class="text-muted block text-ellipsis">AngularJS</small>
                                    </span>
                                </li>
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit14-landing-2.php#">Home</a></li>
                                <li class="column-item"><a href="kit14-landing-2.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit14-landing-2.php#">Get started</a></li>
                                <li class="column-item"><a href="kit14-landing-2.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit14-landing-2.php#">Learning</a></li>
                                <li class="column-item"><a href="kit14-landing-2.php#">Support center</a></li>
                                <li class="column-item"><a href="kit14-landing-2.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit14-landing-2.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit14-landing-2.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit14-landing-2.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit14-landing-2.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit14-landing-2.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit14-landing-2.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit14-landing-2.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit14-landing-2.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit14-landing-2.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit14-landing-2.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit14-landing-2.php#"></a></div>
