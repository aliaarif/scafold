...
<body class="is-theme-core">
    ...
    <div class="hero is-fullheight rounded-hero">
                                    ...
                                    <div class="container">
                                        <div class="columns">
                                            ...
                                            <div class="column">
                                                ...
                                                <p class="is-cta">
                                                    <a href="kit8-landing-3.php#" class="button btn-align mega-btn primary-btn">Learn more</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="kit8-landing-3.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="kit8-landing-3.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="kit8-landing-3.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="kit8-landing-3.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="kit8-landing-3.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="absolute-header">
            <div class="header-inner">
                <img class="cut-circle" src="assets/img/graphics/legacy/cut-shape-v3.svg" alt="">
            </div>
        </div>
        ...
        <div class="hero-body has-text-centered">
            <div class="container">
                ...
                <div class="buttons">
                    <a href="kit8-landing-3.php#" class="button button-cta is-bold btn-align secondary-btn is-rounded raised">
                        Get Started
                    </a>
                    <a href="kit8-landing-3.php#" class="button button-cta is-bold btn-align primary-btn is-rounded raised">
                        Try For Free
                    </a>
                </div>
    ...
    <div class="section section-focus">
        <div class="container has-text-centered">
            ...
            <!--CTA-->
            <p class="pt-40 pb-40">
                <a href="kit8-landing-3.php#product" class="button button-cta btn-align raised rounded secondary-btn">
                    Learn more
                </a>
            </p>
        </div>
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="right-side">
                            ...
                            <div class="testimonial-content">
                                ...
                                <a class="learn-more" href="kit8-landing-3.php#">
                    ...
                    <div class="columns is-vcentered is-multiline stories">
                                ...
                                <div class="columns is-gapless is-desktop">
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-3.php#">Beating job challenges for almost 5 years</a></h3>
                                        ...
                                        <div class="mcard-controls">
                                            ...
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-3.php#" class="color-primary">Melany Smith</a></span>
                                    ...
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-demo-background="assets/img/demo/photos/l1.jpg"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-demo-background="assets/img/demo/photos/l2.jpg"></div>
                                    </div>
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-3.php#">Bulkit HR recruiting changed my work habits</a></h3>
                                            <p class="mcard-description is-hidden-touch">Discover Terry's success story on Bulkit HR recruiting </p>
                                        </div>
                                        <div class="mcard-controls">
                                            <div class="mcard-avatar">
                                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/terry.jpg">
                                            </div>
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-3.php#" class="color-primary">Terry Daniels</a></span>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-3.php#">It helped me switch to full time freelance</a></h3>
                                        ...
                                        <div class="mcard-controls">
                                            ...
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-3.php#" class="color-primary">Sally Mitchells</a></span>
                                                <div><span>29 Aug</span> <i class="fa fa-circle"></i> <span>15m</span></div>
                                            </div>
                                            <div class="mcard-actions ml-auto">
                                                <span><i class="material-icons">bookmark_border</i> </span>
                                    ...
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-demo-background="assets/img/demo/photos/l3.jpg"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-demo-background="assets/img/demo/photos/l4.jpg"></div>
                                    </div>
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-3.php#">Got rid of time tracking problems.</a></h3>
                                            <p class="mcard-description is-hidden-touch">Discover Mark's success story on Bulkit HR recruiting </p>
                                        </div>
                                        <div class="mcard-controls">
                                            <div class="mcard-avatar">
                                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/marc.jpg">
                                            </div>
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-3.php#" class="color-primary">Mark Walters</a></span>
                                                <div><span>06 Oct</span> <i class="fa fa-circle"></i> <span>4m</span></div>
                                            </div>
                                            <div class="mcard-actions ml-auto">
                                                <span><i class="material-icons">bookmark_border</i> </span>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-3.php#">A big choice of big to small sized jobs</a></h3>
                                            <p class="mcard-description is-hidden-touch">Discover Fred's success story on Bulkit HR recruiting </p>
                                        </div>
                                        <div class="mcard-controls">
                                            <div class="mcard-avatar">
                                                <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/fred.jpg">
                                            </div>
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-3.php#" class="color-primary">Fred Gillings</a></span>
                                                <div><span>29 Aug</span> <i class="fa fa-circle"></i> <span>15m</span></div>
                                            </div>
                                            <div class="mcard-actions ml-auto">
                                                <span><i class="material-icons">bookmark_border</i> </span>
                                    ...
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-demo-background="assets/img/demo/photos/l5.jpg"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column is-6">
                            <div class="flex-card media-card media-card-right light-bordered light-raised no-margin-bottom">
                                <div class="columns is-gapless is-desktop">
                                    <div class="column is-4 media-stretch">
                                        <div class="media-card-image" data-background="https://via.placeholder.com/800x600" data-demo-background="assets/img/demo/photos/l6.jpg"></div>
                                    </div>
                                    <div class="column content-column">
                                        <div class="mcard-content">
                                            <h3 class="mcard-title"><a href="kit8-landing-3.php#">I earn a lot more working overall less time.</a></h3>
                                        ...
                                        <div class="mcard-controls">
                                            ...
                                            <div class="mcard-info">
                                                <span><a href="kit8-landing-3.php#" class="color-primary">Janet Biggs</a></span>
                                                <div><span>06 Oct</span> <i class="fa fa-circle"></i> <span>4m</span></div>
                                            </div>
                                            <div class="mcard-actions ml-auto">
                                                <span><i class="material-icons">bookmark_border</i> </span>
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit8-landing-3.php#">Home</a></li>
                                <li class="column-item"><a href="kit8-landing-3.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit8-landing-3.php#">Get started</a></li>
                                <li class="column-item"><a href="kit8-landing-3.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit8-landing-3.php#">Learning</a></li>
                                <li class="column-item"><a href="kit8-landing-3.php#">Support center</a></li>
                                <li class="column-item"><a href="kit8-landing-3.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit8-landing-3.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit8-landing-3.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit8-landing-3.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit8-landing-3.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit8-landing-3.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit8-landing-3.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit8-landing-3.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit8-landing-3.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit8-landing-3.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit8-landing-3.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit8-landing-3.php#"></a></div>
