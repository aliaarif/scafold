...
<body class="is-theme-core">
            ...
            <div class="container">
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-start">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="agency-about.php">
                            About
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="agency-portfolio.php">
                            Portfolio
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="agency-blog.php">
                            Blog
                        </a>
                    </div>
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item">
                            <a id="#signup-btn" href="agency-contact.php" class="button button-cta btn-outlined is-bold btn-align primary-btn rounded raised">
                                Contact
                            </a>
                        </div>
                    </div>
    ...
    <!-- Portfolio item -->
    <div class="section section-app-grey">
        <div class="container">
                    ...
                    <div class="single-image-carousel">
                        ...
                        <div class="carousel-item">
                            <div class="image-wrapper">
                                <img src="https://via.placeholder.com/800x800" alt="" data-demo-src="assets/img/demo/agency/ceramic-core.png" data-base-url="assets/img/demo/agency/ceramic" data-extension=".png">
                        ...
                        <div class="carousel-item">
                            <div class="image-wrapper">
                                <img src="https://via.placeholder.com/800x800" alt="" data-demo-src="assets/img/demo/agency/office-core.png" data-base-url="assets/img/demo/agency/office" data-extension=".png">
                                <div class="caption has-text-left">
                                    <span>Lorem ipsum dolor sit amet, vim brute malis vocibus ex, te mei magna persius. Duo nibh aliquam deleniti no.</span>
                                </div>
                            </div>
                        ...
                        <div class="carousel-item">
                            <div class="image-wrapper">
                                <img src="https://via.placeholder.com/800x800" alt="" data-demo-src="assets/img/demo/agency/tin-core.png" data-base-url="assets/img/demo/agency/tin" data-extension=".png">
                                <div class="caption has-text-left">
                                    <span>Lorem ipsum dolor sit amet, vim brute malis vocibus ex, te mei magna persius. Duo nibh aliquam
                                        deleniti no.</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="column">
                    <div class="portfolio-item">
                        ...
                        <div class="item-title">
                            <h1><b>A big project</b></h1>
                            <div class="title-divider"></div>
                        </div>
                        <!-- Description -->
                        <div class="project-description">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet.</p>
                            <p>Duis sagittis ipsum. Praesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum lacinia arcu eget nulla. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur sodales ligula in libero.</p>
                        </div>
                        <!-- Meta made for -->
                        <div class="made-for">
                            <div class="p-label"><b>Made for</b></div>
                            <img src="https://bulkit.cssninja.io/assets/img/logos/custom/infinite.svg" alt="">
                        </div>
                        <hr>
                        <!-- Meta details -->
                        ...
                        <label>Year</label>
                        <div class="project-date"><b>2018</b></div>
                        <!-- Meta share -->
                        <label>Share</label>
                        <div class="inline-list">
                            <div><i class="fa fa-social fa-facebook"></i></div>
                            <i class="inline-bullet fa fa-circle"></i>
                            <div><i class="fa fa-social fa-pinterest"></i></div>
                            <i class="inline-bullet fa fa-circle"></i>
                            <div><i class="fa fa-social fa-twitter"></i></div>
                            <i class="inline-bullet fa fa-circle"></i>
                            <div><i class="fa fa-social fa-behance"></i></div>
                        </div>
                        <!-- Navigation -->
                        <div class="navigation">
                            <a href="agency-portfolio.html#" class="button btn-outlined primary-btn raised rounded is-bold"> <i class="material-icons">arrow_back</i> Previous item</a>
                            <a href="agency-portfolio.html#" class="button btn-outlined primary-btn raised rounded is-bold">Next item <i class="material-icons is-right">arrow_forward</i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="columns">
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="agency-portfolio.html#">Discover features</a></li>
                            <li><a href="agency-portfolio.html#">CMS integration</a></li>
                            <li><a href="agency-portfolio.html#">Customers</a></li>
                            <li><a href="agency-portfolio.html#">Weekly sessions</a></li>
                            <li><a href="agency-portfolio.html#">Free trials and demo</a></li>
                            <li><a href="agency-portfolio.html#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="agency-portfolio.html#">About us</a></li>
                            <li><a href="agency-portfolio.html#">About security</a></li>
                            <li><a href="agency-portfolio.html#">User guide</a></li>
                            <li><a href="agency-portfolio.html#">Terms of service</a></li>
                            <li><a href="agency-portfolio.html#">Terms of website use</a></li>
                            <li><a href="agency-portfolio.html#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="agency-portfolio.html#">Resources</a></li>
                            <li><a href="agency-portfolio.html#">Blog</a></li>
                            <li><a href="agency-portfolio.html#">FAQ</a></li>
                            <li><a href="agency-portfolio.html#">API documentation</a></li>
                            <li><a href="agency-portfolio.html#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="agency-portfolio.html#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="agency-portfolio.html#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="agency-portfolio.html#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="agency-portfolio.html#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="agency-portfolio.html#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="agency-portfolio.html#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="agency-portfolio.html#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="agency-portfolio.html#"></a></div>
