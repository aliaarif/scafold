...
function changeV1Images() {
  $('*[data-v1-src]').each(function () {
    var newSrc = $(this).attr('data-v1-src');

    if (newSrc !== undefined) {
      $(this).attr('src', newSrc);
    }
  });
  $('*[data-v1-background]').each(function () {
    var newBg = $(this).attr('data-v1-background');
...
function initBulmaCalendar() {
  if ($('#calendar-v1').length) {
    bulmaCalendar.attach('#datepickerV1Default', {
      color: '#7F00FF',
      lang: 'en'
    });
    bulmaCalendar.attach('#datepickerV1Dialog', {
      displayMode: 'dialog',
    ...
    bulmaCalendar.attach('#datepickerV1Inline', {
      displayMode: 'inline',
      startDate: new Date('02/11/2018'),
      minDate: '01/01/2018',
      maxDate: '12/31/2018',
    ...
    bulmaCalendar.attach('#datepickerV1Range', {
      color: '#7F00FF',
      lang: 'en'
    });
    bulmaCalendar.attach('#timepickerV1Default', {
      color: '#7F00FF',
      lang: 'en'
    });
    bulmaCalendar.attach('#timepickerV1Range', {
      color: '#7F00FF',
      lang: 'en'
    });
    bulmaCalendar.attach('#timepickerV1Inline', {
      displayMode: 'inline',
      color: '#7F00FF',
      lang: 'en'
    });
    bulmaCalendar.attach('#datetimepickerV1Default', {
      color: '#7F00FF',
      lang: 'en'
    });
    bulmaCalendar.attach('#datetimepickerV1Dialog', {
      displayMode: 'dialog',
      startDate: new Date('02/11/2018'),
      minDate: '01/01/2018',
      maxDate: '12/31/2018',
    ...
    bulmaCalendar.attach('#datetimepickerV1Inline', {
      displayMode: 'inline',
      startDate: new Date('02/11/2018'),
      minDate: '01/01/2018',
      maxDate: '12/31/2018',
...
function initPlayers() {
  if ($('.bulkit-player').length) {
    if (env === 'development') {
      $('[data-v1-poster]').each(function () {
        var poster = $(this).attr('data-v1-poster');
...
function initV1() {
  ...
  if ($('.nav-switch').length) {
    $('#nav-solid').on('click', function () {
      $('#v1-nav').removeClass('navbar-inverse').addClass('is-solid');
      $('#v1-nav .button-cta').addClass('secondary-btn').removeClass('light-btn');
      $('#v1-nav .navbar-brand img').attr("src", "assets/img/logos/bulkit-purple.svg");
    });
    $('#nav-reverse').on('click', function () {
      $('#v1-nav').addClass('navbar-inverse is-reverse').removeClass('is-solid is-blue is-purple is-red');
    });
    $('#nav-blue').on('click', function () {
      $('#v1-nav').addClass('navbar-inverse is-blue').removeClass('is-solid is-reverse is-purple is-red');
    });
    $('#nav-purple').on('click', function () {
      $('#v1-nav').addClass('navbar-inverse is-purple').removeClass('is-solid is-reverse is-blue is-red');
    });
    $('#nav-red').on('click', function () {
      $('#v1-nav').addClass('navbar-inverse is-red').removeClass('is-solid is-reverse is-blue is-purple');
    });
    $('.is-variation').on('click', function () {
      $('#v1-nav .button-cta').addClass('light-btn').removeClass('secondary-btn');
      $('#v1-nav .navbar-brand img').attr("src", "assets/img/logos/bulkit-white.svg");
    });
  }
}
/* ==========================================================================
