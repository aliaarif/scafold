...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-layout-colors.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-layout-colors.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-layout-colors.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-layout-colors.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-layout-colors.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <h2 class="subtitle is-4 components-subtitle">
                            Colors used in Bulkit.
                        </h2>
                        <p class="components-cta">
                            <a href="_components-layout-colors.php#start" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="colors-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="section-title-wrapper">
                ...
                <h3 class="subtitle has-text-centered is-4 pt-10">
                    Colors available globaly
                </h3>
            </div>
            <!-- /Title -->
            <div id="start" class="columns is-multiline pb-60">
                <!-- Color card -->
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-white"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#fff</span></div>
                                    <div class="variable-value"><span>$white</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-smoke-white"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#fcfcfc</span></div>
                                    <div class="variable-value"><span>$smoke-white</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-grey-white"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#f2f2f2</span></div>
                                    <div class="variable-value"><span>$grey-white</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-grey-white-accent"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#e2e2e2</span></div>
                                    <div class="variable-value"><span>$grey-white-accent</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-light-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#EFF4F7</span></div>
                                    <div class="variable-value"><span>$light-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-ultra-light-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#f7fcff</span></div>
                                    <div class="variable-value"><span>$ultra-light-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-title-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#A9ABAC</span></div>
                                    <div class="variable-value"><span>$title-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-blue-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#444F60</span></div>
                                    <div class="variable-value"><span>$blue-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-light-blue-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#98a9c3</span></div>
                                    <div class="variable-value"><span>$light-blue-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-medium-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#66676b</span></div>
                                    <div class="variable-value"><span>$medium-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-basaltic-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#878787</span></div>
                                    <div class="variable-value"><span>$basaltic-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-muted-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#999</span></div>
                                    <div class="variable-value"><span>$muted-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-section-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#fbfbfb</span></div>
                                    <div class="variable-value"><span>$section-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-section-grey-accent"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#efefef</span></div>
                                    <div class="variable-value"><span>$section-grey-accent</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-header-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#f5f9fc</span></div>
                                    <div class="variable-value"><span>$header-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-default-input"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#ccc</span></div>
                                    <div class="variable-value"><span>$default-input</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-placeholder"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#cecece</span></div>
                                    <div class="variable-value"><span>$placeholder</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-fade-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#ededed</span></div>
                                    <div class="variable-value"><span>$fade-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-coal"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>##444</span></div>
                                    <div class="variable-value"><span>$coal</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-sidebar"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#344258</span></div>
                                    <div class="variable-value"><span>$sidebar</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-grey-3"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#333</span></div>
                                    <div class="variable-value"><span>$grey-3</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-grey-5"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#555</span></div>
                                    <div class="variable-value"><span>$grey-5</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-grey-6"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#666</span></div>
                                    <div class="variable-value"><span>$grey-6</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-cream-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#f6f4ff</span></div>
                                    <div class="variable-value"><span>$cream-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-icon-grey"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#818a97</span></div>
                                    <div class="variable-value"><span>$icon-grey</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-blue"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#039be5</span></div>
                                    <div class="variable-value"><span>$blue</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-green"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#00b289</span></div>
                                    <div class="variable-value"><span>$green</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-orange"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#eda514</span></div>
                                    <div class="variable-value"><span>$orange</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-red"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#ff7273</span></div>
                                    <div class="variable-value"><span>$red</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="section section-feature-grey">
        <div class="container">
            ...
            <!-- /Title -->
            <div class="columns is-multiline pb-60">
                <!-- Color card -->
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-facebook"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#3b5998</span></div>
                                    <div class="variable-value"><span>$facebook</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-twitter"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#1dcaff</span></div>
                                    <div class="variable-value"><span>$twitter</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-linkedin"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#007bb6</span></div>
                                    <div class="variable-value"><span>$linkedin</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-tumblr"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#35465c</span></div>
                                    <div class="variable-value"><span>$tumblr</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-github"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#444</span></div>
                                    <div class="variable-value"><span>$github</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-dribbble"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#ea4c89</span></div>
                                    <div class="variable-value"><span>$dribbble</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-google-plus"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#d34836</span></div>
                                    <div class="variable-value"><span>$google-plus</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-youtube"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#cc181e</span></div>
                                    <div class="variable-value"><span>$youtube</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-reddit"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#ff4500</span></div>
                                    <div class="variable-value"><span>$reddit</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="columns is-multiline pb-60">
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-primary"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#4FC1EA</span></div>
                                    <div class="variable-value"><span>$primary</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-secondary"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#673ab7</span></div>
                                    <div class="variable-value"><span>$secondary</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-accent"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#7F00FF</span></div>
                                    <div class="variable-value"><span>$accent</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="columns is-multiline pb-60">
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-green-accent"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#06f4b6</span></div>
                                    <div class="variable-value"><span>$accent</span></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="columns is-multiline pb-60">
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-deep-primary"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#0082c8</span></div>
                                    <div class="variable-value"><span>$primary</span></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-deep-secondary"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#7c4dff</span></div>
                                    <div class="variable-value"><span>$secondary</span></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-deep-accent"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#00b289</span></div>
                                    <div class="variable-value"><span>$accent</span></div>
                                </div>
            ...
            <div class="columns is-multiline pb-60">
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-lemonade-primary"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#039BE5</span></div>
                                    <div class="variable-value"><span>$primary</span></div>
                                </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-lemonade-secondary"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#0084c4</span></div>
                                    <div class="variable-value"><span>$secondary</span></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="column is-3">
                    <div class="flex-card color-card light-bordered hover-inset">
                        <div class="card-body">
                            <div class="color-item">
                                <div class="color-spot is-lemonade-accent"></div>
                                <div class="color-values">
                                    <div class="hex-value">Hex: <span>#00D1B2</span></div>
                                    <div class="variable-value"><span>$accent</span></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="features.php">Discover features</a></li>
                            <li><a href="features.php">CMS integration</a></li>
                            <li><a href="_components-layout-colors.php#">Customers</a></li>
                            <li><a href="_components-layout-colors.php#">Weekly sessions</a></li>
                            <li><a href="_components-layout-colors.php#">Free trials and demo</a></li>
                            <li><a href="_components-layout-colors.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-layout-colors.php#">About us</a></li>
                            <li><a href="_components-layout-colors.php#">About security</a></li>
                            <li><a href="_components-layout-colors.php#">User guide</a></li>
                            <li><a href="_components-layout-colors.php#">Terms of service</a></li>
                            <li><a href="_components-layout-colors.php#">Terms of website use</a></li>
                            <li><a href="_components-layout-colors.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-layout-colors.php#">Blog</a></li>
                            <li><a href="_components-layout-colors.php#">FAQ</a></li>
                            <li><a href="_components-layout-colors.php#">API documentation</a></li>
                            <li><a href="_components-layout-colors.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-layout-colors.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-layout-colors.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-colors.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-colors.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-layout-colors.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-layout-colors.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-layout-colors.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-layout-colors.php#"></a></div> <!-- Concatenated jQuery and plugins -->
