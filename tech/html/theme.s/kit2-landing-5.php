...
<body class="is-theme-core">
    ...
    <div class="hero product-hero is-app-grey has-shape-layer-1">
            ...
            <div class="container">
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-start">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit2-features.php">
                            Features
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit2-pricing.php">
                            Pricing
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide" href="kit2-login.php">
                            Login
                        </a>
                    </div>
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item">
                            <a id="#signup-btn" href="kit2-signup.php" class="button button-cta btn-outlined is-bold btn-align primary-btn raised">
                                Free Trial
                            </a>
                        </div>
                    </div>
        ...
        <!--Shape Layer-->
        <img class="shape-layer" src="assets/img/graphics/legacy/wavy-3-core.svg" alt="" data-base-url="assets/img/graphics/legacy/wavy-3" data-extension=".svg">
                        ...
                        <div class="columns is-vcentered has-text-centered is-multiline">
                            ...
                            <div class="column is-6">
                                <div class="flex-card icon-card hover-inset">
                                    <img src="assets/img/graphics/icons/invoice-core.svg" data-base-url="assets/img/graphics/icons/invoice" data-extension=".svg" alt="">
                            ...
                            <div class="column is-6">
                                <div class="flex-card icon-card hover-inset">
                                    <img src="assets/img/graphics/icons/gateway-core.svg" data-base-url="assets/img/graphics/icons/gateway" data-extension=".svg" alt="">
                                    <div class="icon-card-text is-clean">
                                        Payment gateway
                                    </div>
                                </div>
                            ...
                            <div class="column is-6">
                                <div class="flex-card icon-card hover-inset">
                                    <img src="assets/img/graphics/icons/records-core.svg" data-base-url="assets/img/graphics/icons/records" data-extension=".svg" alt="">
                                    <div class="icon-card-text is-clean">
                                        Customer records
                                    </div>
                                </div>
                            ...
                            <div class="column is-6">
                                <div class="flex-card icon-card hover-inset">
                                    <img src="assets/img/graphics/icons/sync-core.svg" data-base-url="assets/img/graphics/icons/sync" data-extension=".svg" alt="">
                                    <div class="icon-card-text is-clean">
                                        Cloud Sync
                                    </div>
                                </div>
                    ...
                    <div class="column is-5">
                        <div class="side-feature-text">
                            ...
                            <div class="button-wrap">
                                <a href="kit2-signup.php" class="button button-cta btn-align raised primary-btn">
                                    Try it free
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="navigation-tabs outlined-pills animated-tabs">
                            ...
                            <div id="new-deals" class="navtab-content is-active">
                                <div class="columns is-vcentered">
                                    <div class="column is-6">
                                        <figure class="image">
                                            <img class="has-light-shadow" src="assets/img/graphics/apps/app-2-core.png" data-base-url="assets/img/graphics/apps/app-2" data-extension=".png" alt="">
                                        </figure>
                                    </div>
                                    <div class="column is-6">
                                        <div class="inner-content">
                                            ...
                                            <div class="button-wrap">
                                                <a href="kit2-features.php" class="button btn-align btn-more is-link color-primary">
                            ...
                            <div id="invoices" class="navtab-content">
                                <div class="columns is-vcentered">
                                    <div class="column is-6">
                                        <figure class="image">
                                            <img class="has-light-shadow" src="assets/img/graphics/apps/app-1-core.png" data-base-url="assets/img/graphics/apps/app-1" data-extension=".png" alt="">
                                        </figure>
                                    </div>
                                    <div class="column is-6">
                                        <div class="inner-content">
                                ...
                                <div class="columns is-vcentered">
                                    ...
                                    <div class="column is-6">
                                        <div class="inner-content">
                                            ...
                                            <div class="button-wrap">
                                                <a href="kit2-signup.php" class="button btn-align btn-more is-link color-primary">
            ...
            <div class="columns is-vcentered">
                ...
                <div class="column is-5 ">
                    <div class="side-feature-text">
                        ...
                        <div class="button-wrap">
                            <a href="kit2-signup.php" class="button button-cta light-btn btn-outlined is-bold">
                                Get started
                            </a>
                        </div>
                    </div>
            ...
            <div class="columns is-vcentered">
                    ...
                    <div>
                        ...
                        <nav class="level is-mobile mt-20">
                            <div class="level-left level-social">
                                <a href="kit2-landing-5.php#" class="level-item">
                ...
                <div class="column">
                    <div class="footer-nav-right">
                        <a class="footer-nav-link" href="kit2-landing-5.php#">Home</a>
                        <a class="footer-nav-link" href="kit2-landing-5.php#">Features</a>
                        <a class="footer-nav-link" href="kit2-landing-5.php#">Pricing</a>
                        <a class="footer-nav-link" href="kit2-landing-5.php#">Sign in</a>
                        <a class="footer-nav-link" href="kit2-landing-5.php#">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit2-landing-5.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit2-landing-5.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit2-landing-5.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit2-landing-5.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit2-landing-5.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit2-landing-5.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit2-landing-5.php#"></a></div>
