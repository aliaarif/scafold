...
<head>
    ...
    <title> Bulkit :: Testimonials</title>
...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-sections-testimonials.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-sections-testimonials.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-sections-testimonials.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-sections-testimonials.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-sections-testimonials.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <h2 class="subtitle is-4 components-subtitle">
                            Available testimonials variations.
                        </h2>
                        <p class="components-cta">
                            <a href="_components-sections-testimonials.php#card-testimonials" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="testimonials-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Static Testimonials -->
    <div id="card-testimonials" class="section is-medium is-relative is-medium">
        <div class="container">
                        ...
                        <div class="columns is-vcentered">
                            <div class="column is-6">
                                ...
                                <div class="flex-card testimonial-card light-raised padding-20">
                                    ...
                                    <div class="user-id">
                                        <img class="" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/jane.jpg">
                                        <div class="info">
                            ...
                            <div class="column is-6">
                                ...
                                <div class="flex-card testimonial-card light-raised padding-20">
                                    ...
                                    <div class="user-id">
                                        <img class="" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/helen.jpg">
                                        <div class="info">
                        ...
                        <div class="flat-testimonials">
                                ...
                                <div class="columns is-vcentered">
                                    <div class="column is-7">
                                        <div class="image-container">
                                            <img src="https://via.placeholder.com/700x467" alt="" data-demo-src="assets/img/demo/adam_bradley.jpg">
                                    ...
                                    <div class="column is-5">
                                        <div class="testimonial-text">
                                            ...
                                            <img class="company" src="assets/img/logos/custom/tribe.svg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flat-testimonial-item accent">
                                <div class="columns is-vcentered">
                                    <div class="column is-7">
                                        <div class="image-container">
                                            <img src="https://via.placeholder.com/700x467" alt="" data-demo-src="assets/img/demo/evelyne_dwyers.jpg">
                                            <div class="skewed-overlay"></div>
                                        </div>
                                    </div>
                                    <div class="column is-5">
                                        <div class="testimonial-text">
                                            ...
                                            <img class="company" src="assets/img/logos/custom/covenant.svg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flat-testimonial-item accent">
                                <div class="columns is-vcentered">
                                    <div class="column is-7">
                                        <div class="image-container">
                                            <img src="https://via.placeholder.com/700x467" alt="" data-demo-src="assets/img/demo/joel_zimmerman.jpg">
                                            <div class="skewed-overlay"></div>
                                        </div>
                                    </div>
                                    <div class="column is-5">
                                        <div class="testimonial-text">
                                            ...
                                            <img class="company" src="https://bulkit.cssninja.io/assets/img/logos/custom/gutwork.svg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="column is-6">
                        ...
                        <div class="testimonials">
                            ...
                            <div class="testimonial-item">
                                <div class="flex-card card-overflow raised mb-40">
                                    ...
                                    <div class="testimonial-content">
                                        <p>Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum inermis iudicabit. Ex vidit fierent hendrerit eum, sed stet periculis ut. Vis in probo decore labitur. Unum simul an vis, tale patrioque eos ad, dicunt percipit ea nam. Vis dolor quidam assentior te, atomorum posidonium qui an.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="testimonial-item">
                                <div class="flex-card card-overflow raised mb-40">
                                    <div class="testimonial-avatar">
                                        <img src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/marge.jpg">
                                    </div>
                                    <div class="testimonial-name">
                        ...
                        <div class="vertical-testimonials">
                            ...
                            <div class="flex-card vtestimonial-item light-bordered padding-20">
                                <div class="content content-flex">
                                    <img class="vt-avatar is-hidden-mobile" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/carolin.png">
                            ...
                            <div class="flex-card vtestimonial-item light-bordered padding-20">
                                <div class="content content-flex">
                                    <img class="vt-avatar is-hidden-mobile" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/terry.jpg">
                                    <div class="vt-content">
                                        <div class="star-rating color-secondary is-hidden-mobile">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="flex-card vtestimonial-item light-bordered padding-20">
                                <div class="content content-flex">
                                    <img class="vt-avatar is-hidden-mobile" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/helen.jpg">
                                    <div class="vt-content">
                                        <div class="star-rating color-secondary is-hidden-mobile">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="flex-card vtestimonial-item light-bordered padding-20">
                                <div class="content content-flex">
                                    <img class="vt-avatar is-hidden-mobile" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/kareem.jpg">
                                    <div class="vt-content">
                                        <div class="star-rating color-secondary is-hidden-mobile">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                        ...
                                        <div class="vt-text">
                                            Lorem ipsum dolor sit amet, ex vis laoreet perfecto insolens. Pericula repudiandae vel no, ne sonet viderer vis. Iisque forensibus ex per, at vide natum dissentias pro.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex-card vtestimonial-item light-bordered padding-20">
                                <div class="content content-flex">
                                    <img class="vt-avatar is-hidden-mobile" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/jeffrey.jpg">
                                    <div class="vt-content">
                                        <div class="star-rating color-secondary is-hidden-mobile">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                        ...
                                        <div class="vt-text">
                                            Lorem ipsum dolor sit amet, ex vis laoreet perfecto insolens. Pericula repudiandae vel no, ne sonet viderer vis. Iisque forensibus ex per, at vide natum dissentias pro, vivendo explicari deterruisset ea mel.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex-card vtestimonial-item light-bordered padding-20">
                                <div class="content content-flex">
                                    <img class="vt-avatar is-hidden-mobile" src="https://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/sally.jpg">
                                    <div class="vt-content">
                                        <div class="star-rating color-secondary is-hidden-mobile">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                        ...
                                        <div class="vt-text">
                                            Lorem ipsum dolor sit amet, ex vis laoreet perfecto insolens. Pericula repudiandae vel no, ne sonet viderer vis. Iisque forensibus ex per, at vide natum dissentias.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-testimonials.php#">Customers</a></li>
                            <li><a href="_components-sections-testimonials.php#">Weekly sessions</a></li>
                            <li><a href="_components-sections-testimonials.php#">Free trials and demo</a></li>
                            <li><a href="_components-sections-testimonials.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-sections-testimonials.php#">About us</a></li>
                            <li><a href="_components-sections-testimonials.php#">About security</a></li>
                            <li><a href="_components-sections-testimonials.php#">User guide</a></li>
                            <li><a href="_components-sections-testimonials.php#">Terms of service</a></li>
                            <li><a href="_components-sections-testimonials.php#">Terms of website use</a></li>
                            <li><a href="_components-sections-testimonials.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-testimonials.php#">Blog</a></li>
                            <li><a href="_components-sections-testimonials.php#">FAQ</a></li>
                            <li><a href="_components-sections-testimonials.php#">API documentation</a></li>
                            <li><a href="_components-sections-testimonials.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-sections-testimonials.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-sections-testimonials.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-testimonials.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-testimonials.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-testimonials.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-sections-testimonials.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-testimonials.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-sections-testimonials.php#"></a></div> <!-- Concatenated jQuery and plugins -->
