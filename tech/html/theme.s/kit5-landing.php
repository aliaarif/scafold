...
<body class="is-theme-core">
            ...
            <div class="container">
                ...
                <div id="is-cloned" class="navbar-menu">
                    ...
                    <div class="navbar-start">
                                    ...
                                    <div class="container">
                                        <div class="columns">
                                            <div class="column">
                                                ...
                                                <a class="navbar-item is-flex" href="kit5-features.php">
                                                    <i class="im im-icon-Sidebar-Window"></i>
                                                    <div class="navbar-content">
                                                        <p>
                                                            <small class="color-primary">Boards</small>
                                                        </p>
                                                        <p>Kanban Board</p>
                                                    </div>
                                                </a>
                                                <a class="navbar-item is-flex" href="kit5-features.php">
                                                    ...
                                                    <div class="navbar-content">
                                                        <p>
                                                            <small class="color-primary">Productivity</small>
                                                        </p>
                                                        <p>Time Tracking</p>
                                                    </div>
                                                </a>
                                                <a class="navbar-item is-flex" href="kit5-features.php">
                                                    ...
                                                    <div class="navbar-content">
                                                        <p>
                                                            <small class="color-primary">Security</small>
                                                        </p>
                                                        <p>Access Rights</p>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="column">
                                                ...
                                                <a class="navbar-item is-flex" href="kit5-features.php">
                                                    ...
                                                    <div class="navbar-content">
                                                        <p>
                                                            <small class="color-primary">Reporting</small>
                                                        </p>
                                                        <p>Custom Reports</p>
                                                    </div>
                                                </a>
                                                <a class="navbar-item is-flex" href="kit5-features.php">
                                                    ...
                                                    <div class="navbar-content">
                                                        <p>
                                                            <small class="color-primary">Transactions</small>
                                                        </p>
                                            ...
                                            <div class="column">
                                                ...
                                                <a class="navbar-item is-flex" href="kit5-features.php">
                                                    ...
                                                    <div class="navbar-content">
                                                        <p>
                                                            <small class="color-primary">Records Management</small>
                                                        </p>
                                                        <p>File Plan</p>
                                                    </div>
                                                </a>
                                                <a class="navbar-item is-flex" href="kit5-features.php">
                                                    ...
                                                    <div class="navbar-content">
                                                        <p>
                                                            <small class="color-primary">Emails</small>
                                                        </p>
                                            ...
                                            <div class="column">
                                                ...
                                                <p class="is-cta">
                                                    <a href="kit5-features.php" class="button btn-align mega-btn primary-btn">Learn more</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="kit5-landing.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="kit5-landing.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="kit5-landing.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="kit5-landing.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="kit5-landing.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <a class="navbar-item is-slide is-centered-tablet is-hidden-desktop is-hidden-tablet" href="kit5-features.php">
                            Product
                        </a>
                    ...
                    <div class="navbar-end">
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide is-centered-tablet" href="kit5-pricing.php">
                            Pricing
                        </a>
                        <!-- Navbar item -->
                        <a class="navbar-item is-slide is-centered-tablet" href="kit5-login.php">
                            Login
                        </a>
                        <!-- Signup button -->
                        <div class="navbar-item is-button is-centered-tablet">
                            <a id="#signup-btn" href="kit5-login.php" class="button button-cta is-bold btn-align primary-btn raised">
                                Sign up
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div id="is-static" class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        ...
                        <!-- Signup button -->
                        <div class="navbar-item is-button is-centered-tablet">
                            <a id="#signup-btn-double" href="kit5-login.php" class="button button-cta is-bold btn-align primary-btn raised">
                                Sign up
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="columns is-vcentered">
                    <div class="column is-6">
                        <figure class="">
                            <img src="assets/img/graphics/drawings/drawing-2-core.svg" data-base-url="assets/img/graphics/drawings/drawing-2" data-extension=".svg" alt="">
                        </figure>
                    </div>
                    <div class="column is-5 is-offset-1">
                        ...
                        <p class="">
                            <a href="kit5-landing.php#" class="button button-cta is-bold btn-align primary-btn raised">
                                Get Started
                            </a>
                        </p>
                    </div>
            ...
            <div class="container">
                <div class="tabs partner-tabs is-centered">
                    <ul>
                        ...
                        <li><a><img class="partner-logo" src="https://bulkit.cssninja.io/assets/img/logos/custom/infinite.svg" alt=""></a></li>
    ...
    <!-- Features Section -->
    <div class="section is-medium has-pseudo-lines gradient-circle no-line-top">
        <div class="container">
            <!-- Title -->
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-6">
                        <img class="featured-ui" src="assets/img/graphics/legacy/collaboration-sidebar.png" alt="">
                    </div>
                </div>

                <!-- CTA -->
                <div class="cta-wrapper has-text-centered is-title-reveal pt-60 pb-60">
                    <a href="kit5-login.php" class="button button-cta is-bold btn-align primary-btn raised">
                        Try it free
                    </a>
                </div>
            </div>
                ...
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-5">
                        ...
                        <div id="feature-1" class="showcase-text-wrapper animated preFadeInUp fadeInUp">
                            ...
                            <a href="kit5-landing.php#" class="button button-cta is-bold btn-align primary-btn raised mt-20 mb-20">
                                Learn more
                            </a>
                        </div>
                        <!-- Feature -->
                        ...
                        <div id="feature-3" class="showcase-text-wrapper animated preFadeInUp fadeInUp is-hidden">
                            ...
                            <a href="kit5-login.php" class="button button-cta is-bold btn-align primary-btn raised mt-20 mb-20">
                                Free Trial
                            </a>
                        </div>
                    </div>
    ...
    <div class="section is-medium has-pseudo-lines">
        <div class="container">

            <!-- Feature -->
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-svg" src="assets/img/graphics/drawings/drawing-1-core.svg" data-base-url="assets/img/graphics/drawings/drawing-1" data-extension=".svg" alt="">
                </div>
                ...
                <div class="column is-5">
                    ...
                    <div class="pt-10 pb-10">
                        <a href="kit5-landing.php#" class="button btn-align btn-more is-link color-primary">
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered is-hidden-tablet is-hidden-desktop">
                    <img class="featured-svg" src="assets/img/graphics/drawings/drawing-3-core.svg" data-base-url="assets/img/graphics/drawings/drawing-3" data-extension=".svg" alt="">
                </div>
            ...
            <div class="columns is-vcentered">
                <div class="column is-7 has-text-centered">
                    <img class="featured-svg" src="assets/img/graphics/drawings/drawing-4-core.svg" data-base-url="assets/img/graphics/drawings/drawing-4" data-extension=".svg" alt="">
                </div>
            ...
            <h2 class="has-text-centered">
                <a href="kit5-features.php" class="button button-cta is-bold btn-align primary-btn raised">
                    See all Features
                </a>
            </h2>
    ...
    <!-- Team Section -->
    <div class="section section-feature-grey is-medium has-background-image is-contain has-pseudo-lines" data-background="assets/img/graphics/legacy/circles-and-shapes-w.png">
        <div class="container">
            <!-- Title -->
            <div class="section-title-wrapper has-text-centered">
                <!-- Divider -->
            ...
            <div class="content-wrapper">
                <div class="columns">
                    ...
                    <div class="column is-3">
                        <div class="hero-box has-text-centered">
                            <img src="assets/img/graphics/icons/hero-1-core.svg" data-base-url="assets/img/graphics/icons/hero-1" data-extension=".svg" alt="">
                            <div class="name">Alex Kriczek</div>
                            <div class="position">CEO | Founder</div>
                            <p>Alex is passionate about his work. He is also a serial entrepreneur and has many projects
                                behind him</p>
                            <div class="social">
                                <a href="kit5-landing.php#"><i class="fa fa-twitter"></i></a>
                                <a href="kit5-landing.php#"><i class="fa fa-linkedin"></i></a>
                                <a href="kit5-landing.php#"><i class="fa fa-github"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- Team member -->
                    <div class="column is-3">
                        <div class="hero-box has-text-centered">
                            <img src="assets/img/graphics/icons/hero-2-core.svg" data-base-url="assets/img/graphics/icons/hero-2" data-extension=".svg" alt="">
                    ...
                    <div class="column is-3">
                        <div class="hero-box has-text-centered">
                            <img src="assets/img/graphics/icons/hero-3-core.svg" data-base-url="assets/img/graphics/icons/hero-3" data-extension=".svg" alt="">
                ...
                <div class="columns">
                    ...
                    <div class="column is-3">
                        <div class="hero-box has-text-centered">
                            <img src="assets/img/graphics/icons/hero-4-core.svg" data-base-url="assets/img/graphics/icons/hero-4" data-extension=".svg" alt="">
                    ...
                    <div class="column is-3">
                        <div class="hero-box has-text-centered">
                            <img src="assets/img/graphics/icons/hero-5-core.svg" data-base-url="assets/img/graphics/icons/hero-5" data-extension=".svg" alt="">
                    ...
                    <div class="column is-3">
                        <div class="hero-box has-text-centered">
                            <img src="assets/img/graphics/icons/hero-6-core.svg" data-base-url="assets/img/graphics/icons/hero-6" data-extension=".svg" alt="">
    ...
    <!-- Clients Section -->
    <div class="section is-medium no-line-bottom has-animated-waves waves-bottom waves-primary has-pseudo-lines">
            ...
            <div class="content-wrapper huge-pb">
                ...
                <div class="grid-clients three-grid">
                    <div class="columns is-vcentered">
                        ...
                        <!-- Client -->
                        <div class="column">
                            <a><img class="client" src="assets/img/logos/custom/phasekit-dark.svg" alt=""></a>
                        </div>
                        <!-- Client -->
                        <div class="column">
                            <a><img class="client" src="assets/img/logos/custom/proactive-dark.svg" alt=""></a>
                        </div>
                        <!-- Client -->
                        <div class="column">
                            <a><img class="client" src="assets/img/logos/custom/grubspot-dark.svg" alt=""></a>
                        </div>
                        <div class="column"></div>
                    </div>
                    <div class="columns is-vcentered is-separator">
                        ...
                        <!-- Client -->
                        <div class="column">
                            <a><img class="client" src="assets/img/logos/custom/tribe-dark.svg" alt=""></a>
                        </div>
                        <!-- Client -->
                        <div class="column">
                            <a><img class="client" src="assets/img/logos/custom/kromo-dark.svg" alt=""></a>
                        </div>
                        <!-- Client -->
                        <div class="column">
                            <a><img class="client" src="assets/img/logos/custom/covenant-dark.svg" alt=""></a>
                        </div>
                        <div class="column"></div>
                    </div>
                    <div class="columns is-vcentered is-separator">
                        ...
                        <!-- Client -->
                        <div class="column">
                            <a><img class="client" src="assets/img/logos/custom/bitbreaker-dark.svg" alt=""></a>
                        </div>
                        <!-- Client -->
                        <div class="column">
                            <a><img class="client" src="assets/img/logos/custom/infinite-dark.svg" alt=""></a>
                        </div>
                        <!-- Client -->
                        <div class="column">
                            <a><img class="client" src="assets/img/logos/custom/livetalk-dark.svg" alt=""></a>
                        </div>
                        <div class="column"></div>
                    </div>
                </div>
    ...
    <div class="section section-primary is-medium has-background-image is-contain has-pseudo-lines" data-background="assets/img/graphics/legacy/circles-and-shapes-w.png">
                    ...
                    <div class="testimonials-wrapper styled-testimonials">
                        ...
                        <div class="testimonial">
                            <blockquote class="testimonial-quote">
                                ...
                                <p class="testimonial-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa
                                    fugit hic modi nisi blanditiis, possimus asperiores sint iusto dignissimos odio
                                    consequuntur, cumque nobis dicta rerum quisquam non placeat accusantium laborum!</p>
                                <footer class="testimonial-meta">
                                    <img class="testimonial-img" src="http://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/elie.jpg">
                                </footer>
                            </blockquote>
                        </div>
                        <!-- Testimonial item -->
                        <div class="testimonial">
                            <blockquote class="testimonial-quote">
                                ...
                                <p class="testimonial-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa
                                    ...
                                    consequuntur, cumque nobis dicta rerum quisquam non placeat accusantium laborum!</p>
                                <footer class="testimonial-meta">
                                    <img class="testimonial-img" src="http://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/thomas.jpg">
                                </footer>
                            </blockquote>
                        </div>
                        <!-- Testimonial item -->
                        <div class="testimonial">
                            <blockquote class="testimonial-quote">
                                ...
                                <p class="testimonial-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa
                                    ...
                                    consequuntur, cumque nobis dicta rerum quisquam non placeat accusantium laborum!</p>
                                <footer class="testimonial-meta">
                                    <img class="testimonial-img" src="http://via.placeholder.com/250x250" alt="" data-demo-src="assets/img/avatars/sally.jpg">
                                </footer>
                            </blockquote>
                        </div>
                    </div>
    ...
    <!-- Contact Section -->
    <div class="section is-medium section-feature-grey has-pseudo-lines">
        <div class="container">
            <!-- Title -->
            <div class="section-title-wrapper has-text-centered">
                <!-- Divider -->
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit5-landing.php#">Home</a></li>
                                <li class="column-item"><a href="kit5-landing.php#">Pricing</a></li>
                                <li class="column-item"><a href="kit5-landing.php#">Get started</a></li>
                                <li class="column-item"><a href="kit5-landing.php#">Help</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit5-landing.php#">Learning</a></li>
                                <li class="column-item"><a href="kit5-landing.php#">Support center</a></li>
                                <li class="column-item"><a href="kit5-landing.php#">Frequent questions</a></li>
                                <li class="column-item"><a href="kit5-landing.php#">Schedule a demo</a></li>
                            </ul>
                        </div>
                        <!-- Column -->
                        <div class="column">
                            <ul class="footer-column">
                                ...
                                <li class="column-item"><a href="kit5-landing.php#">Terms of Service</a></li>
                                <li class="column-item"><a href="kit5-landing.php#">Privacy policy</a></li>
                                <li class="column-item"><a href="kit5-landing.php#">SaaS services</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit5-landing.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit5-landing.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit5-landing.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit5-landing.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit5-landing.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit5-landing.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit5-landing.php#"></a></div>
