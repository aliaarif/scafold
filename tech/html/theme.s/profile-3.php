...
<head>
    ...
    <title> Bulkit :: Profile Network</title>
...
<body>
    ...
    <nav class="navbar navbar-wrapper navbar-default navbar-fade is-fixed-top is-transparent">
        <div class="container">
            ...
            <div class="navbar-brand">
                ...
                <!-- /Responsive toggle -->
                <!-- Account button -->
                <div class="navbar-item mobile-account">
                    <div class="dropdown account-dropdown is-right">
                        <div class="dropdown-trigger">
                            <button class="button" aria-haspopup="true" aria-controls="dropdown-menu6">
                                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/helen.jpg" />
                            </button>
                        </div>
                        <div class="dropdown-menu" id="dropdown-menu6" role="menu">
                            <div class="dropdown-content">
                                <a href="profile-3.php#" class="dropdown-item">
            ...
            <div class="navbar-menu">
                ...
                <div class="navbar-start">
                    <!-- Navbar item -->
                    <a class="navbar-item is-slide" href="profile-3.php#"> Product </a>
                    <!-- Navbar item -->
                    <a class="navbar-item is-slide" href="profile-3.php#"> Pricing </a>
                    <!-- Navbar item -->
                    <a class="navbar-item is-slide" href="profile-3.php#"> About </a>
                </div>
    ...
    <div class="profile-header">
        <div class="profile-header-inner">
            <div class="profile-avatar">
                <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/helen.jpg" />
                <h2 class="title is-4 is-narrow">Helen Miller</h2>
                <p class="subtitle is-6">UI/UX Designer</p>
            </div>

            <div class="tabs is-centered">
                <ul>
                    <li><a href="profile-1.php">Overview</a></li>
                    <li><a href="profile-2.php">Projects</a></li>
                    <li class="is-active"><a href="profile-3.php">Network</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="network-grid">
                    <div class="columns is-multiline">
                        ...
                        <div class="column is-4">
                            <div class="network-card">
                                <div class="network-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/alan.jpg" />
                                </div>
                                <h3 class="title is-6 is-narrow">Alan Maynard</h3>
                                <p class="subtitle is-size-7">Sales Manager</p>
                                <div class="network-stats">
                                    <div class="network-stat">
                                        <span>114</span>
                                        <span>Followers</span>
                        ...
                        <div class="column is-4">
                            <div class="network-card">
                                <div class="network-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/betty.jpg" />
                                </div>
                                <h3 class="title is-6 is-narrow">Betty Lopez</h3>
                                <p class="subtitle is-size-7">Project Manager</p>
                                <div class="network-stats">
                                    <div class="network-stat">
                                        <span>189</span>
                                        <span>Followers</span>
                        ...
                        <div class="column is-4">
                            <div class="network-card">
                                <div class="network-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/janet.jpg" />
                                </div>
                                <h3 class="title is-6 is-narrow">Janet Briggs</h3>
                                <p class="subtitle is-size-7">Product Manager</p>
                                <div class="network-stats">
                                    <div class="network-stat">
                                        <span>329</span>
                                        <span>Followers</span>
                        ...
                        <div class="column is-4">
                            <div class="network-card">
                                <div class="network-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/marc.jpg" />
                                </div>
                                <h3 class="title is-6 is-narrow">Mark Wallace</h3>
                                <p class="subtitle is-size-7">Project Manager</p>
                                <div class="network-stats">
                                    <div class="network-stat">
                                        <span>457</span>
                        ...
                        <div class="column is-4">
                            <div class="network-card">
                                <div class="network-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/sally.jpg" />
                                </div>
                                <h3 class="title is-6 is-narrow">Sally Mitchells</h3>
                                <p class="subtitle is-size-7">Sales Manager</p>
                                <div class="network-stats">
                                    <div class="network-stat">
                                        <span>113</span>
                        ...
                        <div class="column is-4">
                            <div class="network-card">
                                <div class="network-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/terry.jpg" />
                                </div>
                                <h3 class="title is-6 is-narrow">Terry Daniels</h3>
                                <p class="subtitle is-size-7">Software Engineer</p>
                                <div class="network-stats">
                                    <div class="network-stat">
                                        <span>219</span>
                                        <span>Followers</span>
                        ...
                        <div class="column is-4">
                            <div class="network-card">
                                <div class="network-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/nick.jpg" />
                                </div>
                                <h3 class="title is-6 is-narrow">Nick Fraiser</h3>
                                <p class="subtitle is-size-7">Software Engineer</p>
                                <div class="network-stats">
                                    <div class="network-stat">
                                        <span>721</span>
                        ...
                        <div class="column is-4">
                            <div class="network-card">
                                <div class="network-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/nina.jpg" />
                                </div>
                                <h3 class="title is-6 is-narrow">Nina Evans</h3>
                                <p class="subtitle is-size-7">Product Manager</p>
                                <div class="network-stats">
                                    <div class="network-stat">
                                        <span>511</span>
                        ...
                        <div class="column is-4">
                            <div class="network-card">
                                <div class="network-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/250x250" alt="" data-v1-src="assets/img/avatars/marge.jpg" />
                                </div>
                                <h3 class="title is-6 is-narrow">Marge Harris</h3>
                                <p class="subtitle is-size-7">Frontend Engineer</p>
                                <div class="network-stats">
                                    <div class="network-stat">
                                        <span>598</span>
                                        <span>Followers</span>
            ...
            <div class="columns is-vcentered">
                    ...
                    <div>
                        ...
                        <nav class="level is-mobile mt-20">
                            <div class="level-left level-social">
                                <a href="profile-3.php#" class="level-item">
                ...
                <div class="column">
                    <div class="footer-nav-right">
                        <a class="footer-nav-link" href="profile-3.php#">Home</a>
                        <a class="footer-nav-link" href="profile-3.php#">Features</a>
                        <a class="footer-nav-link" href="profile-3.php#">Pricing</a>
                        <a class="footer-nav-link" href="profile-3.php#">Sign in</a>
                        <a class="footer-nav-link" href="profile-3.php#">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="profile-3.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="profile-3.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="profile-3.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="profile-3.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="profile-3.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="profile-3.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="profile-3.php#"></a></div> <!-- Concatenated jQuery and plugins -->
