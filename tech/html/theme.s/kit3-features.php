...
<body class="is-theme-core">
    ...
    <!-- Hero and nav -->
    <div class="hero has-waves-bottom-alt is-relative is-theme-primary is-fullheight">
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        ...
                        <div class="navbar-item">
                            <a id="#signup-btn" href="kit3-signup.php" class="button button-signup btn-outlined is-bold btn-align light-btn rounded raised">
                                Sign up
                            </a>
                        </div>
                    </div>
        ...
        <div id="main-hero" class="hero-body">
            <div class="container">
                <div class="columns is-vcentered">
                    <div class="column is-4 is-header-caption">
                        ...
                        <a href="kit3-features.php#services" class="button button-cta light-btn btn-outlined is-bold rounded z-index-2">
                            Get Started
                        </a>
                        <a href="kit3-features.php#" class="button button-cta light-btn btn-outlined is-bold rounded z-index-2">
                            Try for Free
                        </a>
                    </div>
                    <div class="column is-9 is-offset-1">
                        <!-- Hero mockup -->
                        <figure class="image">
                            <img class="levitate" src="assets/img/graphics/apps/laptop-app2-core.png" data-base-url="assets/img/graphics/apps/laptop-app2" data-extension=".png" alt="">
                        </figure>
                    </div>
                </div>
            </div>
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered is-multiline has-text-centered">
                    ...
                    <div class="column is-3">
                        <div class="square-icon-box is-chat rounded secondary">
                            ...
                            <div class="box-text is-tablet-padded-lg body-color">
                                Lorem ipsum dolor sit amet, usu no ancillae verterem.
                            </div>
                        </div>
                    </div>
                    <!-- Icon box -->
                ...
                <div class="columns is-vcentered has-text-centered">
                    ...
                    <!-- Icon box -->
                    <div class="column is-3">
                        <div class="square-icon-box is-chat rounded primary">
                            <div class="icon-box-wrapper">
                                <div class="icon-box">
                ...
                <div class="is-title-reveal pt-40 pb-40">
                    <a href="kit3-signup.php" class="button button-cta btn-align primary-btn rounded raised">Start your
                        Free trial</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="columns is-vcentered">
                ...
                <div class="column is-6 has-text-centered">
                    ...
                    <img class="featured-svg levitate" src="assets/img/graphics/widgets/mini-widget-4-core.png" data-base-url="assets/img/graphics/widgets/mini-widget-4" data-extension=".png" alt="">
                </div>
    ...
    <div class="section is-medium">
        <div class="container">
            <div class="columns is-vcentered">
                ...
                <div class="column is-6 has-text-centered">
                    <!-- Featured illustration -->
                    <img class="featured-svg levitate" src="assets/img/graphics/widgets/widget-13-core.png" data-base-url="assets/img/graphics/widgets/widget-13" data-extension=".png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section is-medium section-feature-grey">
        <div class="container">
            <div class="columns is-vcentered">
                ...
                <div class="column is-6 has-text-centered">
                    <!-- Featured illustration -->
                    <img class="featured-svg levitate" src="assets/img/graphics/widgets/widget-3-core.png" data-base-url="assets/img/graphics/widgets/widget-3" data-extension=".png" alt="">
                </div>
            ...
            <div class="has-text-centered is-title-reveal pt-40 pb-40">
                <a class="button button-cta btn-align primary-btn rounded">Get Started</a>
            </div>
        </div>
    </div>

    <!-- Slanted feature Section -->
    <div id="business-types" class="section section-primary is-medium is-skewed-sm is-relative">
        <div class="container slanted-container is-reverse-skewed-sm">
            <div class="columns is-vcentered">
                <!-- Content -->
                <div class="column is-5 ">
                    <div>
                        <h2 class="title quick-feature light-text"><span>Straight to the point</span></h2>
                        <p class="light-text pb-10">Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has
                            eu lorem convenire incorrupte. Vis mutat altera percipit ad, ipsum prompta ius eu. Sanctus
                            appellantur vim ea. Dolorem delicata vis te, aperiam nostrum ut per.</p>
                        <div class="pb-10 pt-10">
                            <a href="kit3-signup.php" class="button button-cta light-btn btn-outlined rounded is-bold">
                                Try it free
                            </a>
                        </div>
                    </div>
                ...
                <div class="column is-6 is-offset-1">
                    <img class="featured-svg levitate" src="assets/img/graphics/widgets/widget-4-core.png" data-base-url="assets/img/graphics/widgets/widget-4" data-extension=".png" alt="">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card ressource-card">
                            <div class="card-image">
                                ...
                                <figure class="image is-4by3 zoomOut">
                                    <img src="https://via.placeholder.com/1280x960" alt="" data-v1-src="assets/img/v1/kit/data-insight.jpeg">
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                    <div class="media-content">
                                        <a href="kit3-features.php#" class="color-primary is-handwritten">Interacting with customers</a>
                    ...
                    <div class="column is-4">
                        <div class="card ressource-card">
                            <div class="card-image">
                                ...
                                <figure class="image is-4by3 zoomOut">
                                    <img src="https://via.placeholder.com/1280x960" alt="" data-v1-src="assets/img/v1/kit/blog.jpeg">
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                    <div class="media-content">
                                        <a href="kit3-features.php#" class="color-primary is-handwritten">Chat as a conversion tool</a>
                                        <p class="subtitle is-6">Marketing ressources</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="column is-4">
                        <div class="card ressource-card">
                            <div class="card-image">
                                <div class="card-image-overlay"></div>
                                <figure class="image is-4by3 zoomOut">
                                    <img src="https://via.placeholder.com/1280x960" alt="" data-v1-src="assets/img/v1/kit/laptop-living.jpeg">
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                    <div class="media-content">
                                        <a href="kit3-features.php#" class="color-primary is-handwritten">Recently added</a>
    ...
    <!-- Video CTA -->
    <div class="section is-cover section-primary is-large is-relative">
        <div class="columns is-vcentered">
            <div class="column is-4 is-offset-2">
                <!-- Video -->
            ...
            <div class="column is-4">
                <div class="content padding-20">
                    ...
                    <p class="light-text no-margin-bottom pt-10 pb-10">Lorem ipsum dolor sit amet, vim quidam blandit
                        voluptaria no, has eu lorem convenire incorrupte. Vis mutat altera percipit ad, ipsum prompta ius
                        eu. Sanctus appellantur.</p>
                    <div class="pt-10 pb-10">
                        <a href="kit3-features.php#" class="button button-cta light-btn btn-outlined rounded is-bold">
                            Ask us a question
                        </a>
                    </div>
                </div>
    ...
    <div id="trust" class="section section-feature-grey is-medium">
        <div class="container">
            ...
            <div class="content-wrapper">
                ...
                <!-- CTA -->
                <div class="has-text-centered is-title-reveal pt-40 pb-40">
                    <a href="kit3-features.php#" class="button button-cta btn-align raised rounded primary-btn">Learn more about
                        pricing</a>
                </div>
                <!-- /CTA -->
            </div>
    ...
    <div class="section is-medium is-relative section-feature-grey footer-wavy">
        <div class="container">
            <!-- Title -->
            <div class="section-title-wrapper has-text-centered">
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="kit3-features.php#">Customers</a></li>
                            <li><a href="kit3-features.php#">Weekly sessions</a></li>
                            <li><a href="kit3-features.php#">Free trials and v1</a></li>
                            <li><a href="kit3-features.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="kit3-features.php#">About us</a></li>
                            <li><a href="kit3-features.php#">About security</a></li>
                            <li><a href="kit3-features.php#">User guide</a></li>
                            <li><a href="kit3-features.php#">Terms of service</a></li>
                            <li><a href="kit3-features.php#">Terms of website use</a></li>
                            <li><a href="kit3-features.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="kit3-features.php#">Blog</a></li>
                            <li><a href="kit3-features.php#">FAQ</a></li>
                            <li><a href="kit3-features.php#">API documentation</a></li>
                            <li><a href="kit3-features.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="kit3-features.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit3-features.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit3-features.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit3-features.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit3-features.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit3-features.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit3-features.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit3-features.php#"></a></div>
