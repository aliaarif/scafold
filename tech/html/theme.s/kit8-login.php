...
<body class="is-theme-core">
    ...
    <div class="auth-nav-alt">
        ...
        <div class="end">
            <span class="muted-text pr-10">Don't have an account?</span>
            <a href="kit8-signup.php" class="button is-rounded btn-align">Sign Up</a>
        </div>
    </div>
            ...
            <div class="column">
                <div class="form-wrapper">
                    ...
                    <div class="form-title">
                        <h3>Welcome back</h3>
                        <h4>We're super happy to see you again! Let's log you in.</h4>
                    </div>
                    ...
                    <div class="form-inner">
                        ...
                        <div class="field">
                            <div class="control has-icons-left">
                                <button class="button is-fullwidth is-rounded primary-btn raised">Login</button>
                            </div>
                        </div>
