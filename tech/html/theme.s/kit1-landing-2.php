...
<body class="is-theme-core">
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                ...
                <div class="has-text-centered pt-40 pb-40">
                    <a href="kit1-landing-2.php#" class="button button-cta primary-btn rounded raised">Learn more</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered pb-40 pt-40">
                    <div class="column is-4 is-offset-1">
                        ...
                        <div class="pt-10 pb-10">
                            <a href="kit1-landing-2.php#" class="button btn-align btn-more is-link color-primary">
                ...
                <div class="has-text-centered is-title-reveal pt-20 pb-20">
                    <a href="kit1-landing-2.php#" class="button button-cta primary-btn rounded raised">Start your Free trial</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="columns is-gapless is-vcentered mt-80 mb-80">
                ...
                <div class="column slide-description">
                    ...
                    <span class="body-text">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum
                        ...
                        labitur.</span>
                    <div class="pt-10 pb-10">
                        <a href="kit1-landing-2.php#second-feature" class="button button-cta btn-align btn-outlined is-bold raised primary-btn rounded is-hidden-touch">
                            Next feature
                        </a>
                    </div>
                </div>
            ...
            <div class="columns is-gapless is-vcentered mt-80 mb-80">
                ...
                <div class="column slide-description">
                    ...
                    <span class="body-text">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum
                        ...
                        labitur.</span>
                    <div class="pt-10 pb-10">
                        <a href="kit1-landing-2.php#third-feature" class="button button-cta btn-align btn-outlined is-bold raised primary-btn rounded is-hidden-touch">
                            Next feature
                        </a>
                    </div>
                </div>
            ...
            <div class="columns is-gapless is-vcentered mt-80 mb-80">
                ...
                <div class="column slide-description">
                    ...
                    <span class="body-text">Lorem ipsum dolor sit amet, clita laoreet ne cum. His cu harum
                        ...
                        labitur.</span>
                    <div class="pt-10 pb-10">
                        <a href="kit1-landing-2.php#fourth-feature" class="button button-cta btn-align btn-outlined is-bold raised primary-btn rounded is-hidden-touch">
                            Next feature
                        </a>
                    </div>
                </div>
                            ...
                            <div class="card-text">
                                <div class="text text-container">
                                    ...
                                    <div class="text text-details">
                                        ...
                                        <a href="kit1-landing-2.php#" class="button btn-align btn-more is-link color-primary mt-10 mb-10">
            ...
            <div class="columns">
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="kit1-landing-2.php#">Discover features</a></li>
                            <li><a href="kit1-landing-2.php#">CMS integration</a></li>
                            <li><a href="kit1-landing-2.php#">Customers</a></li>
                            <li><a href="kit1-landing-2.php#">Weekly sessions</a></li>
                            <li><a href="kit1-landing-2.php#">Free trials and demo</a></li>
                            <li><a href="kit1-landing-2.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="kit1-landing-2.php#">About us</a></li>
                            <li><a href="kit1-landing-2.php#">About security</a></li>
                            <li><a href="kit1-landing-2.php#">User guide</a></li>
                            <li><a href="kit1-landing-2.php#">Terms of service</a></li>
                            <li><a href="kit1-landing-2.php#">Terms of website use</a></li>
                            <li><a href="kit1-landing-2.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="kit1-landing-2.php#">Resources</a></li>
                            <li><a href="kit1-landing-2.php#">Blog</a></li>
                            <li><a href="kit1-landing-2.php#">FAQ</a></li>
                            <li><a href="kit1-landing-2.php#">API documentation</a></li>
                            <li><a href="kit1-landing-2.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="kit1-landing-2.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="kit1-landing-2.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="kit1-landing-2.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit1-landing-2.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="kit1-landing-2.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="kit1-landing-2.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="kit1-landing-2.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="kit1-landing-2.php#"></a></div>
