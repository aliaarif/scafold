...
<body id="component-page">
    ...
    <!-- Hero and nav -->
    <div class="hero is-relative is-theme-primary is-bold">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-sections-pricing.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-sections-pricing.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-sections-pricing.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-sections-pricing.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-sections-pricing.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <h2 class="subtitle is-4 components-subtitle">
                            Pricing tables variations.
                        </h2>
                        <p class="components-cta">
                            <a href="_components-sections-pricing.php#classic" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="pricing-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Pricing V1-A -->
    <div id="classic" class="section is-medium">
        <div class="container">
                ...
                <div class="classic-pricing">
                    <div class="pricing-table">
                        ...
                        <div class="pricing-plan is-mobile">
                            ...
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>20</span><b>/month</b></div>
                            ...
                            <div class="plan-footer">
                                <button class="button btn-align raised is-fullwidth" disabled="disabled">Current plan</button>
                            </div>
                        </div>
                        <!-- Pricing Plan -->
                        <div class="pricing-plan is-mobile is-secondary">
                            <div class="plan-header">Pro</div>
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>40</span><b>/month</b></div>
                            <div class="plan-items">
                                <div class="plan-item"><b>20GB</b> Storage</div>
                            ...
                            <div class="plan-footer">
                                <button class="button btn-align raised is-fullwidth">Sign up</button>
                            </div>
                        </div>
                        <!-- Pricing Plan -->
                        <div class="pricing-plan is-mobile is-primary is-active">
                            <div class="plan-header">Business</div>
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>60</span><b>/month</b></div>
                            <div class="plan-items">
                        ...
                        <div class="pricing-plan is-mobile is-accent">
                            ...
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>100</span><b>/month</b></div>
                            <div class="plan-items">
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="classic-pricing">
                    <div class="pricing-table">
                        <!-- Pricing Plan -->
                        <div class="pricing-plan is-mobile is-success">
                            <div class="plan-header">Starter</div>
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>20</span><b>/month</b></div>
                            <div class="plan-items">
                                <div class="plan-item"><b>20GB</b> Storage</div>
                        ...
                        <!-- Pricing Plan -->
                        <div class="pricing-plan is-mobile is-info">
                            <div class="plan-header">Pro</div>
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>40</span><b>/month</b></div>
                            <div class="plan-items">
                                <div class="plan-item"><b>20GB</b> Storage</div>
                        ...
                        <!-- Pricing Plan -->
                        <div class="pricing-plan is-mobile is-warning is-active">
                            <div class="plan-header">Business</div>
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>60</span><b>/month</b></div>
                            <div class="plan-items">
                                <div class="plan-item"><b>200GB</b> Storage</div>
                        ...
                        <!-- Pricing Plan -->
                        <div class="pricing-plan is-mobile is-danger">
                            <div class="plan-header">Enterprise</div>
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>100</span><b>/month</b></div>
                            <div class="plan-items">
                                <div class="plan-item"><b>2TB</b> Storage</div>
    ...
    <!-- Pricing V1-C -->
    <div class="section is-medium is-hidden-mobile">
        <div class="container">
            <div class="section-title-wrapper">
                ...
                <div class="classic-pricing">
                    <div class="pricing-table is-comparative">
                        ...
                        <div class="pricing-plan">
                            ...
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>20</span><b>/month</b></div>
                            <div class="plan-items">
                                <div class="plan-item" data-feature="Storage"><b>20GB</b></div>
                                <div class="plan-item" data-feature="Domains"><b>100</b></div>
                        ...
                        <div class="pricing-plan is-secondary">
                            ...
                            <div class="plan-items">
                                <div class="plan-item" data-feature="Storage"><b>20GB</b></div>
                                <div class="plan-item" data-feature="Domains"><b>25</b></div>
                                <div class="plan-item" data-feature="Bandwidth"><b>1TB</b></div>
                                <div class="plan-item" data-feature="Email Boxes">-</div>
                            </div>
                            <div class="plan-footer">
                                <button class="button btn-align raised is-fullwidth">Sign up</button>
                        ...
                        <div class="pricing-plan is-primary is-active">
                            ...
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>60</span><b>/month</b></div>
                            <div class="plan-items">
                                <div class="plan-item" data-feature="Storage"><b>200GB</b></div>
                                <div class="plan-item" data-feature="Domains"><b>50</b></div>
                                <div class="plan-item" data-feature="Bandwidth"><b>1TB</b></div>
                                <div class="plan-item" data-feature="Email Boxes"><b>100</b></div>
                            </div>
                            <div class="plan-footer">
                                <button class="button btn-align raised is-fullwidth">Sign up</button>
                            </div>
                        ...
                        <div class="pricing-plan is-accent">
                            ...
                            <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>100</span><b>/month</b></div>
                            <div class="plan-items">
                                <div class="plan-item" data-feature="Storage"><b>2TB</b></div>
                                <div class="plan-item" data-feature="Domains"><b>100</b></div>
                                <div class="plan-item" data-feature="Bandwidth"><b>1TB</b></div>
                                <div class="plan-item" data-feature="Email Boxes"><b>1000</b></div>
                            </div>
                            <div class="plan-footer">
                                <button class="button btn-align raised is-fullwidth">Sign up</button>
                            </div>
                ...
                <div class="classic-pricing">
                    <div class="pricing-table is-horizontal">
                        ...
                        <div class="pricing-plan">
                            ...
                            <div class="plan-footer">
                                <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>20</span></div>
                        ...
                        <div class="pricing-plan is-secondary">
                            ...
                            <div class="plan-footer">
                                <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>40</span></div>
                        ...
                        <div class="pricing-plan is-primary is-active">
                            ...
                            <div class="plan-footer">
                                <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>60</span></div>
                                <button class="button is-fullwidth">Sign up</button>
                            </div>
                        </div>
                        <!-- Pricing Plan -->
                        <div class="pricing-plan is-accent">
                            ...
                            <div class="plan-footer">
                                <div class="plan-price"><span class="plan-price-amount"><span class="plan-price-currency">$</span>100</span></div>
                                <button class="button is-fullwidth">Sign up</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="columns is-vcentered">
                                ...
                                <div class="column is-4">
                                    ...
                                    <div class="flex-card header-pricing-card accent hover-inset">
                                        ...
                                        <div class="pricing-card-body">
                                            ...
                                            <div class="pt-30">
                                                <a class="button button-cta btn-align rounded raised accent-btn btn-outlined mb-20">Get started</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="column is-4">
                                    ...
                                    <div class="flex-card header-pricing-card primary hover-inset">
                                        ...
                                        <div class="pricing-card-body">
                                            <div class="plan-price per-month animated preFadeInUp fadeInUp">
                                                <small>$</small> 40 <small><b>/month</b></small>
                                            </div>
                                            <div class="plan-price per-year is-hidden animated preFadeInUp fadeInUp">
                                                <small>$</small> 480 <small><b>/year</b></small>
                                            </div>
                                            <ul class="plan-features">
                                                <li><span class="feature-count-text">15 Users</span></li>
                                                <li><span class="feature-count-text">100 Projects</span></li>
                                                <li><span class="feature-count-text">25Gb of Storage</span></li>
                                            </ul>
                                            <div class="pt-30">
                                                <a class="button button-cta btn-align rounded raised primary-btn mb-20">Get started</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="column is-4">
                                    ...
                                    <div class="flex-card header-pricing-card secondary hover-inset">
                                        ...
                                        <div class="pricing-card-body">
                                            <div class="plan-price per-month animated preFadeInUp fadeInUp">
                                                <small>$</small> 75 <small><b>/month</b></small>
                                            </div>
                                            <div class="plan-price per-year is-hidden animated preFadeInUp fadeInUp">
                                                <small>$</small> 825 <small><b>/year</b></small>
                                            </div>
                                            <ul class="plan-features">
                                            ...
                                            <div class="pt-30">
                                                <a class="button button-cta btn-align rounded raised secondary-btn btn-outlined mb-20">Get started</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered">
                    <div class="column is-8 is-offset-2">
                        <!-- Freelance pricing -->
                        <div id="freelance-pricing" class="side-pricing">
                            <div class="columns is-vcentered has-text-centered">
                                <div class="column">
                                    <!-- Pricing table features -->
                                    <div class="pricing-card card-raised animated preFadeInLeft fadeInLeft">
                                        <div class="popular"><i class="im im-icon-Crown-2"></i></div>
                                        <div class="inner">
                                            <h6 class="plan-name">Free</h6>
                                            <div class="plan-price">
                                                <small class="currency">$</small>
                                                <div class="month-price animated preFadeInUp fadeInUp">
                                                    <span>0</span>
                                                    <small><b>/month</b></small>
                                                </div>
                                                <div class="year-price animated preFadeInUp fadeInUp is-hidden">
                                                    <span>0</span>
                                                    <small><b>/year</b></small>
                                                </div>
                                            </div>
                                            <ul>
                                                <li><b>15</b> Invoices per month</li>
                                                <li><b>2 Gb</b> Storage</li>
                                                <li><b>1</b> User account</li>
                                                <li><b>20</b> Clients</li>
                                            </ul>
                                            <a href="_components-sections-pricing.php#" class="button button-cta btn-align primary-btn raised rounded">Sign up</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="column">
                                    <!-- Pricing table transparent -->
                                    <div class="pricing-card transparent animated preFadeInLeft fadeInLeft delay-1">
                                        <div class="inner">
                                            <h6 class="plan-name">Freelancer</h6>
                                            <div class="plan-price">
                                                <small class="currency">$</small>
                                                <div class="month-price animated preFadeInUp fadeInUp">
                                                    <span>15</span>
                                            ...
                                            <ul>
                                                <li><b>60</b> Invoices per month</li>
                                                <li><b>15 Gb</b> Storage</li>
                                                <li><b>1</b> User account</li>
                                                <li><b>∞</b> Clients</li>
                                            </ul>
                                            <a href="_components-sections-pricing.php#" class="button button-cta btn-align primary-btn btn-outlined rounded">Sign up</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="columns is-vcentered">
                        ...
                        <div class="column is-3 is-offset-1">
                            ...
                            <div class="flex-card fancy-pricing-card light-bordered hover-inset secondary">
                                ...
                                <ul class="plan-features">
                                    <li><span class="feature-count-text">1 Operator</span></li>
                                    <li><span class="feature-count-text">25 Customers</span></li>
                                    <li><span class="feature-count-text">1 Integration</span></li>
                                </ul>
                                <div class="pt-20 pb-20">
                                    <a class="button button-cta btn-align rounded raised secondary-btn btn-outlined is-bold">Get started</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column is-4">
                            ...
                            <div class="flex-card fancy-pricing-card light-bordered hover-inset secondary">
                                ...
                                <ul class="plan-features">
                                    <li><span class="feature-count-text">5 Operators</span></li>
                                    <li><span class="feature-count-text">100 Customers</span></li>
                                    <li><span class="feature-count-text">3 Integrations</span></li>
                                </ul>
                                <div class="pt-20 pb-20">
                                    <a class="button button-cta btn-align rounded raised secondary-btn">Get started</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column is-3">
                            ...
                            <div class="flex-card fancy-pricing-card light-bordered hover-inset secondary">
                                ...
                                <ul class="plan-features">
                                    <li><span class="feature-count-text">10 Operators</span></li>
                                    <li><span class="feature-count-text">500 Customers</span></li>
                                    <li><span class="feature-count-text">20 Integrations</span></li>
                                </ul>
                                <div class="pt-20 pb-20">
                                    <a class="button button-cta btn-align rounded raised secondary-btn btn-outlined is-bold">Get started</a>
                                </div>
                    ...
                    <div class="columns is-vcentered">
                        ...
                        <div class="column is-10 is-offset-1 is-hidden-mobile">
                            <div class="flex-card fancy-pricing-card streched light-bordered hover-inset secondary">
                                ...
                                <div>
                                    <ul class="plan-features">
                                        <li><span class="large-count">Unlimited</span></li>
                                    </ul>
                                </div>
                                <div class="ml-auto">
                                    <a class="button button-cta btn-align rounded raised secondary-btn btn-outlined is-bold">Learn more</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column is-3 is-hidden-desktop is-hidden-tablet">
                            <div class="flex-card fancy-pricing-card light-bordered hover-inset secondary">
                                ...
                                <div class="plan-price">
                                    <small>$</small> 249 <small>/ month</small>
                                </div>
                                <ul class="plan-features">
                                    <li><span class="feature-count-text">Unlimited Operators</span></li>
                                    <li><span class="feature-count-text">Unlimited Customers</span></li>
                                    <li><span class="feature-count-text">Unlimited Integrations</span></li>
                                </ul>
                                <div class="pt-30">
                                    <a class="button button-cta btn-align rounded raised secondary-btn btn-outlined mb-20">Learn more</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                <div class="columns is-vcentered has-text-centered">
                    <!-- Pricing plan -->
                    <div class="column is-4">
                        <div class="minimal-pricing padding-20">
                            <div class="plan-name">FREE</div>
                            <div class="price">
                                <span class="price-currency">$</span>
                                <span class="price-number">0</span>
                                <span class="price-period"><b>/month</b></span>
                            </div>
                            <div class="plan-features">
                                <ul>
                                    <li><b>3</b> team members</li>
                                    <li class="is-disabled">Multiple projects</li>
                                    <li class="is-disabled">Marketplace</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <!-- Pricing plan -->
                    <div class="column is-4">
                        <div class="minimal-pricing featured padding-20">
                            ...
                            <div class="plan-features">
                                <ul>
                                    <li><b>15</b> team members</li>
                                    <li>up to <b>100</b> projects</li>
                                    <li>Marketplace</li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="columns is-vcentered has-text-centered pt-10 pb-10">
                    <!-- Pricing plan -->
                    <div class="column is-8 no-padding">
                        <div class="minimal-pricing wide-box has-background-image" data-background="https://via.placeholder.com/1920x1280" data-demo-background="assets/img/demo/pots.jpg">
                            <div class="plan-name mt-20 mb-20">BUSINESS</div>
                            <div class="plan-features">
                                <ul>
                                    <li><b>Infinite</b> team members</li>
                                    <li><b>Unlimited</b> projects, Marketplace</li>
                                    <li>Cluster, replication, load balancing</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="column is-4">
                        <div class="has-text-centered">
                            <a href="landing-v3-signup.php" class="button button-cta btn-align primary-btn rounded raised">Get started</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="columns footer-columns is-flex-mobile">
                ...
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-pricing.php#">Customers</a></li>
                            <li><a href="_components-sections-pricing.php#">Weekly sessions</a></li>
                            <li><a href="_components-sections-pricing.php#">Free trials and demo</a></li>
                            <li><a href="_components-sections-pricing.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-sections-pricing.php#">About us</a></li>
                            <li><a href="_components-sections-pricing.php#">About security</a></li>
                            <li><a href="_components-sections-pricing.php#">User guide</a></li>
                            <li><a href="_components-sections-pricing.php#">Terms of service</a></li>
                            <li><a href="_components-sections-pricing.php#">Terms of website use</a></li>
                            <li><a href="_components-sections-pricing.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                <div class="column is-half-mobile">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            ...
                            <li><a href="_components-sections-pricing.php#">Blog</a></li>
                            <li><a href="_components-sections-pricing.php#">FAQ</a></li>
                            <li><a href="_components-sections-pricing.php#">API documentation</a></li>
                            <li><a href="_components-sections-pricing.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Column -->
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-sections-pricing.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-sections-pricing.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-pricing.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-pricing.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-sections-pricing.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-sections-pricing.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-sections-pricing.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-sections-pricing.php#"></a></div> <!-- Concatenated jQuery and plugins -->
