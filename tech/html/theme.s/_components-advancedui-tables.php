...
<body id="component-page">
                                        ...
                                        <div class="navbar-content">
                                            <div class="level is-mobile">
                                                ...
                                                <div class="level-right">
                                                    <div class="level-item">
                                                        <a class="social-link" href="_components-advancedui-tables.php#"><i class="fa fa-twitter"></i></a>
                                                        <a class="social-link" href="_components-advancedui-tables.php#"><i class="fa fa-facebook"></i></a>
                                                        <a class="social-link" href="_components-advancedui-tables.php#"><i class="fa fa-behance"></i></a>
                                                        <a class="social-link" href="_components-advancedui-tables.php#"><i class="fa fa-github"></i></a>
                                                        <a class="social-link" href="_components-advancedui-tables.php#"><i class="fa fa-tumblr"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-1 has-text-left">
                        ...
                        <p class="components-cta">
                            <a href="_components-advancedui-tables.php#tables" class="button button-cta btn-align light-btn btn-outlined is-bold rounded">
                                Get Started
                            </a>
                        </p>
                    </div>
                    <div class="column is-offset-1 has-text-centered is-hidden-mobile">
                        <div id="tables-ill" class="vivus-svg"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="scrollnav" class="scroll-nav-wrapper">
        <div class="container">
            <div class="tabs scrollnav-tabs is-centered">
                <ul>
                    <li class="scrollnav-item is-active"><a href="_components-advancedui-tables.php#basic">Basic</a></li>
                    <li class="scrollnav-item"><a href="_components-advancedui-tables.php#bordered">Bordered</a></li>
                    <li class="scrollnav-item"><a href="_components-advancedui-tables.php#striped">Striped</a></li>
                    <li class="scrollnav-item"><a href="_components-advancedui-tables.php#narrowed">Narrowed</a></li>
                    <li class="scrollnav-item"><a href="_components-advancedui-tables.php#responsive">Responsive</a></li>
                    <li class="scrollnav-item"><a href="_components-advancedui-tables.php#device-compare">Device</a></li>
                    <li class="scrollnav-item"><a href="_components-advancedui-tables.php#compare">Compare</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div id="tables" class="section">
        <div class="container">
            ...
            <!-- Basic table -->
            <div class="columns is-vcentered">
                <div id="basic" class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Basic Table</h4>
                        <p class="no-padding">You can quicly setup a styled table by adding the <code>.table</code> class to
                            a <code>table</code> Html element. Several modifiers are also available. You can use any
                ...
                <div class="column is-10 is-offset-1">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td><a>Michael Hoffman</a></td>
                                <td>Engineer</td>
                                <td>Admin</td>
                                <td>21 projects</td>
                                <td>Php, Javascript, Html & CSS</td>
                                <td><button class="button is-small btn-align accent-btn raised rounded btn-outlined">Hire
                                        now</button></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td><a>Marjory Cambell</a></td>
                                <td>Sales Rep</td>
                                <td>Contributor</td>
                                <td>03 projects</td>
                            ...
                            <tr>
                                <td>3</td>
                                <td><a>Kevin Smith</a></td>
                                <td>Engineer</td>
                                <td>Collaborator</td>
                                <td>12 projects</td>
                                <td>Javascript, Angular, Vue js</td>
                                <td><button class="button is-small btn-align accent-btn raised rounded btn-outlined">Hire
                                        now</button></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td><a>Adrian Fallow</a></td>
                                <td>Sales Manager</td>
                                <td>Reader</td>
                                <td>07 projects</td>
                                <td>Sales and email marketing</td>
                                <td><button class="button is-small btn-align accent-btn raised rounded btn-outlined">Hire
                                        now</button></td>
                            </tr>
                            <tr>
                                <td>5</td>
                                <td><a>Helen Miller</a></td>
            ...
            <div class="columns is-vcentered pt-60">
                <div id="bordered" class="column is-6 is-offset-3">
                    <div class="info-block pb-20">
                        <h4>Bordered Table</h4>
                        <p class="no-padding">To draw borders around the table and its cells, add the
                            <code>.is-bordered</code> modifier class to a <code>.table</code> element.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Striped table -->
            <div class="columns is-vcentered pt-60">
                <div id="striped" class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Striped Table</h4>
                        <p class="no-padding">To make a table's rows striped, add the <code>.is-striped</code> modifier
                            class to a <code>.table</code> element.</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Narrowed table -->
            <div class="columns is-vcentered pt-60">
                <div id="narrowed" class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Narrowed Table</h4>
                        <p class="no-padding">You can make rows narrower by adding the <code>.is-narrow</code> modifier
                            class to a <code>.table</code> element.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <!-- Responsive table -->
            <div class="columns is-vcentered pt-60">
                <div id="responsive" class="column is-6 is-offset-3">
                    <div class="info-block pb-20">
                        <h4>Responsive Table</h4>
                        <p class="no-padding">If you want your table to behave responsively, use the responsive table. To do
                            so, add the <code>.responsive-table</code> class to a Html <code>table</code> element. Color
                            modifiers are also available for the table header. Available classes are
            ...
            <div class="columns is-vcentered pt-30">
                <!-- V1 section -->
                <div class="column is-10 is-offset-1">
                    <table class="responsive-table is-accent mb-40">
                        <tbody>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                            ...
                            <tr>
                                ...
                                <td data-th="Actions">
                                    <button class="button is-small btn-align accent-btn raised rounded btn-outlined">Hire
                                        now</button>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table class="responsive-table is-primary mb-40">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-th="Actions">
                                    <button class="button is-small btn-align primary-btn raised rounded btn-outlined">Hire
                                        now</button>
                                </td>
                            </tr>
                            <tr>
            ...
            <div class="columns is-vcentered pt-60">
                <div id="device-compare" class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Device compare Table</h4>
                        <p class="no-padding">Use the device comparison table to compare app features between devices. Add
                            the <code>.device-table</code> class to a <code>.table</code> element.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="column is-6 is-offset-3">
                    <table class="table device-table">
                        <thead>
                            <tr>
                                <th></th>
                                <th><i class="im im-icon-Smartphone-3"></i></th>
                                <th><i class="im im-icon-Tablet-3"></i></th>
                                <th><i class="im im-icon-Laptop"></i></th>
                                <th><i class="im im-icon-Monitor-2"></i></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="feature-name">Invoice editing</td>
                                <td><i class="im im-icon-Close is-disabled"></i></td>
                                <td><i class="im im-icon-Yes"></i></td>
                                <td><i class="im im-icon-Yes"></i></td>
                                <td><i class="im im-icon-Yes"></i></td>
                            </tr>
                            <tr>
                                <td class="feature-name">Payments schedule</td>
                                <td><i class="im im-icon-Yes"></i></td>
                                <td><i class="im im-icon-Yes"></i></td>
                                <td><i class="im im-icon-Yes"></i></td>
                                <td><i class="im im-icon-Yes"></i></td>
                            ...
                            <tr>
                                <td class="feature-name">Permissions</td>
                                <td><i class="im im-icon-Close is-disabled"></i></td>
                                <td><i class="im im-icon-Yes"></i></td>
                                <td><i class="im im-icon-Yes"></i></td>
                                <td><i class="im im-icon-Yes"></i></td>
            ...
            <!-- Compare table -->
            <div class="columns is-vcentered pt-60">
                <div id="compare" class="column is-6 is-offset-3">
                    <div class="info-block">
                        <h4>Feature compare Table</h4>
                        <p class="no-padding">Use the feature comparison table to compare features between pricing plans or
                            app editions. Add the <code>.compare-table</code> class to a <code>.table</code> element.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="column is-8 is-offset-2">
                    <table class="table compare-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="feature-name">Collaboration</td>
                                <td><i class="fa fa-close is-disabled"></i></td>
                                <td><i class="fa fa-close is-disabled"></i></td>
                                <td><i class="fa fa-check"></i></td>
                                <td><i class="fa fa-check"></i></td>
                            </tr>
                            ...
                            <tr>
                                <td class="feature-name">Online Storage</td>
                                <td><i class="fa fa-close is-disabled"></i></td>
                                <td><i class="fa fa-close is-disabled"></i></td>
                                <td><i class="fa fa-close is-disabled"></i></td>
                                <td><i class="fa fa-check"></i></td>
            ...
            <div class="columns">
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-tables.php#">Discover features</a></li>
                            <li><a href="_components-advancedui-tables.php#">CMS integration</a></li>
                            <li><a href="_components-advancedui-tables.php#">Customers</a></li>
                            <li><a href="_components-advancedui-tables.php#">Weekly sessions</a></li>
                            <li><a href="_components-advancedui-tables.php#">Free trials and v1</a></li>
                            <li><a href="_components-advancedui-tables.php#">What's next ?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-tables.php#">About us</a></li>
                            <li><a href="_components-advancedui-tables.php#">About security</a></li>
                            <li><a href="_components-advancedui-tables.php#">User guide</a></li>
                            <li><a href="_components-advancedui-tables.php#">Terms of service</a></li>
                            <li><a href="_components-advancedui-tables.php#">Terms of website use</a></li>
                            <li><a href="_components-advancedui-tables.php#">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                    <div class="footer-column">
                        ...
                        <ul class="link-list">
                            <li><a href="_components-advancedui-tables.php#">Resources</a></li>
                            <li><a href="_components-advancedui-tables.php#">Blog</a></li>
                            <li><a href="_components-advancedui-tables.php#">FAQ</a></li>
                            <li><a href="_components-advancedui-tables.php#">API documentation</a></li>
                            <li><a href="_components-advancedui-tables.php#">Admin guide</a></li>
                        </ul>
                    </div>
                </div>
                <div class="column">
                        ...
                        <div class="footer-header">
                            <nav class="level is-mobile">
                                <div class="level-left level-social">
                                    <a href="_components-advancedui-tables.php#" class="level-item">
    ...
    <div class="side-navigation-menu">
        ...
        <div id="v1-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
            ...
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">weekend</span>Agency kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">wb_incandescent</span>Startup kit</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">apps</span>Landing kit 1</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">timelapse</span>Landing kit 2</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">assistant</span>Landing kit 3</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">brightness_2</span>Landing kit 4</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">toys</span>Landing kit 5</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">mouse</span>Landing kit 6</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">work</span>Landing kit
                        7</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link" href="_components-advancedui-tables.php#">
        ...
        <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-tables.php#"><span class="material-icons">domain</span>Company</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-tables.php#"><span class="material-icons">call</span>Contact</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link has-new" href="_components-advancedui-tables.php#"><span class="material-icons">book</span>Blog</a>
                    <ul>
                ...
                <li class="has-children">
                    <a class="parent-link has-new" href="_components-advancedui-tables.php#"><span class="material-icons">highlight</span>Error Pages</a>
                    <ul>
        ...
        <div id="components" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
            ...
            <!-- Navigation body -->
            <ul class="navigation-menu">
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">view_quilt</span>Layout</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">subject</span>Navbars</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">view_stream</span>Sections</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">playlist_add_check</span>Basic
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">playlist_add</span>Advanced
                        UI</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">check_box</span>Forms</a>
                    <ul>
                ...
                <li class="has-children"><a class="parent-link" href="_components-advancedui-tables.php#"><span class="material-icons">adjust</span>Icons</a>
                    <ul>
    ...
    <!-- /Side navigation -->
    <!-- Back To Top Button -->
    <div id="backtotop"><a href="_components-advancedui-tables.php#"></a></div> <!-- Concatenated jQuery and plugins -->
